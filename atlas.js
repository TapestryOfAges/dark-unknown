...
function PopulateAtlas(atlasref) {
  ...
  atlasref.insertkey("NortheastLavaCoastDirt",'l`');
  atlasref.insertkey("NortheastCoastCave",'c`');
  atlasref.insertkey("NortheastLavaCoastCave",'L`');
  ...
  atlasref.insertkey("SouthwestLavaCoastDirt",'`l');
  atlasref.insertkey("SouthwestCoastCave",'`c');
  atlasref.insertkey("SouthwestLavaCoastCave",'`L');
  ...
  atlasref.insertkey("NorthwestLavaCoastDirt",'/l');
  atlasref.insertkey("NorthwestCoastCave",'/c');
  atlasref.insertkey("NorthwestLavaCoastCave",'/L');
  ...
  atlasref.insertkey("SoutheastLavaCoastDirt",'l/');
  atlasref.insertkey("SoutheastCoastCave",'c/');
  atlasref.insertkey("SoutheastLavaCoastCave",'L/');
	...
	if (features[0]) {
		for (let i=0; i<features.length; i++) {
			...
			if (retval2["canmove"] === 0) { 
			  retval["canmove"] = 0;
        if (retval2["tutorial"]) { retval["tutorial"] = 1; }
