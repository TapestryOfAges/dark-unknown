...
function ActivateDebug(startup) { 
  ...
  $("body").append("<div style='position:absolute;left:790px;top:0px;width:" + wide + "px;height:" + tall + "px;overflow-y:scroll;z-index:500;background-color:white;color:black;font-size:smaller' id='debugdiv'></div>");
