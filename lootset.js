...
function SetLoots() {
  ...
  loots['Reaper Lord'] = new LootTable();
  loots['Reaper Lord'].goldDice = '5d12+25';
  loots['Reaper Lord'].goldChance = 70;
  loots['Reaper Lord'].loot[0] = {};
  loots['Reaper Lord'].loot[0].objname = 'Potions3';
  loots['Reaper Lord'].loot[0].quantity = '1d2';
  loots['Reaper Lord'].loot[0].chance = 35;
  loots['Reaper Lord'].loot[1] = {};
  loots['Reaper Lord'].loot[1].objname = 'Scrolls3';
  loots['Reaper Lord'].loot[1].quantity = '1d2';
  loots['Reaper Lord'].loot[1].chance = 25;
  loots['Reaper Lord'].loot[2] = {};
  loots['Reaper Lord'].loot[2].objname = 'Potions4';
  loots['Reaper Lord'].loot[2].quantity = '1d2';
  loots['Reaper Lord'].loot[2].chance = 35;
  loots['Reaper Lord'].loot[3] = {};
  loots['Reaper Lord'].loot[3].objname = 'LightningWood';
  loots['Reaper Lord'].loot[3].quantity = '1';
  loots['Reaper Lord'].loot[3].chance = 25;
  loots['Reaper Lord'].loot[4] = {};
  loots['Reaper Lord'].loot[4].objname = 'Potions2';
  loots['Reaper Lord'].loot[4].quantity = '1d2';
  loots['Reaper Lord'].loot[4].chance = 30;
  loots['Reaper Lord'].loot[5] = {};
  loots['Reaper Lord'].loot[5].objname = 'Heavy Armor';
  loots['Reaper Lord'].loot[5].quantity = '1';
  loots['Reaper Lord'].loot[5].chance = 25;
  loots['Reaper Lord'].loot[6] = {};
  loots['Reaper Lord'].loot[6].objname = 'Scrolls4';
  loots['Reaper Lord'].loot[6].quantity = '1d2';
  loots['Reaper Lord'].loot[6].chance = 30;
  loots['Reaper Lord'].loot[7] = {};
  loots['Reaper Lord'].loot[7].objname = 'Scrolls5';
  loots['Reaper Lord'].loot[7].quantity = '1';
  loots['Reaper Lord'].loot[7].chance = 30;
  loots['Reaper Lord'].loot[8] = {};
  loots['Reaper Lord'].loot[8].objname = 'Heavy Weapon';
  loots['Reaper Lord'].loot[8].quantity = '1';
  loots['Reaper Lord'].loot[8].chance = 35;
  loots['Reaper Lord'].loot[9] = {};
  loots['Reaper Lord'].loot[9].objname = 'BloodMoss';
  loots['Reaper Lord'].loot[9].quantity = '1';
  loots['Reaper Lord'].loot[9].chance = 30;
  loots['Reaper Lord'].loot[10] = {};
  loots['Reaper Lord'].loot[10].objname = 'Scrolls6';
  loots['Reaper Lord'].loot[10].quantity = '1';
  loots['Reaper Lord'].loot[10].chance = 25;
  loots['Reaper Lord'].trap = 'strong';
  ...
  loots['Level5'].loot[6] = {};
  loots['Level5'].loot[6].objname = 'Scrolls4';
  loots['Level5'].loot[6].quantity = '1';
  loots['Level5'].loot[6].chance = 30;
  loots['Level5'].loot[7] = {};
  loots['Level5'].loot[7].objname = 'Scrolls2';
  loots['Level5'].loot[7].quantity = '1';
  loots['Level5'].loot[7].chance = 30;
  loots['Level5'].loot[8] = {};
  loots['Level5'].loot[8].objname = 'Potions2';
  loots['Level5'].loot[8].quantity = '1d2';
  loots['Level5'].loot[8].chance = 35;
  loots['Level5'].loot[9] = {};
  loots['Level5'].loot[9].objname = 'Heavy Armor';
  loots['Level5'].loot[9].quantity = '1';
  loots['Level5'].loot[9].chance = 20;
  loots['Level5'].loot[10] = {};
  loots['Level5'].loot[10].objname = 'BluePalmCrystal';
  loots['Level5'].loot[10].quantity = '1';
  loots['Level5'].loot[10].chance = 10;
  ...
  loots['shrinecavechest'].loot[0].objname = 'ScrollProtection';
  loots['shrinecavechest'].loot[0].quantity = '1';
  loots['shrinecavechest'].loot[0].chance = 100;
  loots['shrinecavechest'].loot[1] = {};
  loots['shrinecavechest'].loot[1].objname = 'XApprenticeJournal';
  ...
  loots['Eyes'].loot[0] = {};
  loots['Eyes'].loot[0].objname = 'Nightshade';
  loots['Eyes'].loot[0].quantity = '1';
  loots['Eyes'].loot[0].chance = 25;
  loots['Eyes'].loot[1] = {};
  loots['Eyes'].loot[1].objname = 'BluePalmCrystal';
  loots['Eyes'].loot[1].quantity = '1';
  loots['Eyes'].loot[1].chance = 30;
  loots['Eyes'].loot[2] = {};
  ...
  loots['Warduke'].loot[0].objname = 'Chalice';
  ...
  loots['Archmage'].loot[0].objname = 'MandrakeRoot';
  loots['Archmage'].loot[0].quantity = '1';
  loots['Archmage'].loot[0].chance = 50;
  ...
  loots['Archmage'].loot[7].objname = 'Audachta3';
  loots['Archmage'].loot[7].quantity = '1';
  loots['Archmage'].loot[7].chance = 10;
  loots['Archmage'].loot[8] = {};
  loots['Archmage'].loot[8].objname = 'Audachta4';
  loots['Archmage'].loot[8].quantity = '1';
  loots['Archmage'].loot[8].chance = 10;
  loots['Archmage'].loot[9] = {};
  loots['Archmage'].loot[9].objname = 'Audachta2';
  loots['Archmage'].loot[9].quantity = '1';
  loots['Archmage'].loot[9].chance = 15;
  loots['Archmage'].loot[10] = {};
  loots['Archmage'].loot[10].objname = 'Potions3';
  ...
  loots['Spiders'].loot[1].objname = 'Scrolls1';
  ...
  loots['archdaemon_ashes'].goldDice = '3d20+20';
  loots['archdaemon_ashes'].goldChance = 100;
  loots['archdaemon_ashes'].loot[0] = {};
  loots['archdaemon_ashes'].loot[0].objname = 'Heavy Weapon';
  loots['archdaemon_ashes'].loot[0].quantity = '1';
  loots['archdaemon_ashes'].loot[0].chance = 35;
  loots['archdaemon_ashes'].loot[1] = {};
  loots['archdaemon_ashes'].loot[1].objname = 'Scrolls6';
  loots['archdaemon_ashes'].loot[1].quantity = '1';
  loots['archdaemon_ashes'].loot[1].chance = 40;
  loots['archdaemon_ashes'].loot[2] = {};
  loots['archdaemon_ashes'].loot[2].objname = 'Potions4';
  loots['archdaemon_ashes'].loot[2].quantity = '1';
  loots['archdaemon_ashes'].loot[2].chance = 30;
  loots['archdaemon_ashes'].loot[3] = {};
  loots['archdaemon_ashes'].loot[3].objname = 'Heavy Armor';
  loots['archdaemon_ashes'].loot[3].quantity = '1';
  loots['archdaemon_ashes'].loot[3].chance = 35;
  loots['archdaemon_ashes'].loot[4] = {};
  loots['archdaemon_ashes'].loot[4].objname = 'Potions2';
  loots['archdaemon_ashes'].loot[4].quantity = '1d2';
  loots['archdaemon_ashes'].loot[4].chance = 50;
  loots['archdaemon_ashes'].loot[5] = {};
  loots['archdaemon_ashes'].loot[5].objname = 'Scrolls5';
  loots['archdaemon_ashes'].loot[5].quantity = '1';
  loots['archdaemon_ashes'].loot[5].chance = 50;
  loots['archdaemon_ashes'].loot[6] = {};
  loots['archdaemon_ashes'].loot[6].objname = 'Scrolls4';
  loots['archdaemon_ashes'].loot[6].quantity = '1d2';
  loots['archdaemon_ashes'].loot[6].chance = 50;
  loots['archdaemon_ashes'].loot[7] = {};
  loots['archdaemon_ashes'].loot[7].objname = 'Medium Weapon';
  loots['archdaemon_ashes'].loot[7].quantity = '1';
  loots['archdaemon_ashes'].loot[7].chance = 25;
  loots['archdaemon_ashes'].loot[8] = {};
  loots['archdaemon_ashes'].loot[8].objname = 'Medium Armor';
  loots['archdaemon_ashes'].loot[8].quantity = '1';
  loots['archdaemon_ashes'].loot[8].chance = 25;
  ...
  loots['archdaemon_ashes'].loot[10] = {};
  loots['archdaemon_ashes'].loot[10].objname = 'Potions1';
  loots['archdaemon_ashes'].loot[10].quantity = '1d2';
  loots['archdaemon_ashes'].loot[10].chance = 50;
  loots['archdaemon_ashes'].loot[11] = {};
  loots['archdaemon_ashes'].loot[11].objname = 'Potions3';
  loots['archdaemon_ashes'].loot[11].quantity = '1';
  loots['archdaemon_ashes'].loot[11].chance = 30;
  loots['archdaemon_ashes'].loot[12] = {};
  loots['archdaemon_ashes'].loot[12].objname = 'Scrolls7';
  loots['archdaemon_ashes'].loot[12].quantity = '1';
  loots['archdaemon_ashes'].loot[12].chance = 30;
  loots['archdaemon_ashes'].loot[13] = {};
  loots['archdaemon_ashes'].loot[13].objname = 'Scrolls3';
  loots['archdaemon_ashes'].loot[13].quantity = '1d2';
  loots['archdaemon_ashes'].loot[13].chance = 50;
  ...
  loots['Shadow2'].loot[2].objname = 'Lesser Weapon';
  loots['Shadow2'].loot[2].quantity = '1';
  loots['Shadow2'].loot[2].chance = 25;
  ...
  loots['High Adventurer'].loot[4].objname = 'BluePalmCrystal';
  ...
  loots['Level6'].loot[9] = {};
  loots['Level6'].loot[9].objname = 'Potions1';
  ...
  loots['Level6'].loot[11].objname = 'Potions3';
  ...
  loots['Underworld3'].goldDice = '3d20+10';
  ...
  loots['Reaper'] = new LootTable();
  loots['Reaper'].goldDice = '5d12+25';
  loots['Reaper'].goldChance = 70;
  loots['Reaper'].loot[0] = {};
  loots['Reaper'].loot[0].objname = 'Medium Armor';
  loots['Reaper'].loot[0].quantity = '1';
  loots['Reaper'].loot[0].chance = 25;
  loots['Reaper'].loot[1] = {};
  loots['Reaper'].loot[1].objname = 'Medium Weapon';
  loots['Reaper'].loot[1].quantity = '1';
  loots['Reaper'].loot[1].chance = 20;
  loots['Reaper'].loot[2] = {};
  loots['Reaper'].loot[2].objname = 'Scrolls5';
  loots['Reaper'].loot[2].quantity = '1';
  loots['Reaper'].loot[2].chance = 25;
  loots['Reaper'].loot[3] = {};
  loots['Reaper'].loot[3].objname = 'Scrolls4';
  loots['Reaper'].loot[3].quantity = '1d2';
  loots['Reaper'].loot[3].chance = 25;
  loots['Reaper'].loot[4] = {};
  loots['Reaper'].loot[4].objname = 'LightningWood';
  loots['Reaper'].loot[4].quantity = '1';
  loots['Reaper'].loot[4].chance = 25;
  loots['Reaper'].loot[5] = {};
  loots['Reaper'].loot[5].objname = 'Potions4';
  loots['Reaper'].loot[5].quantity = '1d2';
  loots['Reaper'].loot[5].chance = 35;
  loots['Reaper'].loot[6] = {};
  loots['Reaper'].loot[6].objname = 'Potions2';
  loots['Reaper'].loot[6].quantity = '1d2';
  loots['Reaper'].loot[6].chance = 30;
  loots['Reaper'].loot[7] = {};
  loots['Reaper'].loot[7].objname = 'Heavy Armor';
  loots['Reaper'].loot[7].quantity = '1';
  loots['Reaper'].loot[7].chance = 25;
  loots['Reaper'].loot[8] = {};
  loots['Reaper'].loot[8].objname = 'Scrolls6';
  loots['Reaper'].loot[8].quantity = '1';
  loots['Reaper'].loot[8].chance = 20;
  loots['Reaper'].loot[9] = {};
  loots['Reaper'].loot[9].objname = 'BloodMoss';
  loots['Reaper'].loot[9].quantity = '1';
  loots['Reaper'].loot[9].chance = 30;
  loots['Reaper'].loot[10] = {};
  loots['Reaper'].loot[10].objname = 'Heavy Weapon';
  loots['Reaper'].loot[10].quantity = '1';
  loots['Reaper'].loot[10].chance = 35;
  loots['Reaper'].loot[11] = {};
  loots['Reaper'].loot[11].objname = 'Scrolls3';
  loots['Reaper'].loot[11].quantity = '1d2';
  loots['Reaper'].loot[11].chance = 25;
  loots['Reaper'].loot[12] = {};
  loots['Reaper'].loot[12].objname = 'Potions3';
  loots['Reaper'].loot[12].quantity = '1d2';
  loots['Reaper'].loot[12].chance = 35;
  loots['Reaper'].loot[13] = {};
  loots['Reaper'].loot[13].objname = 'Potions1';
  loots['Reaper'].loot[13].quantity = '1d2';
  loots['Reaper'].loot[13].chance = 30;
  loots['Reaper'].trap = 'strong';
  ...
  loots['Ghost'].loot[1] = {};
  loots['Ghost'].loot[1].objname = 'PurplePalmCrystal';
  loots['Ghost'].loot[1].quantity = '1';
  loots['Ghost'].loot[1].chance = 5;
  loots['Ghost'].loot[2] = {};
  ...
  loots['archdaemon_bone'].goldDice = '3d20+20';
  loots['archdaemon_bone'].goldChance = 100;
  loots['archdaemon_bone'].loot[0] = {};
  loots['archdaemon_bone'].loot[0].objname = 'Potions3';
  loots['archdaemon_bone'].loot[0].quantity = '1';
  loots['archdaemon_bone'].loot[0].chance = 30;
  loots['archdaemon_bone'].loot[1] = {};
  loots['archdaemon_bone'].loot[1].objname = 'Scrolls7';
  loots['archdaemon_bone'].loot[1].quantity = '1';
  loots['archdaemon_bone'].loot[1].chance = 30;
  loots['archdaemon_bone'].loot[2] = {};
  loots['archdaemon_bone'].loot[2].objname = 'Scrolls3';
  loots['archdaemon_bone'].loot[2].quantity = '1d2';
  loots['archdaemon_bone'].loot[2].chance = 50;
  loots['archdaemon_bone'].loot[3] = {};
  loots['archdaemon_bone'].loot[3].objname = 'KeyOfBone';
  loots['archdaemon_bone'].loot[3].quantity = '1';
  loots['archdaemon_bone'].loot[3].chance = 100;
  loots['archdaemon_bone'].loot[4] = {};
  loots['archdaemon_bone'].loot[4].objname = 'Potions1';
  loots['archdaemon_bone'].loot[4].quantity = '1d2';
  loots['archdaemon_bone'].loot[4].chance = 50;
  loots['archdaemon_bone'].loot[5] = {};
  loots['archdaemon_bone'].loot[5].objname = 'Medium Weapon';
  loots['archdaemon_bone'].loot[5].quantity = '1';
  loots['archdaemon_bone'].loot[5].chance = 25;
  loots['archdaemon_bone'].loot[6] = {};
  loots['archdaemon_bone'].loot[6].objname = 'Medium Armor';
  loots['archdaemon_bone'].loot[6].quantity = '1';
  loots['archdaemon_bone'].loot[6].chance = 25;
  loots['archdaemon_bone'].loot[7] = {};
  loots['archdaemon_bone'].loot[7].objname = 'Heavy Weapon';
  loots['archdaemon_bone'].loot[7].quantity = '1';
  loots['archdaemon_bone'].loot[7].chance = 35;
  loots['archdaemon_bone'].loot[8] = {};
  loots['archdaemon_bone'].loot[8].objname = 'Scrolls6';
  loots['archdaemon_bone'].loot[8].quantity = '1';
  loots['archdaemon_bone'].loot[8].chance = 40;
  loots['archdaemon_bone'].loot[9] = {};
  loots['archdaemon_bone'].loot[9].objname = 'Heavy Armor';
  loots['archdaemon_bone'].loot[9].quantity = '1';
  loots['archdaemon_bone'].loot[9].chance = 35;
  loots['archdaemon_bone'].loot[10] = {};
  loots['archdaemon_bone'].loot[10].objname = 'Potions4';
  loots['archdaemon_bone'].loot[10].quantity = '1';
  loots['archdaemon_bone'].loot[10].chance = 30;
  loots['archdaemon_bone'].loot[11] = {};
  loots['archdaemon_bone'].loot[11].objname = 'Potions2';
  loots['archdaemon_bone'].loot[11].quantity = '1d2';
  loots['archdaemon_bone'].loot[11].chance = 50;
  loots['archdaemon_bone'].loot[12] = {};
  loots['archdaemon_bone'].loot[12].objname = 'Scrolls5';
  loots['archdaemon_bone'].loot[12].quantity = '1';
  loots['archdaemon_bone'].loot[12].chance = 50;
  loots['archdaemon_bone'].loot[13] = {};
  loots['archdaemon_bone'].loot[13].objname = 'Scrolls4';
  loots['archdaemon_bone'].loot[13].quantity = '1d2';
  loots['archdaemon_bone'].loot[13].chance = 50;
  ...
  loots['Willowisp'].loot[0].objname = 'Audachta2';
  ...
  loots['Willowisp'].loot[2].objname = 'Audachta1';
  ...
  loots['Phantom'].loot[1].objname = 'GreenPalmCrystal';
  loots['Phantom'].loot[1].quantity = '1';
  loots['Phantom'].loot[1].chance = 10;
  loots['Phantom'].loot[2] = {};
  loots['Phantom'].loot[2].objname = 'BluePalmCrystal';
  loots['Phantom'].loot[2].quantity = '1';
  loots['Phantom'].loot[2].chance = 20;
  ...
  loots['Headlesses'].loot[0].objname = 'Lesser Weapon';
  loots['Headlesses'].loot[0].quantity = '1';
  loots['Headlesses'].loot[0].chance = 40;
  ...
  loots['Minor Adventurer'].loot[0].objname = 'Torch';
  ...
  loots['Minor Adventurer'].loot[3].objname = 'Potions1';
  ...
  loots['Level7'].loot[9] = {};
  loots['Level7'].loot[9].objname = 'Potions1';
  ...
  loots['Lesser Adventurer'].loot[0].objname = 'Lesser Weapon';
  loots['Lesser Adventurer'].loot[0].quantity = '1';
  loots['Lesser Adventurer'].loot[0].chance = 20;
  loots['Lesser Adventurer'].loot[1] = {};
  loots['Lesser Adventurer'].loot[1].objname = 'Torch';
  loots['Lesser Adventurer'].loot[1].quantity = '1d2';
  loots['Lesser Adventurer'].loot[1].chance = 50;
  ...
  loots['Toshin'].loot[1] = {};
  loots['Toshin'].loot[1].objname = 'Scrolls5';
  loots['Toshin'].loot[1].quantity = '1';
  loots['Toshin'].loot[1].chance = 25;
  loots['Toshin'].loot[2] = {};
  ...
  loots['Toshin'].loot[4] = {};
  loots['Toshin'].loot[4].objname = 'Potions1';
  loots['Toshin'].loot[4].quantity = '1';
  loots['Toshin'].loot[4].chance = 35;
  loots['Toshin'].loot[5] = {};
  loots['Toshin'].loot[5].objname = 'Audachta1';
  ...
  loots['Toshin'].loot[7] = {};
  loots['Toshin'].loot[7].objname = 'Potions3';
  loots['Toshin'].loot[7].quantity = '1';
  loots['Toshin'].loot[7].chance = 30;
  loots['Toshin'].loot[8] = {};
  loots['Toshin'].loot[8].objname = 'Audachta2';
  loots['Toshin'].loot[8].quantity = '1';
  loots['Toshin'].loot[8].chance = 10;
  ...
  loots['Level4'].loot[0] = {};
  loots['Level4'].loot[0].objname = 'BluePalmCrystal';
  loots['Level4'].loot[0].quantity = '1';
  loots['Level4'].loot[0].chance = 10;
  loots['Level4'].loot[1] = {};
  loots['Level4'].loot[1].objname = 'Mid Weapon';
  loots['Level4'].loot[1].quantity = '1';
  loots['Level4'].loot[1].chance = 45;
  loots['Level4'].loot[2] = {};
  loots['Level4'].loot[2].objname = 'Scrolls3';
  loots['Level4'].loot[2].quantity = '1d2';
  loots['Level4'].loot[2].chance = 20;
  loots['Level4'].loot[3] = {};
  loots['Level4'].loot[3].objname = 'Medium Armor';
  loots['Level4'].loot[3].quantity = '1';
  loots['Level4'].loot[3].chance = 40;
  loots['Level4'].loot[4] = {};
  loots['Level4'].loot[4].objname = 'Lesser Weapon';
  loots['Level4'].loot[4].quantity = '1';
  loots['Level4'].loot[4].chance = 20;
  loots['Level4'].loot[5] = {};
  ...
  loots['Trolls'].loot[0] = {};
  loots['Trolls'].loot[0].objname = 'Mid Ranged';
  loots['Trolls'].loot[0].quantity = '1';
  loots['Trolls'].loot[0].chance = 25;
  loots['Trolls'].loot[1] = {};
  loots['Trolls'].loot[1].objname = 'Torch';
  loots['Trolls'].loot[1].quantity = '1';
  loots['Trolls'].loot[1].chance = 15;
  loots['Trolls'].loot[2] = {};
  loots['Trolls'].loot[2].objname = 'Lesser Weapon';
  loots['Trolls'].loot[2].quantity = '1';
  loots['Trolls'].loot[2].chance = 40;
  loots['Trolls'].loot[3] = {};
  ...
  loots['castlechest'].loot[3].objname = 'Scrolls3';
  loots['castlechest'].loot[3].quantity = '1';
  loots['castlechest'].loot[3].chance = 20;
  ...
  loots['castlechest'].loot[5].objname = 'Scrolls7';
  ...
  loots['castlechest'].loot[14].objname = 'BluePalmCrystal';
  ...
  loots['Adventurer'].loot[0].objname = 'Potions1';
  loots['Adventurer'].loot[0].quantity = '1';
  loots['Adventurer'].loot[0].chance = 20;
  ...
  loots['Adventurer'].loot[4].objname = 'Mid Weapon';
  loots['Adventurer'].loot[4].quantity = '1';
  loots['Adventurer'].loot[4].chance = 30;
  ...
  loots['Adventurer'].loot[6].objname = 'Lesser Weapon';
  loots['Adventurer'].loot[6].quantity = '1';
  loots['Adventurer'].loot[6].chance = 10;
  ...
  loots['worldsendcorpse'].goldDice = '3d20';
  ...
  loots['archdaemon_ice'].goldDice = '3d20+20';
  loots['archdaemon_ice'].goldChance = 100;
  loots['archdaemon_ice'].loot[0] = {};
  loots['archdaemon_ice'].loot[0].objname = 'Scrolls3';
  loots['archdaemon_ice'].loot[0].quantity = '1d2';
  loots['archdaemon_ice'].loot[0].chance = 50;
  loots['archdaemon_ice'].loot[1] = {};
  loots['archdaemon_ice'].loot[1].objname = 'Scrolls7';
  loots['archdaemon_ice'].loot[1].quantity = '1';
  loots['archdaemon_ice'].loot[1].chance = 30;
  loots['archdaemon_ice'].loot[2] = {};
  loots['archdaemon_ice'].loot[2].objname = 'Potions3';
  loots['archdaemon_ice'].loot[2].quantity = '1';
  loots['archdaemon_ice'].loot[2].chance = 30;
  loots['archdaemon_ice'].loot[3] = {};
  loots['archdaemon_ice'].loot[3].objname = 'Potions1';
  loots['archdaemon_ice'].loot[3].quantity = '1d2';
  loots['archdaemon_ice'].loot[3].chance = 50;
  loots['archdaemon_ice'].loot[4] = {};
  loots['archdaemon_ice'].loot[4].objname = 'KeyOfIce';
  loots['archdaemon_ice'].loot[4].quantity = '1';
  loots['archdaemon_ice'].loot[4].chance = 100;
  loots['archdaemon_ice'].loot[5] = {};
  loots['archdaemon_ice'].loot[5].objname = 'Medium Armor';
  loots['archdaemon_ice'].loot[5].quantity = '1';
  loots['archdaemon_ice'].loot[5].chance = 25;
  loots['archdaemon_ice'].loot[6] = {};
  loots['archdaemon_ice'].loot[6].objname = 'Medium Weapon';
  loots['archdaemon_ice'].loot[6].quantity = '1';
  loots['archdaemon_ice'].loot[6].chance = 25;
  loots['archdaemon_ice'].loot[7] = {};
  loots['archdaemon_ice'].loot[7].objname = 'Scrolls5';
  loots['archdaemon_ice'].loot[7].quantity = '1';
  ...
  loots['archdaemon_ice'].loot[9].objname = 'Potions4';
  loots['archdaemon_ice'].loot[9].quantity = '1';
  loots['archdaemon_ice'].loot[9].chance = 30;
  loots['archdaemon_ice'].loot[10] = {};
  loots['archdaemon_ice'].loot[10].objname = 'Potions2';
  loots['archdaemon_ice'].loot[10].quantity = '1d2';
  loots['archdaemon_ice'].loot[10].chance = 50;
  loots['archdaemon_ice'].loot[11] = {};
  loots['archdaemon_ice'].loot[11].objname = 'Heavy Armor';
  loots['archdaemon_ice'].loot[11].quantity = '1';
  loots['archdaemon_ice'].loot[11].chance = 35;
  loots['archdaemon_ice'].loot[12] = {};
  loots['archdaemon_ice'].loot[12].objname = 'Scrolls6';
  loots['archdaemon_ice'].loot[12].quantity = '1';
  loots['archdaemon_ice'].loot[12].chance = 40;
  loots['archdaemon_ice'].loot[13] = {};
  loots['archdaemon_ice'].loot[13].objname = 'Heavy Weapon';
  loots['archdaemon_ice'].loot[13].quantity = '1';
  loots['archdaemon_ice'].loot[13].chance = 35;
  ...
  loots['Specter'].loot[2].objname = 'BluePalmCrystal';
  loots['Specter'].loot[2].quantity = '1';
  loots['Specter'].loot[2].chance = 20;
  loots['Specter'].loot[3] = {};
  loots['Specter'].loot[3].objname = 'Scrolls3';
  loots['Specter'].loot[3].quantity = '1';
  loots['Specter'].loot[3].chance = 20;
  ...
  loots['Specter'].loot[5].objname = 'Scrolls4';
  loots['Specter'].loot[5].quantity = '1';
  loots['Specter'].loot[5].chance = 15;
  ...
  loots['Specter'].loot[7].objname = 'PurplePalmCrystal';
  loots['Specter'].loot[7].quantity = '1';
  loots['Specter'].loot[7].chance = 15;
  loots['Specter'].loot[8] = {};
  loots['Specter'].loot[8].objname = 'GreenPalmCrystal';
  loots['Specter'].loot[8].quantity = '1';
  loots['Specter'].loot[8].chance = 10;
  ...
  loots['dragon'].goldDice = '5d12+25';
  loots['dragon'].goldChance = 100;
  loots['dragon'].loot[0] = {};
  loots['dragon'].loot[0].objname = 'Scrolls5';
  loots['dragon'].loot[0].quantity = '1';
  loots['dragon'].loot[0].chance = 25;
  loots['dragon'].loot[1] = {};
  loots['dragon'].loot[1].objname = 'Scrolls4';
  loots['dragon'].loot[1].quantity = '1d2';
  loots['dragon'].loot[1].chance = 25;
  loots['dragon'].loot[2] = {};
  loots['dragon'].loot[2].objname = 'Heavy Armor';
  loots['dragon'].loot[2].quantity = '1';
  loots['dragon'].loot[2].chance = 35;
  loots['dragon'].loot[3] = {};
  loots['dragon'].loot[3].objname = 'Potions4';
  ...
  loots['dragon'].loot[5] = {};
  loots['dragon'].loot[5].objname = 'Scrolls6';
  loots['dragon'].loot[5].quantity = '1';
  loots['dragon'].loot[5].chance = 20;
  loots['dragon'].loot[6] = {};
  loots['dragon'].loot[6].objname = 'Heavy Weapon';
  loots['dragon'].loot[6].quantity = '1';
  loots['dragon'].loot[6].chance = 35;
  loots['dragon'].loot[7] = {};
  loots['dragon'].loot[7].objname = 'Medium Armor';
  loots['dragon'].loot[7].quantity = '1';
  loots['dragon'].loot[7].chance = 25;
  loots['dragon'].loot[8] = {};
  loots['dragon'].loot[8].objname = 'Medium Weapon';
  loots['dragon'].loot[8].quantity = '1';
  loots['dragon'].loot[8].chance = 35;
  loots['dragon'].loot[9] = {};
  ...
  loots['dragon'].loot[11].objname = 'Scrolls3';
  loots['dragon'].loot[11].quantity = '1d2';
  loots['dragon'].loot[11].chance = 25;
  loots['dragon'].loot[12] = {};
  loots['dragon'].loot[12].objname = 'Potions3';
  loots['dragon'].loot[12].quantity = '1d2';
  loots['dragon'].loot[12].chance = 20;
  ...
  loots['Ettin Sorcerer'].loot[0].objname = 'Scrolls3';
  loots['Ettin Sorcerer'].loot[0].quantity = '1';
  loots['Ettin Sorcerer'].loot[0].chance = 25;
  loots['Ettin Sorcerer'].loot[1] = {};
  loots['Ettin Sorcerer'].loot[1].objname = 'Medium Armor';
  loots['Ettin Sorcerer'].loot[1].quantity = '1';
  loots['Ettin Sorcerer'].loot[1].chance = 50;
  loots['Ettin Sorcerer'].loot[2] = {};
  loots['Ettin Sorcerer'].loot[2].objname = 'Medium Weapon';
  loots['Ettin Sorcerer'].loot[2].quantity = '1';
  loots['Ettin Sorcerer'].loot[2].chance = 20;
  loots['Ettin Sorcerer'].loot[3] = {};
  loots['Ettin Sorcerer'].loot[3].objname = 'Lesser Weapon';
  loots['Ettin Sorcerer'].loot[3].quantity = '1';
  loots['Ettin Sorcerer'].loot[3].chance = 30;
  ...
  loots['Ettin Sorcerer'].loot[5].objname = 'Mid Weapon';
  loots['Ettin Sorcerer'].loot[5].quantity = '1';
  loots['Ettin Sorcerer'].loot[5].chance = 60;
  loots['Ettin Sorcerer'].loot[6] = {};
  loots['Ettin Sorcerer'].loot[6].objname = 'Scrolls2';
  loots['Ettin Sorcerer'].loot[6].quantity = '1d2';
  loots['Ettin Sorcerer'].loot[6].chance = 75;
  loots['Ettin Sorcerer'].loot[7] = {};
  loots['Ettin Sorcerer'].loot[7].objname = 'Mid Ranged';
  loots['Ettin Sorcerer'].loot[7].quantity = '1';
  loots['Ettin Sorcerer'].loot[7].chance = 15;
  loots['Ettin Sorcerer'].trap = 'medium';

  loots['EttinJournalist'] = new LootTable();
  loots['EttinJournalist'].goldDice = '7d10+15';
  ...
  loots['EttinJournalist'].loot[1].objname = 'Mid Ranged';
  loots['EttinJournalist'].loot[1].quantity = '1';
  loots['EttinJournalist'].loot[1].chance = 15;
  loots['EttinJournalist'].loot[2] = {};
  loots['EttinJournalist'].loot[2].objname = 'Potions1';
  loots['EttinJournalist'].loot[2].quantity = '1';
  loots['EttinJournalist'].loot[2].chance = 50;
  loots['EttinJournalist'].loot[3] = {};
  loots['EttinJournalist'].loot[3].objname = 'Lesser Weapon';
  loots['EttinJournalist'].loot[3].quantity = '1';
  loots['EttinJournalist'].loot[3].chance = 30;
  loots['EttinJournalist'].loot[4] = {};
  loots['EttinJournalist'].loot[4].objname = 'Medium Weapon';
  loots['EttinJournalist'].loot[4].quantity = '1';
  loots['EttinJournalist'].loot[4].chance = 20;
  ...
  loots['archdaemon_dust'].goldDice = '3d20+20';
  loots['archdaemon_dust'].goldChance = 100;
  loots['archdaemon_dust'].loot[0] = {};
  loots['archdaemon_dust'].loot[0].objname = 'Scrolls3';
  loots['archdaemon_dust'].loot[0].quantity = '1d2';
  loots['archdaemon_dust'].loot[0].chance = 50;
  loots['archdaemon_dust'].loot[1] = {};
  loots['archdaemon_dust'].loot[1].objname = 'Scrolls7';
  loots['archdaemon_dust'].loot[1].quantity = '1';
  loots['archdaemon_dust'].loot[1].chance = 30;
  loots['archdaemon_dust'].loot[2] = {};
  loots['archdaemon_dust'].loot[2].objname = 'Potions3';
  loots['archdaemon_dust'].loot[2].quantity = '1';
  loots['archdaemon_dust'].loot[2].chance = 30;
  loots['archdaemon_dust'].loot[3] = {};
  loots['archdaemon_dust'].loot[3].objname = 'Potions1';
  loots['archdaemon_dust'].loot[3].quantity = '1d2';
  loots['archdaemon_dust'].loot[3].chance = 50;
  ...
  loots['archdaemon_dust'].loot[5].objname = 'Medium Armor';
  loots['archdaemon_dust'].loot[5].quantity = '1';
  loots['archdaemon_dust'].loot[5].chance = 25;
  loots['archdaemon_dust'].loot[6] = {};
  loots['archdaemon_dust'].loot[6].objname = 'Medium Weapon';
  loots['archdaemon_dust'].loot[6].quantity = '1';
  loots['archdaemon_dust'].loot[6].chance = 25;
  loots['archdaemon_dust'].loot[7] = {};
  loots['archdaemon_dust'].loot[7].objname = 'Scrolls5';
  loots['archdaemon_dust'].loot[7].quantity = '1';
  loots['archdaemon_dust'].loot[7].chance = 50;
  ...
  loots['archdaemon_dust'].loot[9].objname = 'Potions4';
  loots['archdaemon_dust'].loot[9].quantity = '1';
  loots['archdaemon_dust'].loot[9].chance = 30;
  loots['archdaemon_dust'].loot[10] = {};
  loots['archdaemon_dust'].loot[10].objname = 'Potions2';
  loots['archdaemon_dust'].loot[10].quantity = '1d2';
  loots['archdaemon_dust'].loot[10].chance = 50;
  loots['archdaemon_dust'].loot[11] = {};
  loots['archdaemon_dust'].loot[11].objname = 'Heavy Armor';
  loots['archdaemon_dust'].loot[11].quantity = '1';
  loots['archdaemon_dust'].loot[11].chance = 35;
  loots['archdaemon_dust'].loot[12] = {};
  loots['archdaemon_dust'].loot[12].objname = 'Scrolls6';
  loots['archdaemon_dust'].loot[12].quantity = '1';
  loots['archdaemon_dust'].loot[12].chance = 40;
  loots['archdaemon_dust'].loot[13] = {};
  loots['archdaemon_dust'].loot[13].objname = 'Heavy Weapon';
  loots['archdaemon_dust'].loot[13].quantity = '1';
  loots['archdaemon_dust'].loot[13].chance = 35;
  ...
  loots['potshigh'].loot[0].objname = 'Potions4';
  loots['potshigh'].loot[0].quantity = '1';
  loots['potshigh'].loot[0].chance = 33;
  ...
  loots['Level3'].loot[0] = {};
  loots['Level3'].loot[0].objname = 'Mid Weapon';
  loots['Level3'].loot[0].quantity = '1';
  loots['Level3'].loot[0].chance = 35;
  loots['Level3'].loot[1] = {};
  loots['Level3'].loot[1].objname = 'BluePalmCrystal';
  loots['Level3'].loot[1].quantity = '1';
  loots['Level3'].loot[1].chance = 5;
  loots['Level3'].loot[2] = {};
  ...
  loots['Level3'].loot[5] = {};
  loots['Level3'].loot[5].objname = 'Potions2';
  loots['Level3'].loot[5].quantity = '1';
  loots['Level3'].loot[5].chance = 20;
  loots['Level3'].loot[6] = {};
  loots['Level3'].loot[6].objname = 'Potions1';
  loots['Level3'].loot[6].quantity = '1d2';
  loots['Level3'].loot[6].chance = 35;
  loots['Level3'].loot[7] = {};
  loots['Level3'].loot[7].objname = 'Scrolls2';
  loots['Level3'].loot[7].quantity = '1';
  loots['Level3'].loot[7].chance = 25;
  loots['Level3'].loot[8] = {};
  loots['Level3'].loot[8].objname = 'Scrolls1';
  loots['Level3'].loot[8].quantity = '1';
  loots['Level3'].loot[8].chance = 10;
  loots['Level3'].loot[9] = {};
  loots['Level3'].loot[9].objname = 'GreenPalmCrystal';
  loots['Level3'].loot[9].quantity = '1';
  loots['Level3'].loot[9].chance = 5;
  ...
  loots['High Orcs'].loot[2].objname = 'Medium Weapon';
  loots['High Orcs'].loot[2].quantity = '1';
  loots['High Orcs'].loot[2].chance = 20;
  ...
  loots['High Orcs'].loot[4].objname = 'Potions2';
  loots['High Orcs'].loot[4].quantity = '1';
  loots['High Orcs'].loot[4].chance = 30;
  ...
  loots['Devourer'].goldDice = '7d10';
  loots['Devourer'].goldChance = 65;
  loots['Devourer'].loot[0] = {};
  loots['Devourer'].loot[0].objname = 'Lesser Weapon';
  loots['Devourer'].loot[0].quantity = '1';
  loots['Devourer'].loot[0].chance = 20;
  loots['Devourer'].loot[1] = {};
  loots['Devourer'].loot[1].objname = 'Medium Armor';
  loots['Devourer'].loot[1].quantity = '1';
  loots['Devourer'].loot[1].chance = 40;
  loots['Devourer'].loot[2] = {};
  loots['Devourer'].loot[2].objname = 'BluePalmCrystal';
  loots['Devourer'].loot[2].quantity = '1';
  loots['Devourer'].loot[2].chance = 10;
  loots['Devourer'].loot[3] = {};
  loots['Devourer'].loot[3].objname = 'Potions2';
  loots['Devourer'].loot[3].quantity = '1';
  loots['Devourer'].loot[3].chance = 35;
  loots['Devourer'].loot[4] = {};
  loots['Devourer'].loot[4].objname = 'Scrolls4';
  loots['Devourer'].loot[4].quantity = '1';
  loots['Devourer'].loot[4].chance = 15;
  loots['Devourer'].loot[5] = {};
  loots['Devourer'].loot[5].objname = 'Scrolls2';
  loots['Devourer'].loot[5].quantity = '1d2';
  loots['Devourer'].loot[5].chance = 25;
  loots['Devourer'].loot[6] = {};
  loots['Devourer'].loot[6].objname = 'Scrolls3';
  loots['Devourer'].loot[6].quantity = '1d2';
  loots['Devourer'].loot[6].chance = 20;
  loots['Devourer'].loot[7] = {};
  loots['Devourer'].loot[7].objname = 'Mid Weapon';
  loots['Devourer'].loot[7].quantity = '1';
  loots['Devourer'].loot[7].chance = 45;
  loots['Devourer'].loot[8] = {};
  loots['Devourer'].loot[8].objname = 'PurplePalmCrystal';
  loots['Devourer'].loot[8].quantity = '1';
  loots['Devourer'].loot[8].chance = 5;
  loots['Devourer'].loot[9] = {};
  loots['Devourer'].loot[9].objname = 'MagicAxe';
  loots['Devourer'].loot[9].quantity = '1';
  loots['Devourer'].loot[9].chance = 100;
  ...
  loots['Devourer'].loot[11] = {};
  loots['Devourer'].loot[11].objname = 'Scrolls1';
  loots['Devourer'].loot[11].quantity = '1';
  loots['Devourer'].loot[11].chance = 10;
  ...
  loots['Ettin'].loot[2] = {};
  loots['Ettin'].loot[2].objname = 'Lesser Weapon';
  loots['Ettin'].loot[2].quantity = '1';
  loots['Ettin'].loot[2].chance = 30;
  loots['Ettin'].loot[3] = {};
  loots['Ettin'].loot[3].objname = 'Medium Weapon';
  loots['Ettin'].loot[3].quantity = '1';
  loots['Ettin'].loot[3].chance = 20;
  loots['Ettin'].loot[4] = {};
  loots['Ettin'].loot[4].objname = 'Mid Ranged';
  loots['Ettin'].loot[4].quantity = '1';
  loots['Ettin'].loot[4].chance = 15;
  loots['Ettin'].loot[5] = {};
  loots['Ettin'].loot[5].objname = 'Potions1';
  loots['Ettin'].loot[5].quantity = '1';
  loots['Ettin'].loot[5].chance = 50;
