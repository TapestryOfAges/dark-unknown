...
function SetLoots() {
  ...
  loots['Toshin'].loot[3] = {};
  loots['Toshin'].loot[3].objname = 'Audachta2';
  ...
  loots['Level7'].loot[0] = {};
  loots['Level7'].loot[0].objname = 'Potions1';
  ...
  loots['Level7'].loot[10].objname = 'Scrolls6';
  loots['Level7'].loot[10].quantity = '1';
  loots['Level7'].loot[10].chance = 20;
  ...
  loots['Level3'].loot[2] = {};
  loots['Level3'].loot[2].objname = 'GreenPalmCrystal';
  ...
  loots['Level3'].loot[8] = {};
  loots['Level3'].loot[8].objname = 'Mid Weapon';
  ...
  loots['Level4'].loot[5] = {};
  loots['Level4'].loot[5].objname = 'BluePalmCrystal';
  loots['Level4'].loot[5].quantity = '1';
  loots['Level4'].loot[5].chance = 10;
  loots['Level4'].loot[6] = {};
  ...
  loots['Archmage'].loot[2].objname = 'Scrolls6';
  loots['Archmage'].loot[2].quantity = '1';
  loots['Archmage'].loot[2].chance = 20;
  ...
  loots['Archmage'].loot[9].objname = 'Scrolls5';
  ...
  loots['High Adventurer'].loot[15].objname = 'PurplePalmCrystal';
  ...
  loots['Specter'].loot[1].objname = 'Audachta3';
  ...
  loots['Level6'].loot[7] = {};
  loots['Level6'].loot[7].objname = 'Scrolls6';
  ...
  loots['Level5'].loot[4] = {};
  loots['Level5'].loot[4].objname = 'PurplePalmCrystal';
  loots['Level5'].loot[4].quantity = '1';
  loots['Level5'].loot[4].chance = 5;
  loots['Level5'].loot[5] = {};
  ...
  loots['Level5'].loot[12].objname = 'Scrolls5';
  loots['Level5'].loot[12].quantity = '1';
  loots['Level5'].loot[12].chance = 25;
