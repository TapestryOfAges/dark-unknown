...
function SetLoots() {
  ...
  loots['Archmage'].loot[0].objname = 'Audachta1';
  ...
  loots['Level5'].loot[11].objname = 'Potions3';
  ...
  loots['Level4'].loot[0] = {};
  loots['Level4'].loot[0].objname = 'Scrolls3';
  ...
  loots['castlechest'].loot[6].objname = 'Scrolls4';
  ...
  loots['Ettin'].loot[2] = {};
  loots['Ettin'].loot[2].objname = 'Medium Weapon';
  loots['Ettin'].loot[2].quantity = '1';
  loots['Ettin'].loot[2].chance = 20;
  loots['Ettin'].loot[3] = {};
  ...
  loots['High Adventurer'].loot[3].objname = 'Torch';
  loots['High Adventurer'].loot[3].quantity = '1d2';
  loots['High Adventurer'].loot[3].chance = 50;
  ...
  loots['High Adventurer'].loot[10].objname = 'Potions3';
