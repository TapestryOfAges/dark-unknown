...
function SetLoots() {
  ...
  loots['archdaemon_bone'].loot[4].objname = 'Scrolls6';
  loots['archdaemon_bone'].loot[4].quantity = '1';
  loots['archdaemon_bone'].loot[4].chance = 40;
  loots['archdaemon_bone'].loot[5] = {};
  loots['archdaemon_bone'].loot[5].objname = 'KeyOfBone';
  loots['archdaemon_bone'].loot[5].quantity = '1';
  loots['archdaemon_bone'].loot[5].chance = 100;
  loots['archdaemon_bone'].loot[6] = {};
  loots['archdaemon_bone'].loot[6].objname = 'Potions2';
  loots['archdaemon_bone'].loot[6].quantity = '1d2';
  loots['archdaemon_bone'].loot[6].chance = 50;
  loots['archdaemon_bone'].loot[7] = {};
  loots['archdaemon_bone'].loot[7].objname = 'Scrolls4';
  ...
  loots['Adventurer'].loot[4].objname = 'Potions1';
  loots['Adventurer'].loot[4].quantity = '1';
  loots['Adventurer'].loot[4].chance = 20;
  ...
  loots['Level5'].loot[6] = {};
  loots['Level5'].loot[6].objname = 'Potions1';
  ...
  loots['Level5'].loot[11].objname = 'Scrolls4';
  ...
  loots['dragon'].loot[0] = {};
  loots['dragon'].loot[0].objname = 'Mid Ranged';
  loots['dragon'].loot[0].quantity = '1';
  loots['dragon'].loot[0].chance = 15;
  loots['dragon'].loot[1] = {};
  ...
  loots['Level6'].loot[0] = {};
  loots['Level6'].loot[0].objname = 'Medium Weapon';
  loots['Level6'].loot[0].quantity = '1';
  loots['Level6'].loot[0].chance = 50;
  loots['Level6'].loot[1] = {};
  ...
  loots['Specter'].loot[0].objname = 'Audachta2';
  ...
  loots['Specter'].loot[8].objname = 'Audachta1';
  ...
  loots['archdaemon_ashes'].loot[1].objname = 'Potions3';
  ...
  loots['archdaemon_ashes'].loot[6].objname = 'Potions4';
  ...
  loots['Reaper'].loot[0] = {};
  loots['Reaper'].loot[0].objname = 'Potions1';
  loots['Reaper'].loot[0].quantity = '1d2';
  loots['Reaper'].loot[0].chance = 30;
  loots['Reaper'].loot[1] = {};
  loots['Reaper'].loot[1].objname = 'Heavy Weapon';
  loots['Reaper'].loot[1].quantity = '1';
  loots['Reaper'].loot[1].chance = 35;
  loots['Reaper'].loot[2] = {};
  loots['Reaper'].loot[2].objname = 'Scrolls6';
  loots['Reaper'].loot[2].quantity = '1';
  loots['Reaper'].loot[2].chance = 20;
  loots['Reaper'].loot[3] = {};
  loots['Reaper'].loot[3].objname = 'Heavy Armor';
  loots['Reaper'].loot[3].quantity = '1';
  loots['Reaper'].loot[3].chance = 25;
  loots['Reaper'].loot[4] = {};
  loots['Reaper'].loot[4].objname = 'Medium Weapon';
  loots['Reaper'].loot[4].quantity = '1';
  loots['Reaper'].loot[4].chance = 20;
  loots['Reaper'].loot[5] = {};
  loots['Reaper'].loot[5].objname = 'Scrolls3';
  loots['Reaper'].loot[5].quantity = '1d2';
  loots['Reaper'].loot[5].chance = 25;
  loots['Reaper'].loot[6] = {};
  ...
  loots['Reaper'].loot[9] = {};
  loots['Reaper'].loot[9].objname = 'Potions3';
  loots['Reaper'].loot[9].quantity = '1d2';
  loots['Reaper'].loot[9].chance = 35;
  loots['Reaper'].loot[10] = {};
  loots['Reaper'].loot[10].objname = 'Potions2';
  loots['Reaper'].loot[10].quantity = '1d2';
  loots['Reaper'].loot[10].chance = 30;
  loots['Reaper'].loot[11] = {};
  loots['Reaper'].loot[11].objname = 'Scrolls4';
  loots['Reaper'].loot[11].quantity = '1d2';
  loots['Reaper'].loot[11].chance = 25;
  loots['Reaper'].loot[12] = {};
  loots['Reaper'].loot[12].objname = 'Medium Armor';
  loots['Reaper'].loot[12].quantity = '1';
  loots['Reaper'].loot[12].chance = 25;
  loots['Reaper'].loot[13] = {};
  loots['Reaper'].loot[13].objname = 'BloodMoss';
  ...
  loots['Ettin Sorcerer'].loot[0].objname = 'Scrolls2';
  loots['Ettin Sorcerer'].loot[0].quantity = '1d2';
  loots['Ettin Sorcerer'].loot[0].chance = 75;
  ...
  loots['Ettin Sorcerer'].loot[2].objname = 'Mid Weapon';
  loots['Ettin Sorcerer'].loot[2].quantity = '1';
  loots['Ettin Sorcerer'].loot[2].chance = 60;
  ...
  loots['Level7'].loot[2] = {};
  loots['Level7'].loot[2].objname = 'Scrolls4';
  ...
  loots['Level7'].loot[4] = {};
  loots['Level7'].loot[4].objname = 'Medium Armor';
  ...
  loots['Level7'].loot[7] = {};
  loots['Level7'].loot[7].objname = 'Medium Weapon';
  ...
  loots['Level7'].loot[12].objname = 'Scrolls7';
  ...
  loots['EttinJournalist'].loot[0].objname = 'Potions1';
  loots['EttinJournalist'].loot[0].quantity = '1';
  loots['EttinJournalist'].loot[0].chance = 50;
  ...
  loots['EttinJournalist'].loot[6].objname = 'Lesser Weapon';
  loots['EttinJournalist'].loot[6].quantity = '1';
  loots['EttinJournalist'].loot[6].chance = 30;
  ...
  loots['archdaemon_ice'].loot[0].objname = 'Scrolls6';
  loots['archdaemon_ice'].loot[0].quantity = '1';
  loots['archdaemon_ice'].loot[0].chance = 40;
  ...
  loots['archdaemon_ice'].loot[2].objname = 'Potions4';
  ...
  loots['archdaemon_ice'].loot[4].objname = 'Scrolls7';
  ...
  loots['archdaemon_ice'].loot[7].objname = 'KeyOfIce';
  loots['archdaemon_ice'].loot[7].quantity = '1';
  loots['archdaemon_ice'].loot[7].chance = 100;
  ...
  loots['archdaemon_dust'].loot[7].objname = 'Potions3';
  ...
  loots['archdaemon_dust'].loot[9].objname = 'KeyOfDust';
  loots['archdaemon_dust'].loot[9].quantity = '1';
  loots['archdaemon_dust'].loot[9].chance = 100;
  ...
  loots['Level4'].loot[7] = {};
  loots['Level4'].loot[7].objname = 'Scrolls4';
  loots['Level4'].loot[7].quantity = '1';
  loots['Level4'].loot[7].chance = 15;
  loots['Level4'].loot[8] = {};
  ...
  loots['Archmage'].loot[5].objname = 'Audachta2';
  loots['Archmage'].loot[5].quantity = '1';
  loots['Archmage'].loot[5].chance = 15;
  loots['Archmage'].loot[6] = {};
  loots['Archmage'].loot[6].objname = 'Audachta1';
  ...
  loots['Reaper Lord'].loot[8].objname = 'LightningWood';
  loots['Reaper Lord'].loot[8].quantity = '1';
  loots['Reaper Lord'].loot[8].chance = 25;
  loots['Reaper Lord'].loot[9] = {};
  loots['Reaper Lord'].loot[9].objname = 'Potions3';
  loots['Reaper Lord'].loot[9].quantity = '1d2';
  loots['Reaper Lord'].loot[9].chance = 35;
  loots['Reaper Lord'].loot[10] = {};
  loots['Reaper Lord'].loot[10].objname = 'BloodMoss';
  ...
  loots['castlechest'].loot[1].objname = 'Scrolls4';
  ...
  loots['castlechest'].loot[5].objname = 'All Weapons';
  loots['castlechest'].loot[5].quantity = '1d3';
  loots['castlechest'].loot[5].chance = 60;
  ...
  loots['castlechest'].loot[9].objname = 'Potions1';
  ...
  loots['Lesser Adventurer'].loot[1].objname = 'Potions1';
  loots['Lesser Adventurer'].loot[1].quantity = '1';
  loots['Lesser Adventurer'].loot[1].chance = 20;
  ...
  loots['Lesser Adventurer'].loot[4].objname = 'Potions2';
  ...
  loots['Level3'].loot[8] = {};
  loots['Level3'].loot[8].objname = 'Potions1';
  loots['Level3'].loot[8].quantity = '1d2';
  loots['Level3'].loot[8].chance = 35;
  loots['Level3'].loot[9] = {};
  ...
  loots['High Adventurer'].loot[0].objname = 'Audachta2';
  ...
  loots['High Adventurer'].loot[2].objname = 'Potions2';
  ...
  loots['High Adventurer'].loot[9].objname = 'Potions1';
  loots['High Adventurer'].loot[9].quantity = '1';
  loots['High Adventurer'].loot[9].chance = 15;
  ...
  loots['High Adventurer'].loot[11].objname = 'Scrolls2';
  loots['High Adventurer'].loot[11].quantity = '1';
  loots['High Adventurer'].loot[11].chance = 20;
  loots['High Adventurer'].loot[12] = {};
  loots['High Adventurer'].loot[12].objname = 'Scrolls3';
  ...
  loots['High Adventurer'].loot[14].objname = 'Medium Weapon';
  ...
  loots['Willowisp'].loot[0].objname = 'Scrolls4';
  ...
  loots['Devourer'].loot[1].objname = 'Potions1';
  loots['Devourer'].loot[1].quantity = '1d2';
  loots['Devourer'].loot[1].chance = 30;
  loots['Devourer'].loot[2] = {};
  loots['Devourer'].loot[2].objname = 'Scrolls3';
  loots['Devourer'].loot[2].quantity = '1d2';
  loots['Devourer'].loot[2].chance = 20;
  loots['Devourer'].loot[3] = {};
  loots['Devourer'].loot[3].objname = 'Scrolls2';
  loots['Devourer'].loot[3].quantity = '1d2';
  loots['Devourer'].loot[3].chance = 25;
  loots['Devourer'].loot[4] = {};
  loots['Devourer'].loot[4].objname = 'Lesser Weapon';
  ...
  loots['Devourer'].loot[6].objname = 'Scrolls4';
  loots['Devourer'].loot[6].quantity = '1';
  loots['Devourer'].loot[6].chance = 15;
  loots['Devourer'].loot[7] = {};
  loots['Devourer'].loot[7].objname = 'Medium Armor';
  loots['Devourer'].loot[7].quantity = '1';
  loots['Devourer'].loot[7].chance = 40;
  loots['Devourer'].loot[8] = {};
  loots['Devourer'].loot[8].objname = 'Potions2';
  loots['Devourer'].loot[8].quantity = '1';
  loots['Devourer'].loot[8].chance = 35;
  ...
  loots['Ettin'].loot[1] = {};
  loots['Ettin'].loot[1].objname = 'Potions1';
  loots['Ettin'].loot[1].quantity = '1';
  loots['Ettin'].loot[1].chance = 50;
  loots['Ettin'].loot[2] = {};
  loots['Ettin'].loot[2].objname = 'Medium Armor';
