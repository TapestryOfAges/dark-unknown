...
function SetLoots() {
  ...
  loots['Adventurer'].loot[2].objname = 'PurplePalmCrystal';
  ...
  loots['Adventurer'].loot[4].objname = 'Medium Armor';
  loots['Adventurer'].loot[4].quantity = '1';
  loots['Adventurer'].loot[4].chance = 30;
  loots['Adventurer'].loot[5] = {};
  loots['Adventurer'].loot[5].objname = 'Mid Ranged';
  loots['Adventurer'].loot[5].quantity = '1';
  loots['Adventurer'].loot[5].chance = 10;
  loots['Adventurer'].loot[6] = {};
  loots['Adventurer'].loot[6].objname = 'Torch';
  loots['Adventurer'].loot[6].quantity = '1d2';
  loots['Adventurer'].loot[6].chance = 50;
  ...
  loots['Level7'].loot[11].chance = 35;
  loots['Level7'].loot[12] = {};
  loots['Level7'].loot[12].objname = 'Scrolls4';
  ...
  loots['Level5'].loot[3] = {};
  loots['Level5'].loot[3].objname = 'Scrolls2';
  ...
  loots['Level5'].loot[6] = {};
  loots['Level5'].loot[6].objname = 'PurplePalmCrystal';
  loots['Level5'].loot[6].quantity = '1';
  loots['Level5'].loot[6].chance = 5;
  loots['Level5'].loot[7] = {};
  ...
  loots['Level5'].loot[12].objname = 'Scrolls4';
  ...
  loots['Level6'].loot[0] = {};
  loots['Level6'].loot[0].objname = 'Heavy Armor';
  ...
  loots['Lesser Adventurer'].loot[0].objname = 'Torch';
  loots['Lesser Adventurer'].loot[0].quantity = '1d2';
  loots['Lesser Adventurer'].loot[0].chance = 50;
  ...
  loots['Lesser Adventurer'].loot[7].objname = 'Medium Armor';
  ...
  loots['Archmage'].loot[6].objname = 'Potions3';
  ...
  loots['Archmage'].loot[8].objname = 'Audachta2';
  ...
  loots['Archmage'].loot[10].objname = 'Scrolls4';
  ...
  loots['Toshin'].loot[3] = {};
  loots['Toshin'].loot[3].objname = 'Scrolls3';
  ...
  loots['castlechest'].loot[4].objname = 'BluePalmCrystal';
  loots['castlechest'].loot[4].quantity = '1';
  loots['castlechest'].loot[4].chance = 10;
  loots['castlechest'].loot[5] = {};
  loots['castlechest'].loot[5].objname = 'PurplePalmCrystal';
  ...
  loots['castlechest'].loot[10].objname = 'Scrolls5';
  ...
  loots['castlechest'].loot[14].objname = 'Scrolls3';
  loots['castlechest'].loot[14].quantity = '1';
  loots['castlechest'].loot[14].chance = 20;
  loots['castlechest'].loot[15] = {};
  loots['castlechest'].loot[15].objname = 'Scrolls1';
  loots['castlechest'].loot[15].quantity = '1';
  loots['castlechest'].loot[15].chance = 25;
  ...
  loots['High Adventurer'].loot[2].objname = 'PurplePalmCrystal';
  ...
  loots['High Adventurer'].loot[9].objname = 'Torch';
  loots['High Adventurer'].loot[9].quantity = '1d2';
  loots['High Adventurer'].loot[9].chance = 50;
  ...
  loots['High Adventurer'].loot[15].objname = 'Mid Weapon';
