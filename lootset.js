...
function SetLoots() {
  ...
  loots['Level7'].loot[1] = {};
  loots['Level7'].loot[1].objname = 'Scrolls7';
  loots['Level7'].loot[1].quantity = '1';
  loots['Level7'].loot[1].chance = 10;
  loots['Level7'].loot[2] = {};
  loots['Level7'].loot[2].objname = 'Scrolls6';
  loots['Level7'].loot[2].quantity = '1';
  loots['Level7'].loot[2].chance = 20;
  loots['Level7'].loot[3] = {};
  ...
  loots['Level7'].loot[5] = {};
  loots['Level7'].loot[5].objname = 'Medium Armor';
  ...
  loots['Specter'].loot[0].objname = 'Scrolls2';
  loots['Specter'].loot[0].quantity = '1';
  loots['Specter'].loot[0].chance = 25;
  ...
  loots['Specter'].loot[7].objname = 'Scrolls3';
  ...
  loots['Toshin'].loot[5] = {};
  loots['Toshin'].loot[5].objname = 'Potions3';
  ...
  loots['archdaemon_ashes'].loot[5].objname = 'Medium Weapon';
  loots['archdaemon_ashes'].loot[5].quantity = '1';
  loots['archdaemon_ashes'].loot[5].chance = 25;
  ...
  loots['archdaemon_ashes'].loot[7].objname = 'Heavy Armor';
  loots['archdaemon_ashes'].loot[7].quantity = '1';
  loots['archdaemon_ashes'].loot[7].chance = 35;
  ...
  loots['archdaemon_ashes'].loot[9].objname = 'Potions3';
  ...
  loots['Level6'].loot[2] = {};
  loots['Level6'].loot[2].objname = 'Potions2';
  ...
  loots['Level6'].loot[7] = {};
  loots['Level6'].loot[7].objname = 'Potions4';
  ...
  loots['Level4'].loot[5] = {};
  loots['Level4'].loot[5].objname = 'Medium Armor';
  loots['Level4'].loot[5].quantity = '1';
  loots['Level4'].loot[5].chance = 40;
  loots['Level4'].loot[6] = {};
  loots['Level4'].loot[6].objname = 'Potions1';
  loots['Level4'].loot[6].quantity = '1d2';
  loots['Level4'].loot[6].chance = 30;
  loots['Level4'].loot[7] = {};
  loots['Level4'].loot[7].objname = 'Scrolls4';
  loots['Level4'].loot[7].quantity = '1';
  loots['Level4'].loot[7].chance = 15;
  loots['Level4'].loot[8] = {};
  loots['Level4'].loot[8].objname = 'PurplePalmCrystal';
  loots['Level4'].loot[8].quantity = '1';
  loots['Level4'].loot[8].chance = 5;
  loots['Level4'].loot[9] = {};
  ...
  loots['Ettin'].loot[0] = {};
  loots['Ettin'].loot[0].objname = 'Potions1';
  ...
  loots['High Adventurer'].loot[3].objname = 'Audachta2';
  ...
  loots['castlechest'].loot[4].objname = 'Scrolls4';
  ...
  loots['castlechest'].loot[6].objname = 'Potions4';
  ...
  loots['castlechest'].loot[8].objname = 'Scrolls8';
  ...
  loots['castlechest'].loot[12].objname = 'Potions3';
  ...
  loots['castlechest'].loot[14].objname = 'All Weapons';
  loots['castlechest'].loot[14].quantity = '1d3';
  loots['castlechest'].loot[14].chance = 60;
  ...
  loots['Archmage'].loot[1].objname = 'Potions2';
  ...
  loots['Archmage'].loot[8].objname = 'Audachta1';
  loots['Archmage'].loot[8].quantity = '1';
  loots['Archmage'].loot[8].chance = 15;
  ...
  loots['Lesser Adventurer'].loot[6].objname = 'Low Ranged';
  ...
  loots['Lesser Adventurer'].loot[8].objname = 'Torch';
  loots['Lesser Adventurer'].loot[8].quantity = '1d2';
  loots['Lesser Adventurer'].loot[8].chance = 50;
  ...
  loots['Level5'].loot[11].objname = 'Potions2';
  loots['Level5'].loot[11].quantity = '1d2';
  ...
  loots['Reaper'].loot[4] = {};
  loots['Reaper'].loot[4].objname = 'Potions3';
  ...
  loots['archdaemon_ice'].loot[4].objname = 'Scrolls3';
  ...
  loots['archdaemon_ice'].loot[13].objname = 'Scrolls7';
  loots['archdaemon_ice'].loot[13].quantity = '1';
  loots['archdaemon_ice'].loot[13].chance = 30;
  ...
  loots['archdaemon_bone'].loot[2].objname = 'Heavy Weapon';
  loots['archdaemon_bone'].loot[2].quantity = '1';
  loots['archdaemon_bone'].loot[2].chance = 35;
  loots['archdaemon_bone'].loot[3] = {};
  loots['archdaemon_bone'].loot[3].objname = 'Potions3';
  ...
  loots['archdaemon_bone'].loot[5].objname = 'Potions4';
  ...
  loots['archdaemon_bone'].loot[7].objname = 'Scrolls5';
  ...
  loots['archdaemon_bone'].loot[10].objname = 'Potions1';
  loots['archdaemon_bone'].loot[10].quantity = '1d2';
  loots['archdaemon_bone'].loot[10].chance = 50;
  loots['archdaemon_bone'].loot[11] = {};
  loots['archdaemon_bone'].loot[11].objname = 'Medium Armor';
  loots['archdaemon_bone'].loot[11].quantity = '1';
  loots['archdaemon_bone'].loot[11].chance = 25;
  ...
  loots['archdaemon_bone'].loot[13].objname = 'Scrolls3';
  ...
  loots['Willowisp'].loot[1].objname = 'Scrolls2';
  loots['Willowisp'].loot[1].quantity = '1';
  loots['Willowisp'].loot[1].chance = 25;
  ...
  loots['archdaemon_dust'].loot[2].objname = 'Scrolls6';
  loots['archdaemon_dust'].loot[2].quantity = '1';
  loots['archdaemon_dust'].loot[2].chance = 40;
  loots['archdaemon_dust'].loot[3] = {};
  loots['archdaemon_dust'].loot[3].objname = 'Scrolls7';
  ...
  loots['archdaemon_dust'].loot[6].objname = 'Scrolls4';
  ...
  loots['archdaemon_dust'].loot[8].objname = 'Potions2';
  ...
  loots['archdaemon_dust'].loot[10].objname = 'Medium Weapon';
  loots['archdaemon_dust'].loot[10].quantity = '1';
  loots['archdaemon_dust'].loot[10].chance = 25;
  ...
  loots['Adventurer'].loot[3].objname = 'Torch';
  loots['Adventurer'].loot[3].quantity = '1d2';
  loots['Adventurer'].loot[3].chance = 50;
  ...
  loots['Level3'].loot[2] = {};
  loots['Level3'].loot[2].objname = 'Potions1';
  loots['Level3'].loot[2].quantity = '1d2';
  ...
  loots['Level3'].loot[7] = {};
  loots['Level3'].loot[7].objname = 'GreenPalmCrystal';
