...
function SetLoots() {
  ...
  loots['castlechest'].loot[9].objname = 'Scrolls3';
  loots['castlechest'].loot[9].quantity = '1';
  loots['castlechest'].loot[9].chance = 20;
  ...
  loots['Toshin'].loot[0] = {};
  loots['Toshin'].loot[0].objname = 'Audachta2';
  ...
  loots['Toshin'].loot[4] = {};
  loots['Toshin'].loot[4].objname = 'Potions3';
  ...
  loots['Toshin'].loot[8] = {};
  loots['Toshin'].loot[8].objname = 'Audachta1';
  ...
  loots['Ettin Sorcerer'].loot[1].objname = 'Medium Weapon';
  loots['Ettin Sorcerer'].loot[1].quantity = '1';
  loots['Ettin Sorcerer'].loot[1].chance = 20;
  loots['Ettin Sorcerer'].loot[2] = {};
  loots['Ettin Sorcerer'].loot[2].objname = 'Scrolls3';
  loots['Ettin Sorcerer'].loot[2].quantity = '1';
  loots['Ettin Sorcerer'].loot[2].chance = 25;
  ...
  loots['Ettin Sorcerer'].loot[4].objname = 'Lesser Weapon';
  loots['Ettin Sorcerer'].loot[4].quantity = '1';
  loots['Ettin Sorcerer'].loot[4].chance = 30;
  loots['Ettin Sorcerer'].loot[5] = {};
  loots['Ettin Sorcerer'].loot[5].objname = 'Potions3';
  ...
  loots['dragon'].loot[9] = {};
  loots['dragon'].loot[9].objname = 'Heavy Weapon';
  loots['dragon'].loot[9].quantity = '1';
  loots['dragon'].loot[9].chance = 35;
  ...
  loots['dragon'].loot[11].objname = 'Scrolls6';
  ...
  loots['Level5'].loot[0] = {};
  loots['Level5'].loot[0].objname = 'Mid Weapon';
  loots['Level5'].loot[0].quantity = '1';
  loots['Level5'].loot[0].chance = 50;
  loots['Level5'].loot[1] = {};
  ...
  loots['Level5'].loot[3] = {};
  loots['Level5'].loot[3].objname = 'Potions1';
  ...
  loots['Level5'].loot[7] = {};
  loots['Level5'].loot[7].objname = 'Scrolls3';
  loots['Level5'].loot[7].quantity = '1d2';
  loots['Level5'].loot[7].chance = 35;
  loots['Level5'].loot[8] = {};
  loots['Level5'].loot[8].objname = 'BluePalmCrystal';
  loots['Level5'].loot[8].quantity = '1';
  loots['Level5'].loot[8].chance = 10;
  loots['Level5'].loot[9] = {};
  ...
  loots['EttinJournalist'].loot[5].objname = 'Lesser Weapon';
  loots['EttinJournalist'].loot[5].quantity = '1';
  loots['EttinJournalist'].loot[5].chance = 30;
  loots['EttinJournalist'].loot[6] = {};
  loots['EttinJournalist'].loot[6].objname = 'Mid Ranged';
  loots['EttinJournalist'].loot[6].quantity = '1';
  loots['EttinJournalist'].loot[6].chance = 15;
  ...
  loots['High Orcs'].loot[1].objname = 'Mid Ranged';
  loots['High Orcs'].loot[1].quantity = '1';
  loots['High Orcs'].loot[1].chance = 15;
  ...
  loots['High Orcs'].loot[3].objname = 'Medium Armor';
  ...
  loots['Mage Town'].loot[1].objname = 'Audachta1';
  loots['Mage Town'].loot[1].quantity = '1';
  loots['Mage Town'].loot[1].chance = 15;
  ...
  loots['paladinchest'].loot[1].objname = 'Heavy Armor';
  ...
  loots['paladinchest'].loot[3].objname = 'Heavy Weapon';
  ...
  loots['Olcrann'].loot[0].objname = 'Scrolls3';
  loots['Olcrann'].loot[0].quantity = '1d2';
  loots['Olcrann'].loot[0].chance = 25;
  loots['Olcrann'].loot[1] = {};
  loots['Olcrann'].loot[1].objname = 'Medium Weapon';
  loots['Olcrann'].loot[1].quantity = '1';
  loots['Olcrann'].loot[1].chance = 20;
  loots['Olcrann'].loot[2] = {};
  loots['Olcrann'].loot[2].objname = 'Heavy Weapon';
  loots['Olcrann'].loot[2].quantity = '1';
  loots['Olcrann'].loot[2].chance = 35;
  loots['Olcrann'].loot[3] = {};
  loots['Olcrann'].loot[3].objname = 'Scrolls4';
  loots['Olcrann'].loot[3].quantity = '1d2';
  loots['Olcrann'].loot[3].chance = 25;
  loots['Olcrann'].loot[4] = {};
  loots['Olcrann'].loot[4].objname = 'Heavy Armor';
  loots['Olcrann'].loot[4].quantity = '1';
  loots['Olcrann'].loot[4].chance = 25;
  loots['Olcrann'].loot[5] = {};
  loots['Olcrann'].loot[5].objname = 'Scrolls6';
  loots['Olcrann'].loot[5].quantity = '1';
  loots['Olcrann'].loot[5].chance = 20;
  ...
  loots['Olcrann'].loot[7].objname = 'Potions1';
  loots['Olcrann'].loot[7].quantity = '1d2';
  loots['Olcrann'].loot[7].chance = 30;
  loots['Olcrann'].loot[8] = {};
  loots['Olcrann'].loot[8].objname = 'Medium Armor';
  ...
  loots['Level4'].loot[1] = {};
  loots['Level4'].loot[1].objname = 'PurplePalmCrystal';
  loots['Level4'].loot[1].quantity = '1';
  loots['Level4'].loot[1].chance = 5;
  loots['Level4'].loot[2] = {};
  loots['Level4'].loot[2].objname = 'Scrolls2';
  loots['Level4'].loot[2].quantity = '1d2';
  loots['Level4'].loot[2].chance = 25;
  loots['Level4'].loot[3] = {};
  ...
  loots['Level4'].loot[8] = {};
  loots['Level4'].loot[8].objname = 'Scrolls3';
  ...
  loots['Level4'].loot[10].objname = 'Medium Armor';
  loots['Level4'].loot[10].quantity = '1';
  loots['Level4'].loot[10].chance = 40;
  ...
  loots['Adventurer'].loot[4].objname = 'Potions2';
  ...
  loots['archdaemon_bone'].loot[8].objname = 'KeyOfBone';
  loots['archdaemon_bone'].loot[8].quantity = '1';
  loots['archdaemon_bone'].loot[8].chance = 100;
  loots['archdaemon_bone'].loot[9] = {};
  loots['archdaemon_bone'].loot[9].objname = 'Potions2';
  ...
  loots['Lord Olcrann'].loot[1].objname = 'Scrolls6';
  ...
  loots['Lord Olcrann'].loot[3].objname = 'Scrolls4';
  ...
  loots['Lord Olcrann'].loot[10].objname = 'Scrolls5';
  loots['Lord Olcrann'].loot[10].quantity = '1';
  ...
  loots['Level7'].loot[0] = {};
  loots['Level7'].loot[0].objname = 'Scrolls3';
  loots['Level7'].loot[0].quantity = '1d2';
  loots['Level7'].loot[0].chance = 30;
  loots['Level7'].loot[1] = {};
  loots['Level7'].loot[1].objname = 'Medium Weapon';
  loots['Level7'].loot[1].quantity = '1';
  loots['Level7'].loot[1].chance = 25;
  loots['Level7'].loot[2] = {};
  ...
  loots['Level3'].loot[7] = {};
  loots['Level3'].loot[7].objname = 'Scrolls3';
  ...
  loots['archdaemon_ashes'].loot[0].objname = 'Potions1';
  ...
  loots['archdaemon_ashes'].loot[6].objname = 'Scrolls3';
  ...
  loots['Giant'].loot[2] = {};
  loots['Giant'].loot[2].objname = 'Heavy Weapon';
  loots['Giant'].loot[2].quantity = '1';
  loots['Giant'].loot[2].chance = 20;
  ...
  loots['Archmage'].loot[4].objname = 'Potions2';
  ...
  loots['Archmage'].loot[6].objname = 'Audachta2';
  loots['Archmage'].loot[6].quantity = '1';
  loots['Archmage'].loot[6].chance = 15;
  loots['Archmage'].loot[7] = {};
  loots['Archmage'].loot[7].objname = 'Audachta1';
  ...
  loots['Archmage'].loot[12].objname = 'Audachta3';
  ...
  loots['Trolls'].loot[2] = {};
  loots['Trolls'].loot[2].objname = 'Medium Weapon';
  loots['Trolls'].loot[2].quantity = '1';
  loots['Trolls'].loot[2].chance = 20;
  loots['Trolls'].loot[3] = {};
  ...
  loots['Lesser Adventurer'].loot[3].objname = 'Scrolls1';
  ...
  loots['Lesser Adventurer'].loot[8].objname = 'Low Ranged';
  ...
  loots['archdaemon_ice'].loot[9].objname = 'Scrolls3';
  ...
  loots['yggdras_secret'].loot[1].objname = 'Lesser Armor';
  loots['yggdras_secret'].loot[1].quantity = '1';
  loots['yggdras_secret'].loot[1].chance = 33;
  loots['yggdras_secret'].loot[2] = {};
  loots['yggdras_secret'].loot[2].objname = 'Scrolls1';
  loots['yggdras_secret'].loot[2].quantity = '1d2';
  loots['yggdras_secret'].loot[2].chance = 25;
  ...
  loots['Specter'].loot[1].objname = 'Scrolls4';
  ...
  loots['Specter'].loot[3].objname = 'GreenPalmCrystal';
  ...
  loots['Level6'].loot[3] = {};
  loots['Level6'].loot[3].objname = 'Heavy Weapon';
  ...
  loots['Level6'].loot[5] = {};
  loots['Level6'].loot[5].objname = 'Scrolls3';
  ...
  loots['Level6'].loot[9] = {};
  loots['Level6'].loot[9].objname = 'Medium Armor';
  ...
  loots['High Adventurer'].loot[8].objname = 'Potions2';
  loots['High Adventurer'].loot[8].quantity = '1';
  loots['High Adventurer'].loot[8].chance = 20;
  ...
  loots['High Adventurer'].loot[14].objname = 'Potions1';
  loots['High Adventurer'].loot[14].quantity = '1';
  loots['High Adventurer'].loot[14].chance = 15;
  ...
  loots['Devourer'].loot[0].objname = 'Potions2';
  loots['Devourer'].loot[0].quantity = '1';
  loots['Devourer'].loot[0].chance = 35;
  loots['Devourer'].loot[1] = {};
  loots['Devourer'].loot[1].objname = 'Scrolls2';
  loots['Devourer'].loot[1].quantity = '1d2';
  loots['Devourer'].loot[1].chance = 25;
  ...
  loots['Devourer'].loot[3].objname = 'Scrolls4';
  loots['Devourer'].loot[3].quantity = '1';
  loots['Devourer'].loot[3].chance = 15;
  loots['Devourer'].loot[4] = {};
  loots['Devourer'].loot[4].objname = 'Scrolls1';
