...
function SetLoots() {
  ...
  loots['Level7'].loot[3] = {};
  loots['Level7'].loot[3].objname = 'Heavy Weapon';
  loots['Level7'].loot[3].quantity = '1';
  loots['Level7'].loot[3].chance = 35;
  loots['Level7'].loot[4] = {};
  loots['Level7'].loot[4].objname = 'Potions3';
  ...
  loots['Level5'].loot[1] = {};
  loots['Level5'].loot[1].objname = 'Scrolls3';
  ...
  loots['Lesser Adventurer'].loot[1].objname = 'Scrolls1';
  ...
  loots['Level6'].loot[11].objname = 'Heavy Weapon';
  ...
  loots['castlechest'].loot[0].objname = 'Potions1';
  ...
  loots['Archmage'].loot[0].objname = 'Potions1';
  ...
  loots['Archmage'].loot[7].objname = 'Potions4';
