...
function SetLoots() {
  ...
  loots['Toshin'].loot[0] = {};
  loots['Toshin'].loot[0].objname = 'Scrolls5';
  loots['Toshin'].loot[0].quantity = '1';
  loots['Toshin'].loot[0].chance = 25;
  loots['Toshin'].loot[1] = {};
  ...
  loots['swainhilcave'].loot[2].objname = 'GoldLocket';
  ...
  loots['Level7'].loot[0] = {};
  loots['Level7'].loot[0].objname = 'Scrolls6';
  loots['Level7'].loot[0].quantity = '1';
  loots['Level7'].loot[0].chance = 20;
  loots['Level7'].loot[1] = {};
  ...
  loots['Level7'].loot[7].chance = 45;
  loots['Level7'].loot[8] = {};
  loots['Level7'].loot[8].objname = 'Scrolls4';
  ...
  loots['Adventurer'].loot[8].objname = 'Scrolls3';
  loots['Adventurer'].loot[8].quantity = '1';
  loots['Adventurer'].loot[8].chance = 15;
  ...
  loots['High Adventurer'].loot[4].objname = 'Mid Weapon';
  loots['High Adventurer'].loot[4].quantity = '1';
  loots['High Adventurer'].loot[4].chance = 30;
  ...
  loots['High Adventurer'].loot[6].objname = 'Potions3';
  loots['High Adventurer'].loot[6].quantity = '1';
  loots['High Adventurer'].loot[6].chance = 30;
  ...
  loots['High Adventurer'].loot[11].objname = 'Torch';
  loots['High Adventurer'].loot[11].quantity = '1d2';
  loots['High Adventurer'].loot[11].chance = 50;
  loots['High Adventurer'].loot[12] = {};
  loots['High Adventurer'].loot[12].objname = 'Medium Armor';
  ...
  loots['High Adventurer'].loot[15].objname = 'Audachta2';
  ...
  loots['Specter'].loot[4].objname = 'Audachta2';
  ...
  loots['Shadow2'].loot[4].objname = 'Medium Armor';
  loots['Shadow2'].loot[4].quantity = '1';
  loots['Shadow2'].loot[4].chance = 35;
  ...
  loots['archdaemon_ice'].loot[0].objname = 'Medium Weapon';
  loots['archdaemon_ice'].loot[0].quantity = '1';
  loots['archdaemon_ice'].loot[0].chance = 25;
  ...
  loots['archdaemon_ice'].loot[2].objname = 'Heavy Armor';
  loots['archdaemon_ice'].loot[2].quantity = '1';
  loots['archdaemon_ice'].loot[2].chance = 35;
  ...
  loots['archdaemon_ice'].loot[9].objname = 'KeyOfIce';
  loots['archdaemon_ice'].loot[9].quantity = '1';
  loots['archdaemon_ice'].loot[9].chance = 100;
  loots['archdaemon_ice'].loot[10] = {};
  loots['archdaemon_ice'].loot[10].objname = 'Potions1';
  loots['archdaemon_ice'].loot[10].quantity = '1d2';
  loots['archdaemon_ice'].loot[10].chance = 50;
  loots['archdaemon_ice'].loot[11] = {};
  loots['archdaemon_ice'].loot[11].objname = 'Scrolls7';
  loots['archdaemon_ice'].loot[11].quantity = '1';
  loots['archdaemon_ice'].loot[11].chance = 30;
  loots['archdaemon_ice'].loot[12] = {};
  loots['archdaemon_ice'].loot[12].objname = 'Medium Armor';
  ...
  loots['Level4'].loot[3] = {};
  loots['Level4'].loot[3].objname = 'Scrolls3';
  ...
  loots['archdaemon_ashes'].loot[1].objname = 'Medium Weapon';
  ...
  loots['Level5'].loot[2] = {};
  loots['Level5'].loot[2].objname = 'Scrolls5';
  loots['Level5'].loot[2].quantity = '1';
  loots['Level5'].loot[2].chance = 25;
  loots['Level5'].loot[3] = {};
  ...
  loots['Level5'].loot[5] = {};
  loots['Level5'].loot[5].objname = 'BluePalmCrystal';
  loots['Level5'].loot[5].quantity = '1';
  loots['Level5'].loot[5].chance = 10;
  loots['Level5'].loot[6] = {};
  ...
  loots['Level5'].loot[9] = {};
  loots['Level5'].loot[9].objname = 'Potions2';
  ...
  loots['Level5'].loot[11].objname = 'Potions1';
  loots['Level5'].loot[11].quantity = '1';
  loots['Level5'].loot[11].chance = 35;
  ...
  loots['Archmage'].loot[3].objname = 'Scrolls6';
  loots['Archmage'].loot[3].quantity = '1';
  loots['Archmage'].loot[3].chance = 20;
  loots['Archmage'].loot[4] = {};
  loots['Archmage'].loot[4].objname = 'Audachta3';
  loots['Archmage'].loot[4].quantity = '1';
  loots['Archmage'].loot[4].chance = 10;
  loots['Archmage'].loot[5] = {};
  loots['Archmage'].loot[5].objname = 'Audachta1';
  ...
  loots['Archmage'].loot[7].objname = 'Scrolls4';
  ...
  loots['Archmage'].loot[10].objname = 'Scrolls3';
  ...
  loots['archdaemon_bone'].loot[0].objname = 'Medium Armor';
  loots['archdaemon_bone'].loot[0].quantity = '1';
  loots['archdaemon_bone'].loot[0].chance = 25;
  loots['archdaemon_bone'].loot[1] = {};
  loots['archdaemon_bone'].loot[1].objname = 'Heavy Weapon';
  ...
  loots['Level6'].loot[2] = {};
  loots['Level6'].loot[2].objname = 'Potions1';
  ...
  loots['Level6'].loot[5] = {};
  loots['Level6'].loot[5].objname = 'Potions3';
  ...
  loots['archdaemon_dust'].loot[11].objname = 'Potions2';
  loots['archdaemon_dust'].loot[11].quantity = '1d2';
  loots['archdaemon_dust'].loot[11].chance = 50;
  loots['archdaemon_dust'].loot[12] = {};
  loots['archdaemon_dust'].loot[12].objname = 'Scrolls3';
  loots['archdaemon_dust'].loot[12].quantity = '1d2';
  loots['archdaemon_dust'].loot[12].chance = 50;
  loots['archdaemon_dust'].loot[13] = {};
  loots['archdaemon_dust'].loot[13].objname = 'Potions3';
  loots['archdaemon_dust'].loot[13].quantity = '1';
  loots['archdaemon_dust'].loot[13].chance = 30;
  ...
  loots['High Orcs'].loot[3].objname = 'Mid Weapon';
  loots['High Orcs'].loot[3].quantity = '1';
  loots['High Orcs'].loot[3].chance = 60;
  ...
  loots['castlechest'].loot[0].objname = 'All Armor';
  loots['castlechest'].loot[0].quantity = '1d2';
  loots['castlechest'].loot[0].chance = 50;
  ...
  loots['castlechest'].loot[7].objname = 'BluePalmCrystal';
  ...
  loots['castlechest'].loot[13].objname = 'Scrolls4';
  ...
  loots['castlechest'].loot[15].objname = 'Scrolls5';
  ...
  loots['Reaper'].loot[5] = {};
  loots['Reaper'].loot[5].objname = 'Scrolls4';
  ...
  loots['Reaper'].loot[7] = {};
  loots['Reaper'].loot[7].objname = 'Potions2';
  loots['Reaper'].loot[7].quantity = '1d2';
  loots['Reaper'].loot[7].chance = 30;
  loots['Reaper'].loot[8] = {};
  ...
  loots['Reaper'].loot[13].objname = 'Heavy Weapon';
  loots['Reaper'].loot[13].quantity = '1';
  loots['Reaper'].loot[13].chance = 35;
  ...
  loots['dragon'].loot[10].objname = 'Medium Armor';
  ...
  loots['Level3'].loot[5] = {};
  loots['Level3'].loot[5].objname = 'BluePalmCrystal';
  loots['Level3'].loot[5].quantity = '1';
  loots['Level3'].loot[5].chance = 5;
  loots['Level3'].loot[6] = {};
  loots['Level3'].loot[6].objname = 'GreenPalmCrystal';
  ...
  loots['Willowisp'].loot[3].objname = 'Audachta3';
  loots['Willowisp'].loot[3].quantity = '1';
  loots['Willowisp'].loot[3].chance = 10;
