...
function SetLoots() {
  ...
  loots['Ettin'].loot[1] = {};
  loots['Ettin'].loot[1].objname = 'Lesser Weapon';
  loots['Ettin'].loot[1].quantity = '1';
  loots['Ettin'].loot[1].chance = 30;
  loots['Ettin'].loot[2] = {};
  ...
  loots['Adventurer'].loot[1].objname = 'Medium Armor';
  ...
  loots['High Adventurer'].loot[0].objname = 'Potions1';
  ...
  loots['High Adventurer'].loot[4].objname = 'Torch';
  loots['High Adventurer'].loot[4].quantity = '1d2';
  loots['High Adventurer'].loot[4].chance = 50;
  ...
  loots['High Adventurer'].loot[11].objname = 'Heavy Weapon';
  ...
  loots['Specter'].loot[5].objname = 'Audachta2';
  ...
  loots['High Orcs'].loot[1].objname = 'Medium Weapon';
  loots['High Orcs'].loot[1].quantity = '1';
  loots['High Orcs'].loot[1].chance = 20;
  ...
  loots['archdaemon_dust'].loot[1].objname = 'Medium Weapon';
  loots['archdaemon_dust'].loot[1].quantity = '1';
  loots['archdaemon_dust'].loot[1].chance = 25;
  ...
  loots['archdaemon_dust'].loot[3].objname = 'Heavy Weapon';
  loots['archdaemon_dust'].loot[3].quantity = '1';
  loots['archdaemon_dust'].loot[3].chance = 35;
  loots['archdaemon_dust'].loot[4] = {};
  loots['archdaemon_dust'].loot[4].objname = 'Heavy Armor';
  loots['archdaemon_dust'].loot[4].quantity = '1';
  loots['archdaemon_dust'].loot[4].chance = 35;
  loots['archdaemon_dust'].loot[5] = {};
  loots['archdaemon_dust'].loot[5].objname = 'Potions3';
  ...
  loots['archdaemon_dust'].loot[10].objname = 'Scrolls5';
  loots['archdaemon_dust'].loot[10].quantity = '1';
  loots['archdaemon_dust'].loot[10].chance = 50;
  loots['archdaemon_dust'].loot[11] = {};
  loots['archdaemon_dust'].loot[11].objname = 'Potions4';
  loots['archdaemon_dust'].loot[11].quantity = '1';
  loots['archdaemon_dust'].loot[11].chance = 30;
  loots['archdaemon_dust'].loot[12] = {};
  loots['archdaemon_dust'].loot[12].objname = 'Potions2';
  ...
  loots['Reaper'].loot[1] = {};
  loots['Reaper'].loot[1].objname = 'Potions3';
  ...
  loots['Reaper'].loot[3] = {};
  loots['Reaper'].loot[3].objname = 'Heavy Weapon';
  ...
  loots['Reaper'].loot[12].objname = 'Potions2';
  ...
  loots['Lesser Adventurer'].loot[3].quantity = '1d2';
  loots['Lesser Adventurer'].loot[3].chance = 50;
  ...
  loots['Level4'].loot[8] = {};
  loots['Level4'].loot[8].objname = 'BluePalmCrystal';
  ...
  loots['Level7'].loot[3] = {};
  loots['Level7'].loot[3].objname = 'Scrolls7';
  ...
  loots['Level7'].loot[6] = {};
  loots['Level7'].loot[6].objname = 'Scrolls5';
  ...
  loots['archdaemon_ice'].loot[5].objname = 'Scrolls3';
  ...
  loots['Level3'].loot[8] = {};
  loots['Level3'].loot[8].objname = 'GreenPalmCrystal';
  ...
  loots['Toshin'].loot[6] = {};
  loots['Toshin'].loot[6].objname = 'Potions1';
  ...
  loots['Archmage'].loot[3].objname = 'Audachta3';
  loots['Archmage'].loot[3].quantity = '1';
  loots['Archmage'].loot[3].chance = 10;
  loots['Archmage'].loot[4] = {};
  loots['Archmage'].loot[4].objname = 'Audachta4';
  ...
  loots['Archmage'].loot[11].objname = 'Potions3';
  ...
  loots['Level2'].loot[1] = {};
  loots['Level2'].loot[1].objname = 'GreenPalmCrystal';
  loots['Level2'].loot[1].quantity = '1';
  loots['Level2'].loot[1].chance = 10;
  loots['Level2'].loot[2] = {};
  ...
  loots['castlechest'].loot[8].objname = 'Scrolls3';
  loots['castlechest'].loot[8].quantity = '1';
  loots['castlechest'].loot[8].chance = 20;
  ...
  loots['archdaemon_bone'].loot[1].objname = 'Potions2';
  ...
  loots['archdaemon_bone'].loot[3].objname = 'Heavy Armor';
  loots['archdaemon_bone'].loot[3].quantity = '1';
  loots['archdaemon_bone'].loot[3].chance = 35;
  ...
  loots['archdaemon_bone'].loot[5].objname = 'Scrolls3';
  ...
  loots['archdaemon_bone'].loot[7].objname = 'Medium Weapon';
  loots['archdaemon_bone'].loot[7].quantity = '1';
  loots['archdaemon_bone'].loot[7].chance = 25;
  loots['archdaemon_bone'].loot[8] = {};
  loots['archdaemon_bone'].loot[8].objname = 'Heavy Weapon';
  loots['archdaemon_bone'].loot[8].quantity = '1';
  loots['archdaemon_bone'].loot[8].chance = 35;
  ...
  loots['archdaemon_bone'].loot[11].objname = 'Scrolls4';
  ...
  loots['Level5'].loot[4] = {};
  loots['Level5'].loot[4].objname = 'Potions2';
  ...
  loots['Level5'].loot[10].objname = 'Medium Weapon';
  loots['Level5'].loot[10].quantity = '1';
  loots['Level5'].loot[10].chance = 50;
  ...
  loots['Level5'].loot[12].objname = 'Scrolls3';
  loots['Level5'].loot[12].quantity = '1d2';
  ...
  loots['archdaemon_ashes'].loot[2].objname = 'Potions3';
  ...
  loots['archdaemon_ashes'].loot[5].objname = 'Heavy Weapon';
  loots['archdaemon_ashes'].loot[5].quantity = '1';
  loots['archdaemon_ashes'].loot[5].chance = 35;
  loots['archdaemon_ashes'].loot[6] = {};
  loots['archdaemon_ashes'].loot[6].objname = 'Medium Armor';
  loots['archdaemon_ashes'].loot[6].quantity = '1';
  loots['archdaemon_ashes'].loot[6].chance = 25;
  ...
  loots['archdaemon_ashes'].loot[12].objname = 'Scrolls6';
  loots['archdaemon_ashes'].loot[12].quantity = '1';
  loots['archdaemon_ashes'].loot[12].chance = 40;
  loots['archdaemon_ashes'].loot[13] = {};
  loots['archdaemon_ashes'].loot[13].objname = 'Scrolls4';
