...
function SetLoots() {
  ...
  loots['Level7'].loot[3] = {};
  loots['Level7'].loot[3].objname = 'Heavy Armor';
  ...
  loots['Level7'].loot[6] = {};
  loots['Level7'].loot[6].objname = 'Scrolls3';
  ...
  loots['castlechest'].loot[2].objname = 'Scrolls6';
  ...
  loots['Level2'].loot[1] = {};
  loots['Level2'].loot[1].objname = 'Lesser Weapon';
  loots['Level2'].loot[1].quantity = '1';
  loots['Level2'].loot[1].chance = 40;
  loots['Level2'].loot[2] = {};
  ...
  loots['Level5'].loot[6] = {};
  loots['Level5'].loot[6].objname = 'Scrolls2';
