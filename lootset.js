...
function SetLoots() {
  ...
  loots['archdaemon_ice'].loot[6].objname = 'Potions3';
  loots['archdaemon_ice'].loot[6].quantity = '1';
  loots['archdaemon_ice'].loot[6].chance = 30;
  loots['archdaemon_ice'].loot[7] = {};
  loots['archdaemon_ice'].loot[7].objname = 'Medium Armor';
  loots['archdaemon_ice'].loot[7].quantity = '1';
  loots['archdaemon_ice'].loot[7].chance = 25;
  loots['archdaemon_ice'].loot[8] = {};
  loots['archdaemon_ice'].loot[8].objname = 'Potions2';
  ...
  loots['archdaemon_ice'].loot[10].objname = 'Scrolls7';
  loots['archdaemon_ice'].loot[10].quantity = '1';
  loots['archdaemon_ice'].loot[10].chance = 30;
  loots['archdaemon_ice'].loot[11] = {};
  loots['archdaemon_ice'].loot[11].objname = 'Potions1';
  loots['archdaemon_ice'].loot[11].quantity = '1d2';
  loots['archdaemon_ice'].loot[11].chance = 50;
  loots['archdaemon_ice'].loot[12] = {};
  loots['archdaemon_ice'].loot[12].objname = 'Heavy Weapon';
  loots['archdaemon_ice'].loot[12].quantity = '1';
  loots['archdaemon_ice'].loot[12].chance = 35;
  loots['archdaemon_ice'].loot[13] = {};
  loots['archdaemon_ice'].loot[13].objname = 'Scrolls3';
  loots['archdaemon_ice'].loot[13].quantity = '1d2';
  loots['archdaemon_ice'].loot[13].chance = 50;
  ...
  loots['Level3'].loot[5] = {};
  loots['Level3'].loot[5].objname = 'GreenPalmCrystal';
  loots['Level3'].loot[5].quantity = '1';
  loots['Level3'].loot[5].chance = 5;
  loots['Level3'].loot[6] = {};
  loots['Level3'].loot[6].objname = 'Scrolls3';
  ...
  loots['Level3'].loot[9] = {};
  loots['Level3'].loot[9].objname = 'Lesser Weapon';
  ...
  loots['Lesser Adventurer'].loot[2].objname = 'Potions2';
  ...
  loots['Lesser Adventurer'].loot[6].objname = 'Torch';
  loots['Lesser Adventurer'].loot[6].quantity = '1d2';
  loots['Lesser Adventurer'].loot[6].chance = 50;
  ...
  loots['Level5'].loot[1] = {};
  loots['Level5'].loot[1].objname = 'Mid Weapon';
  ...
  loots['Level5'].loot[4] = {};
  loots['Level5'].loot[4].objname = 'BluePalmCrystal';
  loots['Level5'].loot[4].quantity = '1';
  loots['Level5'].loot[4].chance = 10;
  loots['Level5'].loot[5] = {};
  loots['Level5'].loot[5].objname = 'Potions2';
  loots['Level5'].loot[5].quantity = '1d2';
  loots['Level5'].loot[5].chance = 35;
  loots['Level5'].loot[6] = {};
  loots['Level5'].loot[6].objname = 'Medium Weapon';
  loots['Level5'].loot[6].quantity = '1';
  loots['Level5'].loot[6].chance = 50;
  loots['Level5'].loot[7] = {};
  loots['Level5'].loot[7].objname = 'Scrolls4';
  loots['Level5'].loot[7].quantity = '1';
  loots['Level5'].loot[7].chance = 30;
  loots['Level5'].loot[8] = {};
  loots['Level5'].loot[8].objname = 'Potions3';
  loots['Level5'].loot[8].quantity = '1';
  loots['Level5'].loot[8].chance = 30;
  loots['Level5'].loot[9] = {};
  loots['Level5'].loot[9].objname = 'PurplePalmCrystal';
  loots['Level5'].loot[9].quantity = '1';
  loots['Level5'].loot[9].chance = 5;
  ...
  loots['Level5'].loot[11].objname = 'Heavy Armor';
  loots['Level5'].loot[11].quantity = '1';
  loots['Level5'].loot[11].chance = 20;
  loots['Level5'].loot[12] = {};
  loots['Level5'].loot[12].objname = 'Scrolls2';
  ...
  loots['Toshin'].loot[1] = {};
  loots['Toshin'].loot[1].objname = 'Audachta2';
  loots['Toshin'].loot[1].quantity = '1';
  loots['Toshin'].loot[1].chance = 10;
  loots['Toshin'].loot[2] = {};
  loots['Toshin'].loot[2].objname = 'Scrolls5';
  loots['Toshin'].loot[2].quantity = '1';
  loots['Toshin'].loot[2].chance = 25;
  loots['Toshin'].loot[3] = {};
  loots['Toshin'].loot[3].objname = 'Scrolls2';
  loots['Toshin'].loot[3].quantity = '1';
  loots['Toshin'].loot[3].chance = 30;
  loots['Toshin'].loot[4] = {};
  loots['Toshin'].loot[4].objname = 'Scrolls4';
  loots['Toshin'].loot[4].quantity = '1';
  loots['Toshin'].loot[4].chance = 30;
  loots['Toshin'].loot[5] = {};
  loots['Toshin'].loot[5].objname = 'Potions1';
  ...
  loots['Toshin'].loot[7] = {};
  loots['Toshin'].loot[7].objname = 'Audachta1';
  ...
  loots['Level2'].loot[0] = {};
  loots['Level2'].loot[0].objname = 'Potions1';
  loots['Level2'].loot[0].quantity = '1';
  loots['Level2'].loot[0].chance = 45;
  loots['Level2'].loot[1] = {};
  ...
  loots['Level2'].loot[4] = {};
  loots['Level2'].loot[4].objname = 'GreenPalmCrystal';
  loots['Level2'].loot[4].quantity = '1';
  loots['Level2'].loot[4].chance = 10;
  loots['Level2'].loot[5] = {};
  ...
  loots['Spellblade'].loot[1].objname = 'Heavy Weapon';
  ...
  loots['Level6'].loot[1] = {};
  loots['Level6'].loot[1].objname = 'Scrolls6';
  ...
  loots['Level6'].loot[4] = {};
  loots['Level6'].loot[4].objname = 'Scrolls5';
  ...
  loots['Level6'].loot[8] = {};
  loots['Level6'].loot[8].objname = 'Potions1';
  loots['Level6'].loot[8].quantity = '1d2';
  ...
  loots['Level6'].loot[10].objname = 'Potions2';
  ...
  loots['Adventurer'].loot[0].objname = 'Torch';
  loots['Adventurer'].loot[0].quantity = '1d2';
  loots['Adventurer'].loot[0].chance = 50;
  ...
  loots['archdaemon_dust'].loot[0].objname = 'Medium Armor';
  loots['archdaemon_dust'].loot[0].quantity = '1';
  loots['archdaemon_dust'].loot[0].chance = 25;
  loots['archdaemon_dust'].loot[1] = {};
  loots['archdaemon_dust'].loot[1].objname = 'Potions2';
  loots['archdaemon_dust'].loot[1].quantity = '1d2';
  loots['archdaemon_dust'].loot[1].chance = 50;
  loots['archdaemon_dust'].loot[2] = {};
  loots['archdaemon_dust'].loot[2].objname = 'Scrolls7';
  ...
  loots['archdaemon_dust'].loot[4].objname = 'Potions4';
  loots['archdaemon_dust'].loot[4].quantity = '1';
  loots['archdaemon_dust'].loot[4].chance = 30;
  loots['archdaemon_dust'].loot[5] = {};
  loots['archdaemon_dust'].loot[5].objname = 'KeyOfDust';
  loots['archdaemon_dust'].loot[5].quantity = '1';
  loots['archdaemon_dust'].loot[5].chance = 100;
  loots['archdaemon_dust'].loot[6] = {};
  loots['archdaemon_dust'].loot[6].objname = 'Heavy Weapon';
  loots['archdaemon_dust'].loot[6].quantity = '1';
  loots['archdaemon_dust'].loot[6].chance = 35;
  loots['archdaemon_dust'].loot[7] = {};
  loots['archdaemon_dust'].loot[7].objname = 'Scrolls3';
  loots['archdaemon_dust'].loot[7].quantity = '1d2';
  loots['archdaemon_dust'].loot[7].chance = 50;
  loots['archdaemon_dust'].loot[8] = {};
  loots['archdaemon_dust'].loot[8].objname = 'Scrolls5';
  loots['archdaemon_dust'].loot[8].quantity = '1';
  loots['archdaemon_dust'].loot[8].chance = 50;
  loots['archdaemon_dust'].loot[9] = {};
  loots['archdaemon_dust'].loot[9].objname = 'Heavy Armor';
  loots['archdaemon_dust'].loot[9].quantity = '1';
  loots['archdaemon_dust'].loot[9].chance = 35;
  loots['archdaemon_dust'].loot[10] = {};
  loots['archdaemon_dust'].loot[10].objname = 'Scrolls4';
  loots['archdaemon_dust'].loot[10].quantity = '1d2';
  loots['archdaemon_dust'].loot[10].chance = 50;
  loots['archdaemon_dust'].loot[11] = {};
  loots['archdaemon_dust'].loot[11].objname = 'Medium Weapon';
  loots['archdaemon_dust'].loot[11].quantity = '1';
  loots['archdaemon_dust'].loot[11].chance = 25;
  loots['archdaemon_dust'].loot[12] = {};
  loots['archdaemon_dust'].loot[12].objname = 'Potions3';
  loots['archdaemon_dust'].loot[12].quantity = '1';
  loots['archdaemon_dust'].loot[12].chance = 30;
  loots['archdaemon_dust'].loot[13] = {};
  loots['archdaemon_dust'].loot[13].objname = 'Scrolls6';
  loots['archdaemon_dust'].loot[13].quantity = '1';
  loots['archdaemon_dust'].loot[13].chance = 40;
  ...
  loots['Giant'].loot[0].chance = 20.00;
  loots['Giant'].loot[1] = {};
  ...
  loots['paladinchest'].loot[3].objname = 'HeavyArmor';
  ...
  loots['Specter'].loot[0].objname = 'BluePalmCrystal';
  ...
  loots['Specter'].loot[2].objname = 'Scrolls2';
  loots['Specter'].loot[2].quantity = '1';
  loots['Specter'].loot[2].chance = 25;
  ...
  loots['Specter'].loot[4].objname = 'PurplePalmCrystal';
  loots['Specter'].loot[4].quantity = '1';
  loots['Specter'].loot[4].chance = 15;
  loots['Specter'].loot[5] = {};
  loots['Specter'].loot[5].objname = 'GreenPalmCrystal';
  loots['Specter'].loot[5].quantity = '1';
  loots['Specter'].loot[5].chance = 10;
  ...
  loots['Specter'].loot[8].objname = 'Scrolls4';
  ...
  loots['spireloot'].loot[0].objname = 'Scrolls1';
  loots['spireloot'].loot[0].quantity = '1';
  loots['spireloot'].loot[0].chance = 50;
  loots['spireloot'].loot[1] = {};
  loots['spireloot'].loot[1].objname = 'Potions2';
  loots['spireloot'].loot[1].quantity = '1';
  loots['spireloot'].loot[1].chance = 40;
  loots['spireloot'].loot[2] = {};
  loots['spireloot'].loot[2].objname = 'Scrolls3';
  loots['spireloot'].loot[2].quantity = '1';
  loots['spireloot'].loot[2].chance = 30;
  ...
  loots['High Adventurer'].loot[6].quantity = '1d2';
  loots['High Adventurer'].loot[6].chance = 50;
  ...
  loots['High Adventurer'].loot[8].objname = 'Audachta2';
  ...
  loots['High Adventurer'].loot[10].objname = 'Scrolls3';
  loots['High Adventurer'].loot[10].quantity = '1';
  loots['High Adventurer'].loot[10].chance = 15;
  ...
  loots['High Adventurer'].loot[13].objname = 'Potions2';
  loots['High Adventurer'].loot[13].quantity = '1';
  loots['High Adventurer'].loot[13].chance = 20;
  loots['High Adventurer'].loot[14] = {};
  loots['High Adventurer'].loot[14].objname = 'BluePalmCrystal';
  loots['High Adventurer'].loot[14].quantity = '1';
  loots['High Adventurer'].loot[14].chance = 10;
  loots['High Adventurer'].loot[15] = {};
  loots['High Adventurer'].loot[15].objname = 'Medium Armor';
  loots['High Adventurer'].loot[15].quantity = '1';
  loots['High Adventurer'].loot[15].chance = 30;
  ...
  loots['Archmage'].loot[0].objname = 'Potions2';
  loots['Archmage'].loot[0].quantity = '1d2';
  loots['Archmage'].loot[0].chance = 25;
  loots['Archmage'].loot[1] = {};
  loots['Archmage'].loot[1].objname = 'Potions1';
  ...
  loots['Archmage'].loot[3].objname = 'Scrolls3';
  loots['Archmage'].loot[3].quantity = '1d2';
  loots['Archmage'].loot[3].chance = 30;
  loots['Archmage'].loot[4] = {};
  loots['Archmage'].loot[4].objname = 'MandrakeRoot';
  loots['Archmage'].loot[4].quantity = '1';
  loots['Archmage'].loot[4].chance = 50;
  ...
  loots['Archmage'].loot[7].objname = 'Audachta2';
  loots['Archmage'].loot[7].quantity = '1';
  loots['Archmage'].loot[7].chance = 15;
  loots['Archmage'].loot[8] = {};
  loots['Archmage'].loot[8].objname = 'Scrolls5';
  ...
  loots['Archmage'].loot[11].objname = 'Audachta1';
  loots['Archmage'].loot[11].quantity = '1';
  loots['Archmage'].loot[11].chance = 15;
  loots['Archmage'].loot[12] = {};
  loots['Archmage'].loot[12].objname = 'Scrolls6';
  loots['Archmage'].loot[12].quantity = '1';
  loots['Archmage'].loot[12].chance = 20;
  ...
  loots['EttinJournalist'].loot[1].objname = 'Lesser Weapon';
  loots['EttinJournalist'].loot[1].quantity = '1';
  loots['EttinJournalist'].loot[1].chance = 30;
  loots['EttinJournalist'].loot[2] = {};
  loots['EttinJournalist'].loot[2].objname = 'Mid Ranged';
  loots['EttinJournalist'].loot[2].quantity = '1';
  loots['EttinJournalist'].loot[2].chance = 15;
  loots['EttinJournalist'].loot[3] = {};
  loots['EttinJournalist'].loot[3].objname = 'Mid Weapon';
  loots['EttinJournalist'].loot[3].quantity = '1';
  loots['EttinJournalist'].loot[3].chance = 60;
  ...
  loots['Eyes'].loot[2] = {};
  loots['Eyes'].loot[2].objname = 'Nightshade';
  loots['Eyes'].loot[2].quantity = '1';
  loots['Eyes'].loot[2].chance = 25;
  ...
  loots['Ettin Sorcerer'].loot[0].objname = 'Medium Armor';
  loots['Ettin Sorcerer'].loot[0].quantity = '1';
  loots['Ettin Sorcerer'].loot[0].chance = 50;
  loots['Ettin Sorcerer'].loot[1] = {};
  loots['Ettin Sorcerer'].loot[1].objname = 'Scrolls2';
  loots['Ettin Sorcerer'].loot[1].quantity = '1d2';
  loots['Ettin Sorcerer'].loot[1].chance = 75;
  ...
  loots['Ettin Sorcerer'].loot[3].objname = 'Mid Weapon';
  loots['Ettin Sorcerer'].loot[3].quantity = '1';
  loots['Ettin Sorcerer'].loot[3].chance = 60;
  ...
  loots['Ettin Sorcerer'].loot[5].objname = 'Lesser Weapon';
  loots['Ettin Sorcerer'].loot[5].quantity = '1';
  loots['Ettin Sorcerer'].loot[5].chance = 30;
  ...
  loots['Ettin Sorcerer'].loot[7].objname = 'Scrolls3';
  loots['Ettin Sorcerer'].loot[7].quantity = '1';
  loots['Ettin Sorcerer'].loot[7].chance = 25;
  ...
  loots['archdaemon_bone'].loot[1].objname = 'Scrolls6';
  loots['archdaemon_bone'].loot[1].quantity = '1';
  loots['archdaemon_bone'].loot[1].chance = 40;
  loots['archdaemon_bone'].loot[2] = {};
  loots['archdaemon_bone'].loot[2].objname = 'Medium Weapon';
  loots['archdaemon_bone'].loot[2].quantity = '1';
  loots['archdaemon_bone'].loot[2].chance = 25;
  loots['archdaemon_bone'].loot[3] = {};
  loots['archdaemon_bone'].loot[3].objname = 'Scrolls4';
  loots['archdaemon_bone'].loot[3].quantity = '1d2';
  loots['archdaemon_bone'].loot[3].chance = 50;
  loots['archdaemon_bone'].loot[4] = {};
  loots['archdaemon_bone'].loot[4].objname = 'Scrolls5';
  loots['archdaemon_bone'].loot[4].quantity = '1';
  loots['archdaemon_bone'].loot[4].chance = 50;
  loots['archdaemon_bone'].loot[5] = {};
  loots['archdaemon_bone'].loot[5].objname = 'Heavy Armor';
  loots['archdaemon_bone'].loot[5].quantity = '1';
  loots['archdaemon_bone'].loot[5].chance = 35;
  loots['archdaemon_bone'].loot[6] = {};
  loots['archdaemon_bone'].loot[6].objname = 'Heavy Weapon';
  loots['archdaemon_bone'].loot[6].quantity = '1';
  loots['archdaemon_bone'].loot[6].chance = 35;
  loots['archdaemon_bone'].loot[7] = {};
  loots['archdaemon_bone'].loot[7].objname = 'Scrolls3';
  loots['archdaemon_bone'].loot[7].quantity = '1d2';
  loots['archdaemon_bone'].loot[7].chance = 50;
  loots['archdaemon_bone'].loot[8] = {};
  loots['archdaemon_bone'].loot[8].objname = 'Potions1';
  loots['archdaemon_bone'].loot[8].quantity = '1d2';
  loots['archdaemon_bone'].loot[8].chance = 50;
  loots['archdaemon_bone'].loot[9] = {};
  loots['archdaemon_bone'].loot[9].objname = 'KeyOfBone';
  loots['archdaemon_bone'].loot[9].quantity = '1';
  loots['archdaemon_bone'].loot[9].chance = 100;
  loots['archdaemon_bone'].loot[10] = {};
  loots['archdaemon_bone'].loot[10].objname = 'Scrolls7';
  loots['archdaemon_bone'].loot[10].quantity = '1';
  loots['archdaemon_bone'].loot[10].chance = 30;
  loots['archdaemon_bone'].loot[11] = {};
  loots['archdaemon_bone'].loot[11].objname = 'Potions4';
  loots['archdaemon_bone'].loot[11].quantity = '1';
  loots['archdaemon_bone'].loot[11].chance = 30;
  loots['archdaemon_bone'].loot[12] = {};
  loots['archdaemon_bone'].loot[12].objname = 'Potions2';
  loots['archdaemon_bone'].loot[12].quantity = '1d2';
  loots['archdaemon_bone'].loot[12].chance = 50;
  loots['archdaemon_bone'].loot[13] = {};
  loots['archdaemon_bone'].loot[13].objname = 'Medium Armor';
  loots['archdaemon_bone'].loot[13].quantity = '1';
  loots['archdaemon_bone'].loot[13].chance = 25;
  ...
  loots['Willowisp'].loot[0].objname = 'Scrolls2';
  loots['Willowisp'].loot[0].quantity = '1';
  loots['Willowisp'].loot[0].chance = 25;
  ...
  loots['Willowisp'].loot[2].objname = 'Audachta3';
  loots['Willowisp'].loot[2].quantity = '1';
  loots['Willowisp'].loot[2].chance = 10;
  loots['Willowisp'].loot[3] = {};
  loots['Willowisp'].loot[3].objname = 'Audachta1';
  loots['Willowisp'].loot[3].quantity = '1';
  loots['Willowisp'].loot[3].chance = 15;
  loots['Willowisp'].loot[4] = {};
  loots['Willowisp'].loot[4].objname = 'Scrolls3';
  loots['Willowisp'].loot[4].quantity = '1';
  loots['Willowisp'].loot[4].chance = 20;
  ...
  loots['Reaper'].loot[0] = {};
  loots['Reaper'].loot[0].objname = 'BloodMoss';
  loots['Reaper'].loot[0].quantity = '1';
  loots['Reaper'].loot[0].chance = 30;
  loots['Reaper'].loot[1] = {};
  loots['Reaper'].loot[1].objname = 'Potions2';
  loots['Reaper'].loot[1].quantity = '1d2';
  loots['Reaper'].loot[1].chance = 30;
  loots['Reaper'].loot[2] = {};
  loots['Reaper'].loot[2].objname = 'Medium Armor';
  loots['Reaper'].loot[2].quantity = '1';
  loots['Reaper'].loot[2].chance = 25;
  loots['Reaper'].loot[3] = {};
  loots['Reaper'].loot[3].objname = 'Scrolls3';
  loots['Reaper'].loot[3].quantity = '1d2';
  loots['Reaper'].loot[3].chance = 25;
  loots['Reaper'].loot[4] = {};
  loots['Reaper'].loot[4].objname = 'Heavy Weapon';
  loots['Reaper'].loot[4].quantity = '1';
  loots['Reaper'].loot[4].chance = 35;
  loots['Reaper'].loot[5] = {};
  loots['Reaper'].loot[5].objname = 'Potions1';
  loots['Reaper'].loot[5].quantity = '1d2';
  loots['Reaper'].loot[5].chance = 30;
  loots['Reaper'].loot[6] = {};
  loots['Reaper'].loot[6].objname = 'Potions4';
  loots['Reaper'].loot[6].quantity = '1d2';
  loots['Reaper'].loot[6].chance = 35;
  loots['Reaper'].loot[7] = {};
  loots['Reaper'].loot[7].objname = 'Scrolls5';
  loots['Reaper'].loot[7].quantity = '1';
  loots['Reaper'].loot[7].chance = 25;
  loots['Reaper'].loot[8] = {};
  loots['Reaper'].loot[8].objname = 'LightningWood';
  loots['Reaper'].loot[8].quantity = '1';
  loots['Reaper'].loot[8].chance = 25;
  loots['Reaper'].loot[9] = {};
  loots['Reaper'].loot[9].objname = 'Heavy Armor';
  loots['Reaper'].loot[9].quantity = '1';
  loots['Reaper'].loot[9].chance = 25;
  loots['Reaper'].loot[10] = {};
  loots['Reaper'].loot[10].objname = 'Potions3';
  loots['Reaper'].loot[10].quantity = '1d2';
  loots['Reaper'].loot[10].chance = 35;
  loots['Reaper'].loot[11] = {};
  loots['Reaper'].loot[11].objname = 'Scrolls6';
  loots['Reaper'].loot[11].quantity = '1';
  loots['Reaper'].loot[11].chance = 20;
  loots['Reaper'].loot[12] = {};
  loots['Reaper'].loot[12].objname = 'Medium Weapon';
  loots['Reaper'].loot[12].quantity = '1';
  loots['Reaper'].loot[12].chance = 20;
  loots['Reaper'].loot[13] = {};
  loots['Reaper'].loot[13].objname = 'Scrolls4';
  loots['Reaper'].loot[13].quantity = '1d2';
  loots['Reaper'].loot[13].chance = 25;
  ...
  loots['Shadow2'].loot[4].objname = 'Mid Weapon';
  ...
  loots['Devourer'].loot[1].objname = 'Mid Weapon';
  loots['Devourer'].loot[1].quantity = '1';
  loots['Devourer'].loot[1].chance = 45;
  loots['Devourer'].loot[2] = {};
  loots['Devourer'].loot[2].objname = 'Potions1';
  loots['Devourer'].loot[2].quantity = '1d2';
  loots['Devourer'].loot[2].chance = 30;
  ...
  loots['Devourer'].loot[4].objname = 'BluePalmCrystal';
  loots['Devourer'].loot[4].quantity = '1';
  loots['Devourer'].loot[4].chance = 10;
  loots['Devourer'].loot[5] = {};
  loots['Devourer'].loot[5].objname = 'MagicAxe';
  loots['Devourer'].loot[5].quantity = '1';
  loots['Devourer'].loot[5].chance = 100;
  loots['Devourer'].loot[6] = {};
  loots['Devourer'].loot[6].objname = 'Medium Armor';
  loots['Devourer'].loot[6].quantity = '1';
  loots['Devourer'].loot[6].chance = 40;
  loots['Devourer'].loot[7] = {};
  loots['Devourer'].loot[7].objname = 'PurplePalmCrystal';
  loots['Devourer'].loot[7].quantity = '1';
  loots['Devourer'].loot[7].chance = 5;
  loots['Devourer'].loot[8] = {};
  loots['Devourer'].loot[8].objname = 'Scrolls4';
  loots['Devourer'].loot[8].quantity = '1';
  loots['Devourer'].loot[8].chance = 15;
  loots['Devourer'].loot[9] = {};
  loots['Devourer'].loot[9].objname = 'Lesser Weapon';
  loots['Devourer'].loot[9].quantity = '1';
  loots['Devourer'].loot[9].chance = 20;
  loots['Devourer'].loot[10] = {};
  loots['Devourer'].loot[10].objname = 'Scrolls1';
  loots['Devourer'].loot[10].quantity = '1';
  loots['Devourer'].loot[10].chance = 10;
  loots['Devourer'].loot[11] = {};
  loots['Devourer'].loot[11].objname = 'Scrolls2';
  loots['Devourer'].loot[11].quantity = '1d2';
  loots['Devourer'].loot[11].chance = 25;
  ...
  loots['Ettin'].loot[1] = {};
  loots['Ettin'].loot[1].objname = 'Mid Ranged';
  loots['Ettin'].loot[1].quantity = '1';
  loots['Ettin'].loot[1].chance = 15;
  loots['Ettin'].loot[2] = {};
  ...
  loots['castlechest'].loot[8].objname = 'BluePalmCrystal';
  ...
  loots['castlechest'].loot[10].objname = 'All Weapons';
  loots['castlechest'].loot[10].quantity = '1d3';
  loots['castlechest'].loot[10].chance = 60;
  loots['castlechest'].loot[11] = {};
  loots['castlechest'].loot[11].objname = 'All Armor';
  loots['castlechest'].loot[11].quantity = '1d2';
  loots['castlechest'].loot[11].chance = 50;
  ...
  loots['castlechest'].loot[13].objname = 'Potions4';
  loots['castlechest'].loot[13].quantity = '1';
  loots['castlechest'].loot[13].chance = 10;
  ...
  loots['castlechest'].loot[15].objname = 'Scrolls7';
  loots['castlechest'].loot[15].quantity = '1';
  loots['castlechest'].loot[15].chance = 5;
  ...
  loots['Trolls'].loot[3] = {};
  loots['Trolls'].loot[3].objname = 'Mid Ranged';
  loots['Trolls'].loot[3].quantity = '1';
  loots['Trolls'].loot[3].chance = 25;
  ...
  loots['GremlinMine'].loot[0].objname = 'UncutGems';
  loots['GremlinMine'].loot[0].quantity = '1';
  loots['GremlinMine'].loot[0].chance = 10;
  loots['GremlinMine'].loot[1] = {};
  loots['GremlinMine'].loot[1].objname = 'Uncut Sapphire';
  ...
  loots['Reaper Lord'].loot[0].objname = 'Scrolls4';
  loots['Reaper Lord'].loot[0].quantity = '1d2';
  loots['Reaper Lord'].loot[0].chance = 30;
  loots['Reaper Lord'].loot[1] = {};
  loots['Reaper Lord'].loot[1].objname = 'Potions3';
  loots['Reaper Lord'].loot[1].quantity = '1d2';
  loots['Reaper Lord'].loot[1].chance = 35;
  loots['Reaper Lord'].loot[2] = {};
  loots['Reaper Lord'].loot[2].objname = 'Scrolls6';
  loots['Reaper Lord'].loot[2].quantity = '1';
  loots['Reaper Lord'].loot[2].chance = 25;
  loots['Reaper Lord'].loot[3] = {};
  loots['Reaper Lord'].loot[3].objname = 'Scrolls5';
  loots['Reaper Lord'].loot[3].quantity = '1';
  loots['Reaper Lord'].loot[3].chance = 30;
  loots['Reaper Lord'].loot[4] = {};
  loots['Reaper Lord'].loot[4].objname = 'LightningWood';
  loots['Reaper Lord'].loot[4].quantity = '1';
  loots['Reaper Lord'].loot[4].chance = 25;
  ...
  loots['Reaper Lord'].loot[6].objname = 'Potions4';
  loots['Reaper Lord'].loot[6].quantity = '1d2';
  loots['Reaper Lord'].loot[6].chance = 35;
  loots['Reaper Lord'].loot[7] = {};
  loots['Reaper Lord'].loot[7].objname = 'Scrolls3';
  loots['Reaper Lord'].loot[7].quantity = '1d2';
  loots['Reaper Lord'].loot[7].chance = 25;
  ...
  loots['Reaper Lord'].loot[10].objname = 'Potions2';
  loots['Reaper Lord'].loot[10].quantity = '1d2';
  loots['Reaper Lord'].loot[10].chance = 30;
  ...
  loots['dragon'].loot[11].objname = 'Potions2';
  loots['dragon'].loot[11].quantity = '1d2';
  loots['dragon'].loot[11].chance = 20;
  loots['dragon'].loot[12] = {};
  loots['dragon'].loot[12].objname = 'Medium Armor';
  ...
  loots['High Orcs'].loot[3].objname = 'Medium Weapon';
  loots['High Orcs'].loot[3].quantity = '1';
  loots['High Orcs'].loot[3].chance = 20;
  loots['High Orcs'].loot[4] = {};
  loots['High Orcs'].loot[4].objname = 'Potions1';
  loots['High Orcs'].loot[4].quantity = '1';
  loots['High Orcs'].loot[4].chance = 50;
  loots['High Orcs'].loot[5] = {};
  loots['High Orcs'].loot[5].objname = 'Mid Weapon';
  loots['High Orcs'].loot[5].quantity = '1';
  loots['High Orcs'].loot[5].chance = 60;
  ...
  loots['Level7'].loot[2] = {};
  loots['Level7'].loot[2].objname = 'Potions3';
  ...
  loots['Level7'].loot[6] = {};
  loots['Level7'].loot[6].objname = 'Potions2';
  ...
  loots['Level7'].loot[12].objname = 'Potions4';
  loots['Level7'].loot[12].quantity = '1';
  loots['Level7'].loot[12].chance = 10;
  ...
  loots['archdaemon_ashes'].loot[11].objname = 'Potions4';
  loots['archdaemon_ashes'].loot[11].quantity = '1';
  loots['archdaemon_ashes'].loot[11].chance = 30;
  loots['archdaemon_ashes'].loot[12] = {};
  loots['archdaemon_ashes'].loot[12].objname = 'Scrolls3';
  loots['archdaemon_ashes'].loot[12].quantity = '1d2';
  loots['archdaemon_ashes'].loot[12].chance = 50;
  loots['archdaemon_ashes'].loot[13] = {};
  loots['archdaemon_ashes'].loot[13].objname = 'Heavy Weapon';
  loots['archdaemon_ashes'].loot[13].quantity = '1';
  loots['archdaemon_ashes'].loot[13].chance = 35;
  ...
  loots['Level4'].loot[5] = {};
  loots['Level4'].loot[5].objname = 'Potions2';
  loots['Level4'].loot[5].quantity = '1';
  loots['Level4'].loot[5].chance = 35;
  loots['Level4'].loot[6] = {};
  loots['Level4'].loot[6].objname = 'Scrolls4';
  loots['Level4'].loot[6].quantity = '1';
  loots['Level4'].loot[6].chance = 15;
  loots['Level4'].loot[7] = {};
  ...
  loots['Level4'].loot[9] = {};
  loots['Level4'].loot[9].objname = 'PurplePalmCrystal';
  loots['Level4'].loot[9].quantity = '1';
  loots['Level4'].loot[9].chance = 5;
  loots['Level4'].loot[10] = {};
  loots['Level4'].loot[10].objname = 'Scrolls2';
  loots['Level4'].loot[10].quantity = '1d2';
  loots['Level4'].loot[10].chance = 25;
