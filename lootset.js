...
function SetLoots() {
  ...
  loots['Ettin'].loot[0] = {};
  loots['Ettin'].loot[0].objname = 'Medium Weapon';
  loots['Ettin'].loot[0].quantity = '1';
  loots['Ettin'].loot[0].chance = 20;
  loots['Ettin'].loot[1] = {};
  ...
  loots['Adventurer'].loot[1].objname = 'Torch';
  loots['Adventurer'].loot[1].quantity = '1d2';
  loots['Adventurer'].loot[1].chance = 50;
  ...
  loots['Adventurer'].loot[3].objname = 'Medium Armor';
  ...
  loots['Adventurer'].loot[6].objname = 'Medium Weapon';
  ...
  loots['Adventurer'].loot[9].objname = 'Lesser Weapon';
  ...
  loots['Phantom'].loot[0].objname = 'BluePalmCrystal';
  loots['Phantom'].loot[0].quantity = '1';
  loots['Phantom'].loot[0].chance = 20;
  ...
  loots['archdaemon_dust'].loot[2].objname = 'Scrolls4';
  ...
  loots['archdaemon_dust'].loot[5].objname = 'Potions1';
  ...
  loots['archdaemon_dust'].loot[8].objname = 'Medium Weapon';
  loots['archdaemon_dust'].loot[8].quantity = '1';
  loots['archdaemon_dust'].loot[8].chance = 25;
  ...
  loots['archdaemon_dust'].loot[10].objname = 'Potions3';
  loots['archdaemon_dust'].loot[10].quantity = '1';
  loots['archdaemon_dust'].loot[10].chance = 30;
  loots['archdaemon_dust'].loot[11] = {};
  loots['archdaemon_dust'].loot[11].objname = 'Scrolls6';
  loots['archdaemon_dust'].loot[11].quantity = '1';
  loots['archdaemon_dust'].loot[11].chance = 40;
  loots['archdaemon_dust'].loot[12] = {};
  loots['archdaemon_dust'].loot[12].objname = 'Scrolls7';
  loots['archdaemon_dust'].loot[12].quantity = '1';
  loots['archdaemon_dust'].loot[12].chance = 30;
  loots['archdaemon_dust'].loot[13] = {};
  loots['archdaemon_dust'].loot[13].objname = 'KeyOfDust';
  loots['archdaemon_dust'].loot[13].quantity = '1';
  loots['archdaemon_dust'].loot[13].chance = 100;
  ...
  loots['dragon'].loot[1] = {};
  loots['dragon'].loot[1].objname = 'Scrolls5';
  ...
  loots['dragon'].loot[12].objname = 'Mid Ranged';
  loots['dragon'].loot[12].quantity = '1';
  loots['dragon'].loot[12].chance = 15;
  ...
  loots['Level4'].loot[1] = {};
  loots['Level4'].loot[1].objname = 'Scrolls4';
  loots['Level4'].loot[1].quantity = '1';
  loots['Level4'].loot[1].chance = 15;
  loots['Level4'].loot[2] = {};
  ...
  loots['Level4'].loot[4] = {};
  loots['Level4'].loot[4].objname = 'Potions1';
  loots['Level4'].loot[4].quantity = '1d2';
  loots['Level4'].loot[4].chance = 30;
  loots['Level4'].loot[5] = {};
  ...
  loots['Devourer'].loot[0].objname = 'BluePalmCrystal';
  loots['Devourer'].loot[0].quantity = '1';
  loots['Devourer'].loot[0].chance = 10;
  loots['Devourer'].loot[1] = {};
  loots['Devourer'].loot[1].objname = 'PurplePalmCrystal';
  loots['Devourer'].loot[1].quantity = '1';
  loots['Devourer'].loot[1].chance = 5;
  ...
  loots['Devourer'].loot[9].objname = 'Medium Armor';
  loots['Devourer'].loot[9].quantity = '1';
  loots['Devourer'].loot[9].chance = 40;
  loots['Devourer'].loot[10] = {};
  loots['Devourer'].loot[10].objname = 'MagicAxe';
  loots['Devourer'].loot[10].quantity = '1';
  loots['Devourer'].loot[10].chance = 100;
  ...
  loots['Willowisp'].loot[4].objname = 'Audachta2';
  ...
  loots['Level5'].loot[0] = {};
  loots['Level5'].loot[0].objname = 'Scrolls4';
  loots['Level5'].loot[0].quantity = '1';
  loots['Level5'].loot[0].chance = 30;
  loots['Level5'].loot[1] = {};
  loots['Level5'].loot[1].objname = 'Scrolls5';
  loots['Level5'].loot[1].quantity = '1';
  loots['Level5'].loot[1].chance = 25;
  loots['Level5'].loot[2] = {};
  ...
  loots['Level5'].loot[12].objname = 'PurplePalmCrystal';
  loots['Level5'].loot[12].quantity = '1';
  loots['Level5'].loot[12].chance = 5;
  ...
  loots['Giant'].loot[0] = {};
  loots['Giant'].loot[0].objname = 'Potions4';
  loots['Giant'].loot[0].quantity = '1';
  loots['Giant'].loot[0].chance = 30;
  loots['Giant'].loot[1] = {};
  ...
  loots['Specter'].loot[1].objname = 'BluePalmCrystal';
  ...
  loots['Specter'].loot[4].objname = 'GreenPalmCrystal';
  ...
  loots['Specter'].loot[6].objname = 'Scrolls4';
  loots['Specter'].loot[6].quantity = '1';
  loots['Specter'].loot[6].chance = 15;
  ...
  loots['Specter'].loot[8].objname = 'Audachta3';
  ...
  loots['Level7'].loot[1] = {};
  loots['Level7'].loot[1].objname = 'Potions2';
  loots['Level7'].loot[1].quantity = '1d2';
  loots['Level7'].loot[1].chance = 30;
  loots['Level7'].loot[2] = {};
  loots['Level7'].loot[2].objname = 'Potions1';
  ...
  loots['Level7'].loot[9].chance = 45;
  loots['Level7'].loot[10] = {};
  loots['Level7'].loot[10].objname = 'Medium Weapon';
  loots['Level7'].loot[10].quantity = '1';
  loots['Level7'].loot[10].chance = 25;
  ...
  loots['Ettin Sorcerer'].loot[3].objname = 'Scrolls3';
  loots['Ettin Sorcerer'].loot[3].quantity = '1';
  loots['Ettin Sorcerer'].loot[3].chance = 25;
  ...
  loots['Ettin Sorcerer'].loot[6].objname = 'Lesser Weapon';
  loots['Ettin Sorcerer'].loot[6].quantity = '1';
  loots['Ettin Sorcerer'].loot[6].chance = 30;
  ...
  loots['Toshin'].loot[4] = {};
  loots['Toshin'].loot[4].objname = 'Potions2';
  ...
  loots['Toshin'].loot[8] = {};
  loots['Toshin'].loot[8].objname = 'Potions3';
  ...
  loots['High Adventurer'].loot[1].objname = 'Mid Ranged';
  loots['High Adventurer'].loot[1].quantity = '1';
  loots['High Adventurer'].loot[1].chance = 10;
  loots['High Adventurer'].loot[2] = {};
  loots['High Adventurer'].loot[2].objname = 'Torch';
  loots['High Adventurer'].loot[2].quantity = '1d2';
  loots['High Adventurer'].loot[2].chance = 50;
  ...
  loots['High Adventurer'].loot[14].objname = 'Scrolls3';
  ...
  loots['archdaemon_ashes'].loot[0].objname = 'Medium Weapon';
  loots['archdaemon_ashes'].loot[0].quantity = '1';
  loots['archdaemon_ashes'].loot[0].chance = 25;
  loots['archdaemon_ashes'].loot[1] = {};
  loots['archdaemon_ashes'].loot[1].objname = 'Heavy Weapon';
  loots['archdaemon_ashes'].loot[1].quantity = '1';
  loots['archdaemon_ashes'].loot[1].chance = 35;
  ...
  loots['archdaemon_ashes'].loot[4].objname = 'Heavy Armor';
  loots['archdaemon_ashes'].loot[4].quantity = '1';
  loots['archdaemon_ashes'].loot[4].chance = 35;
  ...
  loots['archdaemon_ashes'].loot[8].objname = 'Potions1';
  ...
  loots['archdaemon_ashes'].loot[10].objname = 'Potions4';
  loots['archdaemon_ashes'].loot[10].quantity = '1';
  loots['archdaemon_ashes'].loot[10].chance = 30;
  loots['archdaemon_ashes'].loot[11] = {};
  loots['archdaemon_ashes'].loot[11].objname = 'KeyOfAshes';
  loots['archdaemon_ashes'].loot[11].quantity = '1';
  loots['archdaemon_ashes'].loot[11].chance = 100;
  ...
  loots['archdaemon_ashes'].loot[13].objname = 'Scrolls6';
  loots['archdaemon_ashes'].loot[13].quantity = '1';
  loots['archdaemon_ashes'].loot[13].chance = 40;
  ...
  loots['Lesser Adventurer'].loot[5].objname = 'Potions2';
  ...
  loots['castlechest'].loot[4].objname = 'Potions4';
  ...
  loots['castlechest'].loot[11].objname = 'PurplePalmCrystal';
  ...
  loots['archdaemon_bone'].loot[1].objname = 'Heavy Armor';
  loots['archdaemon_bone'].loot[1].quantity = '1';
  loots['archdaemon_bone'].loot[1].chance = 35;
  ...
  loots['archdaemon_bone'].loot[4].objname = 'Heavy Weapon';
  loots['archdaemon_bone'].loot[4].quantity = '1';
  loots['archdaemon_bone'].loot[4].chance = 35;
  ...
  loots['archdaemon_bone'].loot[8].objname = 'Scrolls4';
  ...
  loots['archdaemon_bone'].loot[10].objname = 'Medium Armor';
  loots['archdaemon_bone'].loot[10].quantity = '1';
  loots['archdaemon_bone'].loot[10].chance = 25;
  loots['archdaemon_bone'].loot[11] = {};
  loots['archdaemon_bone'].loot[11].objname = 'KeyOfBone';
  loots['archdaemon_bone'].loot[11].quantity = '1';
  loots['archdaemon_bone'].loot[11].chance = 100;
  loots['archdaemon_bone'].loot[12] = {};
  loots['archdaemon_bone'].loot[12].objname = 'Scrolls7';
  loots['archdaemon_bone'].loot[12].quantity = '1';
  loots['archdaemon_bone'].loot[12].chance = 30;
  loots['archdaemon_bone'].loot[13] = {};
  loots['archdaemon_bone'].loot[13].objname = 'Scrolls6';
  loots['archdaemon_bone'].loot[13].quantity = '1';
  loots['archdaemon_bone'].loot[13].chance = 40;
  ...
  loots['Level3'].loot[1] = {};
  loots['Level3'].loot[1].objname = 'Potions1';
  loots['Level3'].loot[1].quantity = '1d2';
  ...
  loots['Level3'].loot[3] = {};
  loots['Level3'].loot[3].objname = 'Scrolls2';
  loots['Level3'].loot[3].quantity = '1';
  loots['Level3'].loot[3].chance = 25;
  loots['Level3'].loot[4] = {};
  loots['Level3'].loot[4].objname = 'Scrolls1';
  loots['Level3'].loot[4].quantity = '1';
  loots['Level3'].loot[4].chance = 10;
  loots['Level3'].loot[5] = {};
  loots['Level3'].loot[5].objname = 'Medium Armor';
  ...
  loots['Level3'].loot[9] = {};
  loots['Level3'].loot[9].objname = 'Scrolls3';
  ...
  loots['Archmage'].loot[0].chance = 100;
  loots['Archmage'].loot[1] = {};
  loots['Archmage'].loot[1].objname = 'Scrolls3';
  ...
  loots['Archmage'].loot[3].objname = 'Potions3';
  ...
  loots['Archmage'].loot[10].objname = 'Audachta2';
  ...
  loots['Level6'].loot[6] = {};
  loots['Level6'].loot[6].objname = 'Scrolls3';
  loots['Level6'].loot[6].quantity = '1d2';
  loots['Level6'].loot[6].chance = 25;
  loots['Level6'].loot[7] = {};
  loots['Level6'].loot[7].objname = 'Heavy Weapon';
  loots['Level6'].loot[7].quantity = '1';
  loots['Level6'].loot[7].chance = 35;
  loots['Level6'].loot[8] = {};
  ...
  loots['Level6'].loot[10].objname = 'Potions3';
  ...
  loots['Reaper'].loot[0] = {};
  loots['Reaper'].loot[0].objname = 'Scrolls6';
  loots['Reaper'].loot[0].quantity = '1';
  loots['Reaper'].loot[0].chance = 20;
  loots['Reaper'].loot[1] = {};
  loots['Reaper'].loot[1].objname = 'LightningWood';
  loots['Reaper'].loot[1].quantity = '1';
  loots['Reaper'].loot[1].chance = 25;
  loots['Reaper'].loot[2] = {};
  loots['Reaper'].loot[2].objname = 'Potions1';
  loots['Reaper'].loot[2].quantity = '1d2';
  loots['Reaper'].loot[2].chance = 30;
  loots['Reaper'].loot[3] = {};
  loots['Reaper'].loot[3].objname = 'Potions2';
  loots['Reaper'].loot[3].quantity = '1d2';
  loots['Reaper'].loot[3].chance = 30;
  loots['Reaper'].loot[4] = {};
  loots['Reaper'].loot[4].objname = 'Potions4';
  loots['Reaper'].loot[4].quantity = '1d2';
  loots['Reaper'].loot[4].chance = 35;
  loots['Reaper'].loot[5] = {};
  loots['Reaper'].loot[5].objname = 'Scrolls5';
  loots['Reaper'].loot[5].quantity = '1';
  loots['Reaper'].loot[5].chance = 25;
  loots['Reaper'].loot[6] = {};
  loots['Reaper'].loot[6].objname = 'Scrolls4';
  loots['Reaper'].loot[6].quantity = '1d2';
  loots['Reaper'].loot[6].chance = 25;
  loots['Reaper'].loot[7] = {};
  loots['Reaper'].loot[7].objname = 'Medium Armor';
  loots['Reaper'].loot[7].quantity = '1';
  loots['Reaper'].loot[7].chance = 25;
  loots['Reaper'].loot[8] = {};
  loots['Reaper'].loot[8].objname = 'Potions3';
  loots['Reaper'].loot[8].quantity = '1d2';
  loots['Reaper'].loot[8].chance = 35;
  loots['Reaper'].loot[9] = {};
  loots['Reaper'].loot[9].objname = 'BloodMoss';
  loots['Reaper'].loot[9].quantity = '1';
  loots['Reaper'].loot[9].chance = 30;
  loots['Reaper'].loot[10] = {};
  loots['Reaper'].loot[10].objname = 'Heavy Armor';
  loots['Reaper'].loot[10].quantity = '1';
  loots['Reaper'].loot[10].chance = 25;
  loots['Reaper'].loot[11] = {};
  loots['Reaper'].loot[11].objname = 'Medium Weapon';
  loots['Reaper'].loot[11].quantity = '1';
  loots['Reaper'].loot[11].chance = 20;
  loots['Reaper'].loot[12] = {};
  loots['Reaper'].loot[12].objname = 'Heavy Weapon';
  loots['Reaper'].loot[12].quantity = '1';
  loots['Reaper'].loot[12].chance = 35;
  loots['Reaper'].loot[13] = {};
  loots['Reaper'].loot[13].objname = 'Scrolls3';
  ...
  loots['olympus_secret'].loot[3].objname = 'Lesser Weapon';
  loots['olympus_secret'].loot[3].quantity = '1d2';
  loots['olympus_secret'].loot[3].chance = 60;
  ...
  loots['Level2'].loot[3] = {};
  loots['Level2'].loot[3].objname = 'Scrolls2';
  loots['Level2'].loot[3].quantity = '1';
  loots['Level2'].loot[3].chance = 20;
  loots['Level2'].loot[4] = {};
  ...
  loots['Level2'].loot[7] = {};
  loots['Level2'].loot[7].objname = 'Lesser Weapon';
  loots['Level2'].loot[7].quantity = '1';
  loots['Level2'].loot[7].chance = 40;
