...
function SetLoots() {
  ...
  loots['Lesser Adventurer'].loot[5].objname = 'Low Ranged';
  ...
  loots['Lesser Adventurer'].loot[7].objname = 'Scrolls1';
  ...
  loots['archdaemon_bone'].loot[10].objname = 'Potions3';
  ...
  loots['High Orcs'].loot[4].objname = 'Medium Armor';
  ...
  loots['Willowisp'].loot[4].objname = 'Scrolls4';
  ...
  loots['castlechest'].loot[4].objname = 'PurplePalmCrystal';
  ...
  loots['Level5'].loot[0] = {};
  loots['Level5'].loot[0].objname = 'Scrolls5';
  loots['Level5'].loot[0].quantity = '1';
  loots['Level5'].loot[0].chance = 25;
  loots['Level5'].loot[1] = {};
  loots['Level5'].loot[1].objname = 'Potions1';
  ...
  loots['Level5'].loot[6] = {};
  loots['Level5'].loot[6].objname = 'Potions3';
  loots['Level5'].loot[6].quantity = '1';
  loots['Level5'].loot[6].chance = 30;
  loots['Level5'].loot[7] = {};
  loots['Level5'].loot[7].objname = 'Heavy Armor';
  loots['Level5'].loot[7].quantity = '1';
  loots['Level5'].loot[7].chance = 20;
  loots['Level5'].loot[8] = {};
  ...
  loots['Level5'].loot[10].objname = 'Mid Weapon';
  ...
  loots['Level4'].loot[9] = {};
  loots['Level4'].loot[9].objname = 'Medium Armor';
  loots['Level4'].loot[9].quantity = '1';
  loots['Level4'].loot[9].chance = 40;
  ...
  loots['High Adventurer'].loot[0].objname = 'Mid Ranged';
  ...
  loots['High Adventurer'].loot[3].objname = 'Potions1';
  ...
  loots['High Adventurer'].loot[6].objname = 'Audachta1';
  ...
  loots['High Adventurer'].loot[8].objname = 'Heavy Weapon';
  ...
  loots['High Adventurer'].loot[11].objname = 'PurplePalmCrystal';
  ...
  loots['Archmage'].loot[9].objname = 'Potions2';
  loots['Archmage'].loot[9].quantity = '1d2';
  loots['Archmage'].loot[9].chance = 25;
  loots['Archmage'].loot[10] = {};
  loots['Archmage'].loot[10].objname = 'Scrolls6';
  loots['Archmage'].loot[10].quantity = '1';
  loots['Archmage'].loot[10].chance = 20;
  loots['Archmage'].loot[11] = {};
  loots['Archmage'].loot[11].objname = 'Potions4';
  ...
  loots['archdaemon_ice'].loot[9].objname = 'Scrolls7';
  ...
  loots['Ettin Sorcerer'].loot[4].objname = 'Scrolls2';
  loots['Ettin Sorcerer'].loot[4].quantity = '1d2';
  loots['Ettin Sorcerer'].loot[4].chance = 75;
  ...
  loots['Level7'].loot[7] = {};
  loots['Level7'].loot[7].objname = 'Heavy Weapon';
  ...
  loots['Adventurer'].loot[3].objname = 'Potions1';
  loots['Adventurer'].loot[3].quantity = '1';
  loots['Adventurer'].loot[3].chance = 20;
  ...
  loots['archdaemon_ashes'].loot[8].objname = 'KeyOfAshes';
  loots['archdaemon_ashes'].loot[8].quantity = '1';
  loots['archdaemon_ashes'].loot[8].chance = 100;
  ...
  loots['archdaemon_ashes'].loot[11].objname = 'Medium Armor';
  loots['archdaemon_ashes'].loot[11].quantity = '1';
  loots['archdaemon_ashes'].loot[11].chance = 25;
  ...
  loots['Level6'].loot[1] = {};
  loots['Level6'].loot[1].objname = 'Medium Weapon';
  loots['Level6'].loot[1].quantity = '1';
  loots['Level6'].loot[1].chance = 50;
  loots['Level6'].loot[2] = {};
