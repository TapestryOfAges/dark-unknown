...
function SetLoots() {
  ...
  loots['Level6'].loot[6] = {};
  loots['Level6'].loot[6].objname = 'Potions1';
  ...
  loots['Adventurer'].loot[5].objname = 'Lesser Weapon';
  ...
  loots['Lesser Adventurer'].loot[3].objname = 'Lesser Weapon';
  ...
  loots['Lesser Adventurer'].loot[8].objname = 'Mid Weapon';
  ...
  loots['castlechest'].loot[10].objname = 'Potions1';
  ...
  loots['Level7'].loot[5] = {};
  loots['Level7'].loot[5].objname = 'Potions2';
  ...
  loots['High Adventurer'].loot[9].objname = 'Medium Weapon';
  ...
  loots['High Adventurer'].loot[11].objname = 'Potions2';
