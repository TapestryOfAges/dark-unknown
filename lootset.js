...
function SetLoots() {
  ...
  loots['archdaemon_ashes'].loot[8].objname = 'Heavy Weapon';
  loots['archdaemon_ashes'].loot[8].quantity = '1';
  loots['archdaemon_ashes'].loot[8].chance = 35;
  loots['archdaemon_ashes'].loot[9] = {};
  loots['archdaemon_ashes'].loot[9].objname = 'Medium Weapon';
  loots['archdaemon_ashes'].loot[9].quantity = '1';
  loots['archdaemon_ashes'].loot[9].chance = 25;
  loots['archdaemon_ashes'].loot[10] = {};
  loots['archdaemon_ashes'].loot[10].objname = 'Scrolls6';
  loots['archdaemon_ashes'].loot[10].quantity = '1';
  loots['archdaemon_ashes'].loot[10].chance = 40;
  ...
  loots['archdaemon_ashes'].loot[12].objname = 'KeyOfAshes';
  loots['archdaemon_ashes'].loot[12].quantity = '1';
  loots['archdaemon_ashes'].loot[12].chance = 100;
  loots['archdaemon_ashes'].loot[13] = {};
  loots['archdaemon_ashes'].loot[13].objname = 'Potions1';
  ...
  loots['Specter'].loot[6].objname = 'Audachta2';
  ...
  loots['castlechest'].loot[15].objname = 'Scrolls8';
  ...
  loots['archdaemon_dust'].loot[1].objname = 'Heavy Weapon';
  loots['archdaemon_dust'].loot[1].quantity = '1';
  loots['archdaemon_dust'].loot[1].chance = 35;
  ...
  loots['archdaemon_dust'].loot[3].objname = 'Scrolls4';
  ...
  loots['archdaemon_dust'].loot[8].objname = 'Heavy Armor';
  loots['archdaemon_dust'].loot[8].quantity = '1';
  loots['archdaemon_dust'].loot[8].chance = 35;
  ...
  loots['archdaemon_dust'].loot[12].objname = 'KeyOfDust';
  loots['archdaemon_dust'].loot[12].quantity = '1';
  loots['archdaemon_dust'].loot[12].chance = 100;
  ...
  loots['Level7'].loot[7] = {};
  loots['Level7'].loot[7].objname = 'Potions2';
  ...
  loots['Level7'].loot[10].objname = 'Medium Armor';
  ...
  loots['Level3'].loot[0] = {};
  loots['Level3'].loot[0].objname = 'Scrolls2';
  ...
  loots['Level6'].loot[2] = {};
  loots['Level6'].loot[2].objname = 'Medium Weapon';
  loots['Level6'].loot[2].quantity = '1';
  loots['Level6'].loot[2].chance = 50;
  loots['Level6'].loot[3] = {};
  ...
  loots['Level6'].loot[5] = {};
  loots['Level6'].loot[5].objname = 'Scrolls4';
  ...
  loots['Level6'].loot[9] = {};
  loots['Level6'].loot[9].objname = 'Potions2';
  ...
  loots['Toshin'].loot[2] = {};
  loots['Toshin'].loot[2].objname = 'Scrolls4';
  ...
  loots['Level4'].loot[1] = {};
  loots['Level4'].loot[1].objname = 'Potions1';
  loots['Level4'].loot[1].quantity = '1d2';
  loots['Level4'].loot[1].chance = 30;
  loots['Level4'].loot[2] = {};
  ...
  loots['High Adventurer'].loot[0].objname = 'Torch';
  loots['High Adventurer'].loot[0].quantity = '1d2';
  loots['High Adventurer'].loot[0].chance = 50;
  ...
  loots['High Adventurer'].loot[9].objname = 'Audachta1';
  ...
  loots['archdaemon_ice'].loot[7].objname = 'Scrolls3';
  ...
  loots['archdaemon_bone'].loot[10].objname = 'KeyOfBone';
  loots['archdaemon_bone'].loot[10].quantity = '1';
  loots['archdaemon_bone'].loot[10].chance = 100;
  ...
  loots['Adventurer'].loot[7].objname = 'Mid Ranged';
