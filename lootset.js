...
function SetLoots() {
  ...
  loots['Level7'].loot[4] = {};
  loots['Level7'].loot[4].objname = 'Scrolls5';
  ...
  loots['Level3'].loot[3] = {};
  loots['Level3'].loot[3].objname = 'BluePalmCrystal';
  ...
  loots['Level3'].loot[9] = {};
  loots['Level3'].loot[9].objname = 'Mid Weapon';
  ...
  loots['Level4'].loot[1] = {};
  loots['Level4'].loot[1].objname = 'Potions2';
  loots['Level4'].loot[1].quantity = '1';
  loots['Level4'].loot[1].chance = 35;
  loots['Level4'].loot[2] = {};
  ...
  loots['Archmage'].loot[2].objname = 'Audachta1';
  ...
  loots['Archmage'].loot[5].objname = 'Scrolls3';
  ...
  loots['High Adventurer'].loot[10].objname = 'Potions2';
  loots['High Adventurer'].loot[10].quantity = '1';
  loots['High Adventurer'].loot[10].chance = 20;
  ...
  loots['High Adventurer'].loot[13].objname = 'Potions1';
  ...
  loots['Level6'].loot[4] = {};
  loots['Level6'].loot[4].objname = 'Heavy Armor';
  ...
  loots['Level6'].loot[10].objname = 'Heavy Weapon';
