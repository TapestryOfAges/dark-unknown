...
function SetLoots() {
  ...
  loots['castlechest'].loot[8].objname = 'PurplePalmCrystal';
  loots['castlechest'].loot[8].quantity = '1';
  loots['castlechest'].loot[8].chance = 5;
  loots['castlechest'].loot[9] = {};
  loots['castlechest'].loot[9].objname = 'BluePalmCrystal';
  ...
  loots['Level5'].loot[0] = {};
  loots['Level5'].loot[0].objname = 'Medium Weapon';
  ...
  loots['Level7'].loot[11].objname = 'Potions2';
  ...
  loots['Level7'].loot[12].chance = 35;
  ...
  loots['archdaemon_bone'].loot[0].objname = 'Heavy Weapon';
  loots['archdaemon_bone'].loot[0].quantity = '1';
  loots['archdaemon_bone'].loot[0].chance = 35;
  ...
  loots['archdaemon_bone'].loot[2].objname = 'Medium Armor';
  ...
  loots['Archmage'].loot[6].objname = 'Potions1';
  ...
  loots['Level6'].loot[1] = {};
  loots['Level6'].loot[1].objname = 'Potions3';
  ...
  loots['Ettin'].loot[3] = {};
  loots['Ettin'].loot[3].objname = 'Medium Armor';
  ...
  loots['High Adventurer'].loot[4].objname = 'Audachta1';
  ...
  loots['archdaemon_dust'].loot[5].objname = 'Potions2';
  ...
  loots['archdaemon_dust'].loot[7].objname = 'Heavy Weapon';
  ...
  loots['archdaemon_dust'].loot[9].objname = 'Medium Armor';
  ...
  loots['archdaemon_dust'].loot[12].objname = 'Scrolls4';
  ...
  loots['archdaemon_ice'].loot[5].objname = 'Heavy Weapon';
  loots['archdaemon_ice'].loot[5].quantity = '1';
  loots['archdaemon_ice'].loot[5].chance = 35;
  loots['archdaemon_ice'].loot[6] = {};
  loots['archdaemon_ice'].loot[6].objname = 'KeyOfIce';
  loots['archdaemon_ice'].loot[6].quantity = '1';
  loots['archdaemon_ice'].loot[6].chance = 100;
  ...
  loots['archdaemon_ice'].loot[11].objname = 'Potions4';
  ...
  loots['archdaemon_ashes'].loot[8].objname = 'Scrolls5';
