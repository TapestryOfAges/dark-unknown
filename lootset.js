...
function SetLoots() {
  ...
  loots['High Adventurer'].loot[1].objname = 'Torch';
  loots['High Adventurer'].loot[1].quantity = '1d2';
  loots['High Adventurer'].loot[1].chance = 50;
  loots['High Adventurer'].loot[2] = {};
  loots['High Adventurer'].loot[2].objname = 'Heavy Weapon';
  ...
  loots['Level4'].loot[3] = {};
  loots['Level4'].loot[3].objname = 'BluePalmCrystal';
  ...
  loots['Specter'].loot[6].objname = 'PurplePalmCrystal';
  loots['Specter'].loot[6].quantity = '1';
  loots['Specter'].loot[6].chance = 15;
  loots['Specter'].loot[7] = {};
  loots['Specter'].loot[7].objname = 'Audachta2';
  ...
  loots['castlechest'].loot[1].objname = 'PurplePalmCrystal';
  ...
  loots['castlechest'].loot[3].objname = 'Scrolls2';
  ...
  loots['castlechest'].loot[10].objname = 'All Armor';
  loots['castlechest'].loot[10].quantity = '1d2';
  loots['castlechest'].loot[10].chance = 50;
  ...
  loots['castlechest'].loot[13].objname = 'Scrolls3';
  loots['castlechest'].loot[13].quantity = '1';
  loots['castlechest'].loot[13].chance = 20;
  ...
  loots['castlechest'].loot[15].objname = 'Potions3';
  ...
  loots['archdaemon_ice'].loot[2].objname = 'Scrolls7';
  ...
  loots['archdaemon_ice'].loot[7].objname = 'Heavy Armor';
  loots['archdaemon_ice'].loot[7].quantity = '1';
  loots['archdaemon_ice'].loot[7].chance = 35;
  ...
  loots['archdaemon_ice'].loot[10].objname = 'Scrolls4';
  ...
  loots['archdaemon_dust'].loot[0].objname = 'Potions2';
  ...
  loots['archdaemon_dust'].loot[2].objname = 'Heavy Weapon';
  loots['archdaemon_dust'].loot[2].quantity = '1';
  loots['archdaemon_dust'].loot[2].chance = 35;
  loots['archdaemon_dust'].loot[3] = {};
  loots['archdaemon_dust'].loot[3].objname = 'Medium Weapon';
  ...
  loots['archdaemon_dust'].loot[10].objname = 'Medium Armor';
  ...
  loots['archdaemon_dust'].loot[13].objname = 'Heavy Armor';
  ...
  loots['Lesser Adventurer'].loot[0].objname = 'Medium Armor';
  ...
  loots['archdaemon_bone'].loot[1].objname = 'Medium Armor';
  loots['archdaemon_bone'].loot[1].quantity = '1';
  loots['archdaemon_bone'].loot[1].chance = 25;
  ...
  loots['Toshin'].loot[6] = {};
  loots['Toshin'].loot[6].objname = 'Potions2';
  ...
  loots['Level7'].loot[7] = {};
  loots['Level7'].loot[7].objname = 'Scrolls6';
  loots['Level7'].loot[7].quantity = '1';
  loots['Level7'].loot[7].chance = 20;
  loots['Level7'].loot[8] = {};
  ...
  loots['Level5'].loot[5] = {};
  loots['Level5'].loot[5].objname = 'Scrolls3';
  ...
  loots['Level6'].loot[6] = {};
  loots['Level6'].loot[6].objname = 'Potions4';
