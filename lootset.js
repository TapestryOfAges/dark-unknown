...
function SetLoots() {
  ...
  loots['archdaemon_ice'].loot[11].objname = 'Medium Weapon';
  ...
  loots['archdaemon_bone'].loot[8].objname = 'Medium Armor';
  ...
  loots['archdaemon_bone'].loot[11].objname = 'Medium Weapon';
  ...
  loots['archdaemon_bone'].loot[13].objname = 'Heavy Armor';
  loots['archdaemon_bone'].loot[13].quantity = '1';
  loots['archdaemon_bone'].loot[13].chance = 35;
  ...
  loots['High Adventurer'].loot[1].objname = 'Audachta1';
  ...
  loots['High Adventurer'].loot[3].objname = 'Mid Weapon';
  ...
  loots['High Adventurer'].loot[8].objname = 'Mid Ranged';
  ...
  loots['High Adventurer'].loot[15].objname = 'Heavy Weapon';
  ...
  loots['Toshin'].loot[0] = {};
  loots['Toshin'].loot[0].objname = 'Scrolls3';
  loots['Toshin'].loot[0].quantity = '1d2';
  loots['Toshin'].loot[0].chance = 35;
  loots['Toshin'].loot[1] = {};
  loots['Toshin'].loot[1].objname = 'Potions3';
  ...
  loots['Adventurer'].loot[1].objname = 'Mid Ranged';
  ...
  loots['castlechest'].loot[5].objname = 'All Armor';
  loots['castlechest'].loot[5].quantity = '1d2';
  loots['castlechest'].loot[5].chance = 50;
  ...
  loots['castlechest'].loot[11].objname = 'Potions4';
  ...
  loots['castlechest'].loot[14].objname = 'Potions3';
  ...
  loots['Ettin Sorcerer'].loot[2].objname = 'Potions3';
  ...
  loots['archdaemon_ashes'].loot[8].objname = 'Scrolls6';
  loots['archdaemon_ashes'].loot[8].quantity = '1';
  loots['archdaemon_ashes'].loot[8].chance = 40;
  loots['archdaemon_ashes'].loot[9] = {};
  loots['archdaemon_ashes'].loot[9].objname = 'Heavy Armor';
  loots['archdaemon_ashes'].loot[9].quantity = '1';
  loots['archdaemon_ashes'].loot[9].chance = 35;
  ...
  loots['archdaemon_ashes'].loot[11].objname = 'Potions1';
  loots['archdaemon_ashes'].loot[11].quantity = '1d2';
  loots['archdaemon_ashes'].loot[11].chance = 50;
  loots['archdaemon_ashes'].loot[12] = {};
  loots['archdaemon_ashes'].loot[12].objname = 'Medium Weapon';
  loots['archdaemon_ashes'].loot[12].quantity = '1';
  loots['archdaemon_ashes'].loot[12].chance = 25;
  loots['archdaemon_ashes'].loot[13] = {};
  loots['archdaemon_ashes'].loot[13].objname = 'Potions2';
  ...
  loots['Level5'].loot[10].objname = 'Potions3';
  ...
  loots['Ettin'].loot[5] = {};
  loots['Ettin'].loot[5].objname = 'Mid Ranged';
  loots['Ettin'].loot[5].quantity = '1';
  loots['Ettin'].loot[5].chance = 15;
  ...
  loots['archdaemon_dust'].loot[4].objname = 'Scrolls7';
  ...
  loots['archdaemon_dust'].loot[7].objname = 'Potions4';
  ...
  loots['archdaemon_dust'].loot[12].objname = 'Medium Weapon';
  loots['archdaemon_dust'].loot[12].quantity = '1';
  loots['archdaemon_dust'].loot[12].chance = 25;
  loots['archdaemon_dust'].loot[13] = {};
  loots['archdaemon_dust'].loot[13].objname = 'Potions2';
  ...
  loots['Level6'].loot[11].objname = 'Scrolls4';
