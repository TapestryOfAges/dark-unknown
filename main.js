...
//      DisplayWares(targetCursor.talkingto);
    ...
    if (targetCursor.dark === 1) {
      ...
      targetCursor.dark++;
      if (DU.settings.getSetting("music")) { DUPlayMusic("Alone", {fade:1}); }
      ...
      if (targetCursor.darkchar === 0) {
        if (DU.gameflags.getFlag("rescued_sam")) {
          ...
          let kylee = endmap.getTile(14,4).getTopNPC();
      ...
      if (DU.settings.getSetting("music")) { DUPlayMusic("Light", {fade:1, queue:"Theme"}); }
      targetCursor.dark++;
