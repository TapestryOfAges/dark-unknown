...
mappages["asharden1"].features[19] = {name : 'PileOfRocks', x : 23, y : 13};
mappages["asharden1"].features[20] = {name : 'EnergyField', x : 26, y : 20};
mappages["asharden1"].features[21] = {name : 'EnergyField', x : 24, y : 20};
mappages["asharden1"].features[22] = {name : 'SleepField', x : 30, y : 18};
mappages["asharden1"].features[23] = {name : 'PoisonField', x : 20, y : 18};
mappages["asharden1"].features[24] = {name : 'FireField', x : 29, y : 15};
mappages["asharden1"].features[25] = {name : 'FireField', x : 21, y : 15};
mappages["asharden1"].features[26] = {name : 'Brazier', x : 14, y : 18};


mappages["asharden1"].npcs = [];
mappages["asharden1"].npcs[0] = {name : 'MageVillagerNPC', x : 25, y : 17, NPCName: 'Asharden', Desc: 'wizard', Level: 6, int: 24, Conversation: 'asharden', ConversationFlag: 'asharden', Gender: 'male', Leash: 3, Bark: '0', NPCBand: '0', skintone: 1, wornlayers: '{"body":"RedRobe","head":"OldManPale","back":"","offhand":"OffhandPale","cloak":"","mainhand":"QuarterstaffPale","realhead":"OldManPale"}'};
...
mappages["asharden1"].returnmap = 'darkunknown';
...
mappages["asharden2"].returnmap = 'darkunknown';
...
mappages["asharden3"].features[3] = {name : 'AlchemyLab', x : 27, y : 16};
mappages["asharden3"].features[4] = {name : 'AlchemyLab2', x : 28, y : 16};
mappages["asharden3"].features[5] = {name : 'AlchemyLabTop2', x : 28, y : 15};
mappages["asharden3"].features[6] = {name : 'AlchemyLabTop', x : 27, y : 15};
...
mappages["asharden3"].returnmap = 'darkunknown';
