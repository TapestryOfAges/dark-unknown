...
mappages["asharden2"].features[3] = {name : 'TorchEast', x : 29, y : 15};
mappages["asharden2"].features[4] = {name : 'BookshelfOne', x : 26, y : 18};
mappages["asharden2"].features[5] = {name : 'BedHead', x : 21, y : 20};
mappages["asharden2"].features[6] = {name : 'BedFoot', x : 22, y : 20};
mappages["asharden2"].features[7] = {name : 'RightChair', x : 26, y : 20};
mappages["asharden2"].features[8] = {name : 'Mirror', x : 21, y : 18};
mappages["asharden2"].features[9] = {name : 'Dresser', x : 22, y : 18};
