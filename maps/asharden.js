...
mappages["asharden1"].terrain[17] = '^^ ^^ ^^ ^^ nn nn ., ., ^^ nn nn nn nn ## +f +f +f +f +f +f ## +f +f +f +f +f +f +f +f +f ## +f +f +f +f ## nn nn nn nn ^^ ^^ ., nn nn ^^ ^^ ^^';
...
mappages["asharden1"].terrain[20] = '^^ ^^ ^^ ^^ nn ., ., ^^ ^^ ^^ ,, nn nn ## ## ## ## ## ## ## ## +f +f +f +f +f +f +f +f +f ## ## ## ## ## ## nn nn nn nn ^^ ., ., nn nn ^^ ^^ ^^';
