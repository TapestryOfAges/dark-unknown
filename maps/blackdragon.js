...
mappages["blackdragon"].features[134] = {name : 'BlueCarpetNW', x : 25, y : 14};
mappages["blackdragon"].features[135] = {name : 'BlueCarpetN', x : 26, y : 14};
mappages["blackdragon"].features[136] = {name : 'BlueCarpetNE', x : 27, y : 14};
mappages["blackdragon"].features[137] = {name : 'BlueCarpetNE', x : 27, y : 14};
mappages["blackdragon"].features[138] = {name : 'BlueCarpetW', x : 25, y : 15};
mappages["blackdragon"].features[139] = {name : 'BlueCarpetC', x : 26, y : 15};
mappages["blackdragon"].features[140] = {name : 'BlueCarpetE', x : 27, y : 15};
mappages["blackdragon"].features[141] = {name : 'BlueCarpetSW', x : 25, y : 16};
mappages["blackdragon"].features[142] = {name : 'BlueCarpetS', x : 26, y : 16};
mappages["blackdragon"].features[143] = {name : 'BlueCarpetSE', x : 27, y : 16};
mappages["blackdragon"].features[144] = {name : 'BedHead', x : 25, y : 17};
mappages["blackdragon"].features[145] = {name : 'BedFoot', x : 26, y : 17};
mappages["blackdragon"].features[146] = {name : 'WallPortcullis', x : 12, y : 38, locked : 1};
