...
mappages["blackdragon"].features[136] = {name : 'DoubleBedBottomHead', x : 21, y : 19};
mappages["blackdragon"].features[137] = {name : 'DoubleBedBottomFoot', x : 22, y : 19};
mappages["blackdragon"].features[138] = {name : 'DoubleBedTopFoot', x : 22, y : 18};
mappages["blackdragon"].features[139] = {name : 'DoubleBedTopHead', x : 21, y : 18};
...
mappages["blackdragon_int"].features[117] = {name : 'WallPortcullis', x : 12, y : 38, locked : 1};
...
mappages["blackdragon_int"].features[136] = {name : 'DoubleBedBottomHead', x : 21, y : 19};
mappages["blackdragon_int"].features[137] = {name : 'DoubleBedBottomFoot', x : 22, y : 19};
mappages["blackdragon_int"].features[138] = {name : 'DoubleBedTopFoot', x : 22, y : 18};
mappages["blackdragon_int"].features[139] = {name : 'DoubleBedTopHead', x : 21, y : 18};
...
mappages["blackdragon_int"].features[166] = {name : 'BlackDragonScale', x : 39, y : 15};


mappages["blackdragon_int"].npcs = [];
mappages["blackdragon_int"].npcs[0] = {name : 'TownGuardNPC', x : 10, y : 40, NPCName: 'Lumen', PeaceAI: 'townsfolk', Conversation: 'lumen_int', Gender: 'female', Bark: '0', NPCBand: '0', skintone: '2'};
mappages["blackdragon_int"].npcs[1] = {name : 'TownGuardNPC', x : 37, y : 17, NPCName: 'Bosku', PeaceAI: 'townsfolk', Conversation: 'bosku_int', Gender: 'male', NPCBand: '0', skintone: '1'};
mappages["blackdragon_int"].npcs[2] = {name : 'TownGuardNPC', x : 11, y : 35, NPCName: 'Dollin', PeaceAI: 'townsfolk', Conversation: 'dollin_int', Gender: 'female', Bark: '0', NPCBand: '0', skintone: '1'};
mappages["blackdragon_int"].npcs[3] = {name : 'TownGuardNPC', x : 41, y : 13, NPCName: 'Nessa', PeaceAI: 'townsfolk', Conversation: 'nessa_int', Gender: 'female', NPCBand: '0', skintone: '1'};
mappages["blackdragon_int"].npcs[4] = {name : 'TownGuardNPC', x : 13, y : 35, NPCName: 'Ronan', PeaceAI: 'townsfolk', Conversation: 'ronan_int', Gender: 'male', Bark: '0', NPCBand: '0', skintone: '2'};
mappages["blackdragon_int"].npcs[5] = {name : 'TownGuardNPC', x : 34, y : 12, NPCName: 'Lian', PeaceAI: 'townsfolk', Conversation: 'lian_int', Gender: 'male', NPCBand: '0', skintone: '2'};
mappages["blackdragon_int"].npcs[6] = {name : 'TownGuardNPC', x : 8, y : 34, NPCName: 'Carbry', PeaceAI: 'townsfolk', Conversation: 'carbry_int', Gender: 'male', Bark: '0', NPCBand: '0', skintone: '2'};
mappages["blackdragon_int"].npcs[7] = {name : 'TownGuardNPC', x : 24, y : 26, NPCName: 'Aelid', PeaceAI: 'townsfolk', Conversation: 'aelid_int', Gender: 'female', NPCBand: '0', skintone: '2'};
mappages["blackdragon_int"].npcs[8] = {name : 'TownGuardNPC', x : 8, y : 27, NPCName: 'Perick', PeaceAI: 'townsfolk', Conversation: 'perick_int', Gender: 'male', Bark: '0', NPCBand: '0', skintone: '2'};
mappages["blackdragon_int"].npcs[9] = {name : 'TownGuardNPC', x : 33, y : 18, NPCName: 'Oshin', PeaceAI: 'townsfolk', Conversation: 'oshin_int', Gender: 'male', NPCBand: '0', skintone: '1'};
mappages["blackdragon_int"].npcs[10] = {name : 'PrinceNPC', x : 25, y : 17, NPCName: 'Prince Lance', PeaceAI: 'townsfolk', Conversation: 'lance', Gender: 'male', Bark: '0', NPCBand: '0', skintone: '1'};
mappages["blackdragon_int"].npcs[11] = {name : 'TownGuardNPC', x : 34, y : 20, NPCName: 'Ranlyn', PeaceAI: 'townsfolk', Conversation: 'ranlyn_int', Gender: 'male', Bark: '0', NPCBand: '0', skintone: '2'};
mappages["blackdragon_int"].npcs[12] = {name : 'TownGuardNPC', x : 33, y : 16, NPCName: 'Sissott', PeaceAI: 'townsfolk', Conversation: 'sissott_int', Gender: 'female', Bark: '0', NPCBand: '0', skintone: '2'};
mappages["blackdragon_int"].npcs[13] = {name : 'TownGuardNPC', x : 38, y : 10, NPCName: 'Yuan', PeaceAI: 'townsfolk', Conversation: 'yuan_int', Gender: 'male', NPCBand: '0', skintone: '2'};
mappages["blackdragon_int"].npcs[14] = {name : 'TownGuardNPC', x : 38, y : 22, NPCName: 'Joney', PeaceAI: 'townsfolk', Conversation: 'joney_int', Gender: 'female', NPCBand: '0', skintone: '1'};
mappages["blackdragon_int"].npcs[15] = {name : 'TownsfolkVillagerNPC', x : 36, y : 15, NPCName: 'Taran', PeaceAI: 'townsfolk', Conversation: 'taran_int', ConversationFlag: 'taran', Gender: 'male', Bark: '0', NPCBand: '0', OverrideGraphic: 'civ_red.gif', skintone: '1'};
mappages["blackdragon_int"].npcs[16] = {name : 'TownsfolkVillagerNPC', x : 39, y : 16, NPCName: 'Brad', PeaceAI: 'townsfolk', Conversation: 'brad_int', Gender: 'male', NPCBand: '0', OverrideGraphic: '310.gif', skintone: '1'};
mappages["blackdragon_int"].npcs[17] = {name : 'FighterVillagerNPC', x : 38, y : 13, NPCName: 'Nadya', PeaceAI: 'townsfolk', Conversation: 'nadya_int', Gender: 'female', NPCBand: '0', OverrideGraphic: 'fighter-offcolor.gif', skintone: '2'};
mappages["blackdragon_int"].npcs[18] = {name : 'MageVillagerNPC', x : 36, y : 12, NPCName: 'Justice', PeaceAI: 'townsfolk', PCThreatAI: 'RunAway', Conversation: 'justice_int', ConversationFlag: 'justice', Gender: 'female', Bark: '0', NPCBand: '0', OverrideGraphic: '303.gif', skintone: '1'};
