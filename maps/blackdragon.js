...
mappages["blackdragon"].features[1] = {name : 'Door', x : 22, y : 29, desc : "locked door", locked : 1, keyname : "SilvergladeKey", inside : "S"};
...
mappages["blackdragon"].features[16] = {name : 'Door', x : 17, y : 25, inside : "N"};
mappages["blackdragon"].features[17] = {name : 'Door', x : 18, y : 23, desc : "locked door", locked : 1, keyname : "SilvergladeKey", inside : "E"};
mappages["blackdragon"].features[18] = {name : 'Door', x : 16, y : 23, desc : "locked door", locked : 1, keyname : "SilvergladeKey", inside : "W"};
mappages["blackdragon"].features[19] = {name : 'Door', x : 16, y : 18, desc : "locked door", locked : 1, keyname : "SilvergladeKey", inside : "W"};
mappages["blackdragon"].features[20] = {name : 'Door', x : 18, y : 18, desc : "locked door", locked : 1, keyname : "SilvergladeKey", inside : "E"};
...
mappages["blackdragon"].features[36] = {name : 'DoorWindow', x : 17, y : 16, locked : 0, inside : "S"};
mappages["blackdragon"].features[37] = {name : 'DoorWindow', x : 30, y : 29, inside : "S"};
...
mappages["blackdragon"].features[66] = {name : 'DoorWindow', x : 36, y : 29, inside : "N"};
mappages["blackdragon"].features[67] = {name : 'LeftTable', x : 34, y : 26};
mappages["blackdragon"].features[68] = {name : 'RightTable', x : 35, y : 26};
mappages["blackdragon"].features[69] = {name : 'Door', x : 29, y : 23, inside : "W"};
mappages["blackdragon"].features[70] = {name : 'Door', x : 11, y : 28, desc : "locked door", locked : 1, keyname : "SilvergladeKey", inside : "W"};
mappages["blackdragon"].features[71] = {name : 'BDThrone', x : 37, y : 11};
mappages["blackdragon"].features[72] = {name : 'Door', x : 32, y : 17, desc : "magically locked door", locked : 2, keyname : "SilvergladeKey", inside : "W"};
...
mappages["blackdragon"].features[89] = {name : 'Door', x : 29, y : 13, desc : "magically locked door", locked : 2, keyname : "SilvergladeKey", inside : "N"};
...
mappages["blackdragon"].features[104] = {name : 'SmallBox', x : 20, y : 33};
mappages["blackdragon"].features[105] = {name : 'SmallBox', x : 25, y : 33};
mappages["blackdragon"].features[106] = {name : 'SmallBox', x : 25, y : 37};
mappages["blackdragon"].features[107] = {name : 'Chest', x : 17, y : 30};
mappages["blackdragon"].features[108] = {name : 'Chest', x : 16, y : 30};
mappages["blackdragon"].features[109] = {name : 'Chest', x : 16, y : 31};
mappages["blackdragon"].features[110] = {name : 'Chest', x : 16, y : 36};
mappages["blackdragon"].features[111] = {name : 'Chest', x : 16, y : 37};
mappages["blackdragon"].features[112] = {name : 'Chest', x : 17, y : 37};
mappages["blackdragon"].features[113] = {name : 'BedHead', x : 25, y : 17};
mappages["blackdragon"].features[114] = {name : 'BedFoot', x : 26, y : 17};
mappages["blackdragon"].features[115] = {name : 'WallPortcullis', x : 12, y : 38, locked : 1};
mappages["blackdragon"].features[116] = {name : 'BedHead', x : 24, y : 30};
mappages["blackdragon"].features[117] = {name : 'BedFoot', x : 25, y : 30};
mappages["blackdragon"].features[118] = {name : 'SmallBox', x : 23, y : 30};
mappages["blackdragon"].features[119] = {name : 'StairUp', x : 25, y : 20, entermap : 'blackdragon2', enterx : 25, entery : 20};
mappages["blackdragon"].features[120] = {name : 'Tree', x : 11, y : 14};
mappages["blackdragon"].features[121] = {name : 'Tree', x : 11, y : 15};
mappages["blackdragon"].features[122] = {name : 'Tree', x : 12, y : 15};
mappages["blackdragon"].features[123] = {name : 'Tree', x : 13, y : 15};
mappages["blackdragon"].features[124] = {name : 'Tree', x : 11, y : 9};
mappages["blackdragon"].features[125] = {name : 'AppleTree', x : 12, y : 14};
mappages["blackdragon"].features[126] = {name : 'AppleTree', x : 11, y : 13};
mappages["blackdragon"].features[127] = {name : 'AppleTree', x : 19, y : 12};
mappages["blackdragon"].features[128] = {name : 'AppleTree', x : 17, y : 7};
mappages["blackdragon"].features[129] = {name : 'Tree', x : 7, y : 11};
mappages["blackdragon"].features[130] = {name : 'Tree', x : 8, y : 6};
mappages["blackdragon"].features[131] = {name : 'Tree', x : 39, y : 6};
mappages["blackdragon"].features[132] = {name : 'Tree', x : 39, y : 26};
mappages["blackdragon"].features[133] = {name : 'Tree', x : 38, y : 39};
mappages["blackdragon"].features[134] = {name : 'PileOfRocks', x : 21, y : 15};
mappages["blackdragon"].features[135] = {name : 'PileOfRocks', x : 21, y : 14};
mappages["blackdragon"].features[136] = {name : 'PileOfRocks', x : 21, y : 13};
mappages["blackdragon"].features[137] = {name : 'PileOfRocks', x : 21, y : 12};
mappages["blackdragon"].features[138] = {name : 'PileOfRocks', x : 21, y : 11};
mappages["blackdragon"].features[139] = {name : 'PileOfRocks', x : 21, y : 10};
mappages["blackdragon"].features[140] = {name : 'PileOfRocks', x : 21, y : 9};
mappages["blackdragon"].features[141] = {name : 'PileOfRocks', x : 21, y : 8};
mappages["blackdragon"].features[142] = {name : 'PileOfRocks', x : 21, y : 7};
mappages["blackdragon"].features[143] = {name : 'PileOfRocks', x : 20, y : 6};
mappages["blackdragon"].features[144] = {name : 'PileOfRocks', x : 19, y : 6};
mappages["blackdragon"].features[145] = {name : 'PileOfRocks', x : 18, y : 6};
mappages["blackdragon"].features[146] = {name : 'PileOfRocks', x : 17, y : 6};
mappages["blackdragon"].features[147] = {name : 'PileOfRocks', x : 16, y : 6};
mappages["blackdragon"].features[148] = {name : 'PileOfRocks', x : 15, y : 6};
mappages["blackdragon"].features[149] = {name : 'PileOfRocks', x : 14, y : 6};
mappages["blackdragon"].features[150] = {name : 'PileOfRocks', x : 13, y : 6};
mappages["blackdragon"].features[151] = {name : 'PileOfRocks', x : 12, y : 6};
mappages["blackdragon"].features[152] = {name : 'PileOfRocks', x : 11, y : 7};
mappages["blackdragon"].features[153] = {name : 'PileOfRocks', x : 10, y : 8};
mappages["blackdragon"].features[154] = {name : 'PileOfRocks', x : 10, y : 9};
mappages["blackdragon"].features[155] = {name : 'PileOfRocks', x : 10, y : 10};
mappages["blackdragon"].features[156] = {name : 'PileOfRocks', x : 10, y : 11};
mappages["blackdragon"].features[157] = {name : 'PileOfRocks', x : 10, y : 12};
mappages["blackdragon"].features[158] = {name : 'PileOfRocks', x : 10, y : 13};
mappages["blackdragon"].features[159] = {name : 'PileOfRocks', x : 10, y : 14};
mappages["blackdragon"].features[160] = {name : 'PileOfRocks', x : 10, y : 15};
mappages["blackdragon"].features[161] = {name : 'PileOfRocks', x : 8, y : 36};
mappages["blackdragon"].features[162] = {name : 'FringeCarpetNW', x : 25, y : 14};
mappages["blackdragon"].features[163] = {name : 'FringeCarpetN', x : 26, y : 14};
mappages["blackdragon"].features[164] = {name : 'FringeCarpetNE', x : 27, y : 14};
mappages["blackdragon"].features[165] = {name : 'FringeCarpetW', x : 25, y : 15};
mappages["blackdragon"].features[166] = {name : 'FringeCarpetC', x : 26, y : 15};
mappages["blackdragon"].features[167] = {name : 'FringeCarpetE', x : 27, y : 15};
mappages["blackdragon"].features[168] = {name : 'FringeCarpetSE', x : 27, y : 16};
mappages["blackdragon"].features[169] = {name : 'FringeCarpetS', x : 26, y : 16};
mappages["blackdragon"].features[170] = {name : 'FringeCarpetSW', x : 25, y : 16};
mappages["blackdragon"].features[171] = {name : 'MarblePillar', x : 13, y : 36};
mappages["blackdragon"].features[172] = {name : 'MarblePillar', x : 13, y : 34};
mappages["blackdragon"].features[173] = {name : 'MarblePillar', x : 13, y : 32};
mappages["blackdragon"].features[174] = {name : 'MarblePillar', x : 13, y : 30};
mappages["blackdragon"].features[175] = {name : 'MarblePillar', x : 11, y : 30};
mappages["blackdragon"].features[176] = {name : 'MarblePillar', x : 11, y : 32};
mappages["blackdragon"].features[177] = {name : 'MarblePillar', x : 11, y : 34};
mappages["blackdragon"].features[178] = {name : 'MarblePillar', x : 11, y : 36};
mappages["blackdragon"].features[179] = {name : 'MarblePillar', x : 35, y : 17};
mappages["blackdragon"].features[180] = {name : 'MarblePillar', x : 35, y : 14};
mappages["blackdragon"].features[181] = {name : 'MarblePillar', x : 35, y : 11};
mappages["blackdragon"].features[182] = {name : 'MarblePillar', x : 39, y : 11};
mappages["blackdragon"].features[183] = {name : 'MarblePillar', x : 39, y : 14};
mappages["blackdragon"].features[184] = {name : 'MarblePillar', x : 39, y : 17};
mappages["blackdragon"].features[185] = {name : 'DoubleBedHead', x : 21, y : 19};
mappages["blackdragon"].features[186] = {name : 'DoubleBedFoot', x : 22, y : 19};
mappages["blackdragon"].features[187] = {name : 'Drawbridge', x : 11, y : 40};
mappages["blackdragon"].features[188] = {name : 'Drawbridge', x : 12, y : 40};
mappages["blackdragon"].features[189] = {name : 'Drawbridge', x : 13, y : 40};
mappages["blackdragon"].features[190] = {name : 'Drawbridge', x : 11, y : 43};
mappages["blackdragon"].features[191] = {name : 'Drawbridge', x : 12, y : 43};
mappages["blackdragon"].features[192] = {name : 'Drawbridge', x : 13, y : 43};
mappages["blackdragon"].features[193] = {name : 'Drawbridge', x : 12, y : 39};
mappages["blackdragon"].features[194] = {name : 'Drawbridge', x : 13, y : 39};
mappages["blackdragon"].features[195] = {name : 'Drawbridge', x : 11, y : 39};
mappages["blackdragon"].features[196] = {name : 'BDCLever', x : 11, y : 39};
mappages["blackdragon"].features[197] = {name : 'Drawbridge', x : 11, y : 40};
mappages["blackdragon"].features[198] = {name : 'Drawbridge', x : 12, y : 40};
mappages["blackdragon"].features[199] = {name : 'Drawbridge', x : 13, y : 40};
mappages["blackdragon"].features[200] = {name : 'Drawbridge', x : 11, y : 43};
mappages["blackdragon"].features[201] = {name : 'Drawbridge', x : 12, y : 43};
mappages["blackdragon"].features[202] = {name : 'Drawbridge', x : 13, y : 43};
mappages["blackdragon"].features[203] = {name : 'Brazier', x : 20, y : 30};
mappages["blackdragon"].features[204] = {name : 'Fireplace', x : 11, y : 17};
mappages["blackdragon"].features[205] = {name : 'Fireplace', x : 11, y : 23};
mappages["blackdragon"].features[206] = {name : 'Fireplace', x : 23, y : 17};
mappages["blackdragon"].features[207] = {name : 'Fireplace', x : 23, y : 22};
mappages["blackdragon"].features[208] = {name : 'Fireplace', x : 26, y : 31};
mappages["blackdragon"].features[209] = {name : 'Fireplace', x : 27, y : 33};
mappages["blackdragon"].features[210] = {name : 'Spit', x : 37, y : 30};
mappages["blackdragon"].features[211] = {name : 'Brazier', x : 37, y : 35};
mappages["blackdragon"].features[212] = {name : 'Fireplace', x : 36, y : 24};
mappages["blackdragon"].features[213] = {name : 'Fireplace', x : 34, y : 24};
mappages["blackdragon"].features[214] = {name : 'Spit', x : 34, y : 28};
mappages["blackdragon"].features[215] = {name : 'Brazier', x : 31, y : 12};
mappages["blackdragon"].features[216] = {name : 'Fireplace', x : 24, y : 15};
mappages["blackdragon"].features[217] = {name : 'TorchWest', x : 33, y : 12};
mappages["blackdragon"].features[218] = {name : 'TorchWest', x : 33, y : 15};
mappages["blackdragon"].features[219] = {name : 'TorchEast', x : 41, y : 12};
mappages["blackdragon"].features[220] = {name : 'TorchEast', x : 41, y : 15};
mappages["blackdragon"].features[221] = {name : 'TorchWest', x : 10, y : 31};
mappages["blackdragon"].features[222] = {name : 'TorchWest', x : 10, y : 34};
mappages["blackdragon"].features[223] = {name : 'TorchEast', x : 14, y : 31};
mappages["blackdragon"].features[224] = {name : 'TorchEast', x : 14, y : 34};
mappages["blackdragon"].features[225] = {name : 'TorchWest', x : 12, y : 26};
mappages["blackdragon"].features[226] = {name : 'Brazier', x : 40, y : 10};
mappages["blackdragon"].features[227] = {name : 'Brazier', x : 34, y : 10};
mappages["blackdragon"].features[228] = {name : 'TorchWest', x : 30, y : 20};
...
mappages["blackdragon"].transover = '{"18,7":[["","",null,null],["static.gif","spacer.gif",-192,0],["TerrainBlend.gif","spacer.gif",-128,-576]],"18,8":[["","",null,null],["static.gif","spacer.gif",-192,0],["TerrainBlend.gif","spacer.gif",-192,-576]],"19,7":[["","",null,null],["static.gif","spacer.gif",-192,0],["TerrainBlend.gif","spacer.gif",0,-576]],"19,8":[["","",null,null],["static.gif","spacer.gif",-192,0],["TerrainBlend.gif","spacer.gif",-32,-576]],"20,7":[["","",null,null],["static.gif","spacer.gif",-192,0],["TerrainBlend.gif","spacer.gif",-160,-576]],"20,8":[["","",null,null],["static.gif","spacer.gif",-192,0],["TerrainBlend.gif","spacer.gif",-224,-576]]}';
...
mappages["blackdragon"].returnmap = 'ellusus';
...
mappages["blackdragon2"].returnmap = 'ellusus';
...
mappages["blackdragon3"].npcs[0] = {name : 'ArchmageVillagerNPC', x : 26, y : 20, NPCName: 'Justice', PeaceAI: 'scheduled', PCThreatAI: 'RunAway', Schedule: 'justice', Conversation: 'justice', ConversationFlag: 'justice', Gender: 'female', Bark: '0', NPCBand: '0', skintone: 1, wornlayers: '{"body":"BlueRobe","head":"ShortBlackPale","back":"","offhand":"OffhandPale","cloak":"","mainhand":"QuarterstaffPale","realhead":"ShortBlackPale"}'};
...
mappages["blackdragon3"].returnmap = 'ellusus';
...
mappages["blackdragon4"].returnmap = 'ellusus';
...
mappages["blackdragon_int"].features[1] = {name : 'Door', x : 22, y : 29, desc : "locked door", locked : 1, keyname : "SilvergladeKey", inside : "S"};
...
mappages["blackdragon_int"].features[16] = {name : 'Door', x : 17, y : 25, inside : "N"};
mappages["blackdragon_int"].features[17] = {name : 'Door', x : 18, y : 23, desc : "locked door", locked : 1, keyname : "SilvergladeKey", inside : "E"};
mappages["blackdragon_int"].features[18] = {name : 'Door', x : 16, y : 23, desc : "locked door", locked : 1, keyname : "SilvergladeKey", inside : "W"};
mappages["blackdragon_int"].features[19] = {name : 'Door', x : 16, y : 18, desc : "locked door", locked : 1, keyname : "SilvergladeKey", inside : "W"};
mappages["blackdragon_int"].features[20] = {name : 'Door', x : 18, y : 18, desc : "locked door", locked : 1, keyname : "SilvergladeKey", inside : "E"};
...
mappages["blackdragon_int"].features[36] = {name : 'DoorWindow', x : 17, y : 16, locked : 0, inside : "S"};
mappages["blackdragon_int"].features[37] = {name : 'DoorWindow', x : 30, y : 29, inside : "S"};
...
mappages["blackdragon_int"].features[66] = {name : 'DoorWindow', x : 36, y : 29, inside : "N"};
...
mappages["blackdragon_int"].features[69] = {name : 'Door', x : 29, y : 23, inside : "W"};
mappages["blackdragon_int"].features[70] = {name : 'Door', x : 11, y : 28, desc : "locked door", locked : 1, inside : "W"};
mappages["blackdragon_int"].features[71] = {name : 'BDThrone', x : 37, y : 11};
mappages["blackdragon_int"].features[72] = {name : 'Door', x : 32, y : 17, inside : "W"};
...
mappages["blackdragon_int"].features[89] = {name : 'Door', x : 29, y : 13, desc : "magically locked door", locked : 2, keyname : "SilvergladeKey", inside : "N"};
...
mappages["blackdragon_int"].features[104] = {name : 'SmallBox', x : 20, y : 33};
mappages["blackdragon_int"].features[105] = {name : 'SmallBox', x : 25, y : 33};
mappages["blackdragon_int"].features[106] = {name : 'SmallBox', x : 25, y : 37};
mappages["blackdragon_int"].features[107] = {name : 'Chest', x : 17, y : 30};
mappages["blackdragon_int"].features[108] = {name : 'Chest', x : 16, y : 30};
mappages["blackdragon_int"].features[109] = {name : 'Chest', x : 16, y : 31};
mappages["blackdragon_int"].features[110] = {name : 'Chest', x : 16, y : 36};
mappages["blackdragon_int"].features[111] = {name : 'Chest', x : 16, y : 37};
mappages["blackdragon_int"].features[112] = {name : 'Chest', x : 17, y : 37};
mappages["blackdragon_int"].features[113] = {name : 'BedHead', x : 25, y : 17};
mappages["blackdragon_int"].features[114] = {name : 'BedFoot', x : 26, y : 17};
mappages["blackdragon_int"].features[115] = {name : 'WallPortcullis', x : 12, y : 38, locked : 0};
mappages["blackdragon_int"].features[116] = {name : 'BedHead', x : 24, y : 30};
mappages["blackdragon_int"].features[117] = {name : 'BedFoot', x : 25, y : 30};
mappages["blackdragon_int"].features[118] = {name : 'SmallBox', x : 23, y : 30};
mappages["blackdragon_int"].features[119] = {name : 'StairUp', x : 25, y : 20, entermap : 'blackdragon_int2', enterx : 25, entery : 20};
mappages["blackdragon_int"].features[120] = {name : 'Tree', x : 11, y : 14};
mappages["blackdragon_int"].features[121] = {name : 'Tree', x : 11, y : 15};
mappages["blackdragon_int"].features[122] = {name : 'Tree', x : 12, y : 15};
mappages["blackdragon_int"].features[123] = {name : 'Tree', x : 13, y : 15};
mappages["blackdragon_int"].features[124] = {name : 'Tree', x : 11, y : 9};
mappages["blackdragon_int"].features[125] = {name : 'AppleTree', x : 12, y : 14};
mappages["blackdragon_int"].features[126] = {name : 'AppleTree', x : 11, y : 13};
mappages["blackdragon_int"].features[127] = {name : 'AppleTree', x : 19, y : 12};
mappages["blackdragon_int"].features[128] = {name : 'AppleTree', x : 17, y : 7};
mappages["blackdragon_int"].features[129] = {name : 'Tree', x : 7, y : 11};
mappages["blackdragon_int"].features[130] = {name : 'Tree', x : 8, y : 6};
mappages["blackdragon_int"].features[131] = {name : 'Tree', x : 39, y : 6};
mappages["blackdragon_int"].features[132] = {name : 'Tree', x : 39, y : 26};
mappages["blackdragon_int"].features[133] = {name : 'Tree', x : 38, y : 39};
mappages["blackdragon_int"].features[134] = {name : 'BlackDragonScale', x : 39, y : 15};
mappages["blackdragon_int"].features[135] = {name : 'PileOfRocks', x : 21, y : 15};
mappages["blackdragon_int"].features[136] = {name : 'PileOfRocks', x : 21, y : 14};
mappages["blackdragon_int"].features[137] = {name : 'PileOfRocks', x : 21, y : 13};
mappages["blackdragon_int"].features[138] = {name : 'PileOfRocks', x : 21, y : 12};
mappages["blackdragon_int"].features[139] = {name : 'PileOfRocks', x : 21, y : 11};
mappages["blackdragon_int"].features[140] = {name : 'PileOfRocks', x : 21, y : 10};
mappages["blackdragon_int"].features[141] = {name : 'PileOfRocks', x : 21, y : 9};
mappages["blackdragon_int"].features[142] = {name : 'PileOfRocks', x : 21, y : 8};
mappages["blackdragon_int"].features[143] = {name : 'PileOfRocks', x : 21, y : 7};
mappages["blackdragon_int"].features[144] = {name : 'PileOfRocks', x : 20, y : 6};
mappages["blackdragon_int"].features[145] = {name : 'PileOfRocks', x : 19, y : 6};
mappages["blackdragon_int"].features[146] = {name : 'PileOfRocks', x : 18, y : 6};
mappages["blackdragon_int"].features[147] = {name : 'PileOfRocks', x : 17, y : 6};
mappages["blackdragon_int"].features[148] = {name : 'PileOfRocks', x : 16, y : 6};
mappages["blackdragon_int"].features[149] = {name : 'PileOfRocks', x : 15, y : 6};
mappages["blackdragon_int"].features[150] = {name : 'PileOfRocks', x : 14, y : 6};
mappages["blackdragon_int"].features[151] = {name : 'PileOfRocks', x : 13, y : 6};
mappages["blackdragon_int"].features[152] = {name : 'PileOfRocks', x : 12, y : 6};
mappages["blackdragon_int"].features[153] = {name : 'PileOfRocks', x : 11, y : 7};
mappages["blackdragon_int"].features[154] = {name : 'PileOfRocks', x : 10, y : 8};
mappages["blackdragon_int"].features[155] = {name : 'PileOfRocks', x : 10, y : 9};
mappages["blackdragon_int"].features[156] = {name : 'PileOfRocks', x : 10, y : 10};
mappages["blackdragon_int"].features[157] = {name : 'PileOfRocks', x : 10, y : 11};
mappages["blackdragon_int"].features[158] = {name : 'PileOfRocks', x : 10, y : 12};
mappages["blackdragon_int"].features[159] = {name : 'PileOfRocks', x : 10, y : 13};
mappages["blackdragon_int"].features[160] = {name : 'PileOfRocks', x : 10, y : 14};
mappages["blackdragon_int"].features[161] = {name : 'PileOfRocks', x : 10, y : 15};
mappages["blackdragon_int"].features[162] = {name : 'PileOfRocks', x : 8, y : 36};
mappages["blackdragon_int"].features[163] = {name : 'FringeCarpetNW', x : 25, y : 14};
mappages["blackdragon_int"].features[164] = {name : 'FringeCarpetN', x : 26, y : 14};
mappages["blackdragon_int"].features[165] = {name : 'FringeCarpetNE', x : 27, y : 14};
mappages["blackdragon_int"].features[166] = {name : 'FringeCarpetC', x : 26, y : 15};
mappages["blackdragon_int"].features[167] = {name : 'FringeCarpetW', x : 25, y : 15};
mappages["blackdragon_int"].features[168] = {name : 'FringeCarpetE', x : 27, y : 15};
mappages["blackdragon_int"].features[169] = {name : 'FringeCarpetSW', x : 25, y : 16};
mappages["blackdragon_int"].features[170] = {name : 'FringeCarpetS', x : 26, y : 16};
mappages["blackdragon_int"].features[171] = {name : 'FringeCarpetSE', x : 27, y : 16};
mappages["blackdragon_int"].features[172] = {name : 'MarblePillar', x : 35, y : 11};
mappages["blackdragon_int"].features[173] = {name : 'MarblePillar', x : 39, y : 11};
mappages["blackdragon_int"].features[174] = {name : 'MarblePillar', x : 39, y : 14};
mappages["blackdragon_int"].features[175] = {name : 'MarblePillar', x : 39, y : 17};
mappages["blackdragon_int"].features[176] = {name : 'MarblePillar', x : 35, y : 14};
mappages["blackdragon_int"].features[177] = {name : 'MarblePillar', x : 35, y : 17};
mappages["blackdragon_int"].features[178] = {name : 'MarblePillar', x : 13, y : 36};
mappages["blackdragon_int"].features[179] = {name : 'MarblePillar', x : 11, y : 36};
mappages["blackdragon_int"].features[180] = {name : 'MarblePillar', x : 11, y : 34};
mappages["blackdragon_int"].features[181] = {name : 'MarblePillar', x : 11, y : 32};
mappages["blackdragon_int"].features[182] = {name : 'MarblePillar', x : 11, y : 30};
mappages["blackdragon_int"].features[183] = {name : 'MarblePillar', x : 13, y : 30};
mappages["blackdragon_int"].features[184] = {name : 'MarblePillar', x : 13, y : 32};
mappages["blackdragon_int"].features[185] = {name : 'MarblePillar', x : 13, y : 34};
mappages["blackdragon_int"].features[186] = {name : 'DoubleBedHead', x : 21, y : 19};
mappages["blackdragon_int"].features[187] = {name : 'DoubleBedFoot', x : 22, y : 19};
mappages["blackdragon_int"].features[188] = {name : 'Brazier', x : 20, y : 30};
mappages["blackdragon_int"].features[189] = {name : 'Fireplace', x : 11, y : 17};
mappages["blackdragon_int"].features[190] = {name : 'Fireplace', x : 11, y : 23};
mappages["blackdragon_int"].features[191] = {name : 'Fireplace', x : 23, y : 17};
mappages["blackdragon_int"].features[192] = {name : 'Fireplace', x : 23, y : 22};
mappages["blackdragon_int"].features[193] = {name : 'Fireplace', x : 26, y : 31};
mappages["blackdragon_int"].features[194] = {name : 'Fireplace', x : 27, y : 33};
mappages["blackdragon_int"].features[195] = {name : 'Spit', x : 37, y : 30};
mappages["blackdragon_int"].features[196] = {name : 'Brazier', x : 37, y : 35};
mappages["blackdragon_int"].features[197] = {name : 'Fireplace', x : 36, y : 24};
mappages["blackdragon_int"].features[198] = {name : 'Fireplace', x : 34, y : 24};
mappages["blackdragon_int"].features[199] = {name : 'Spit', x : 34, y : 28};
mappages["blackdragon_int"].features[200] = {name : 'Brazier', x : 31, y : 12};
mappages["blackdragon_int"].features[201] = {name : 'Fireplace', x : 24, y : 15};
mappages["blackdragon_int"].features[202] = {name : 'TorchWest', x : 33, y : 12};
mappages["blackdragon_int"].features[203] = {name : 'TorchWest', x : 33, y : 15};
mappages["blackdragon_int"].features[204] = {name : 'TorchEast', x : 41, y : 12};
mappages["blackdragon_int"].features[205] = {name : 'TorchEast', x : 41, y : 15};
mappages["blackdragon_int"].features[206] = {name : 'TorchWest', x : 10, y : 31};
mappages["blackdragon_int"].features[207] = {name : 'TorchWest', x : 10, y : 34};
mappages["blackdragon_int"].features[208] = {name : 'TorchEast', x : 14, y : 31};
mappages["blackdragon_int"].features[209] = {name : 'TorchEast', x : 14, y : 34};
mappages["blackdragon_int"].features[210] = {name : 'TorchWest', x : 12, y : 26};
mappages["blackdragon_int"].features[211] = {name : 'Brazier', x : 40, y : 10};
mappages["blackdragon_int"].features[212] = {name : 'Brazier', x : 34, y : 10};
mappages["blackdragon_int"].features[213] = {name : 'TorchWest', x : 30, y : 20};
...
mappages["blackdragon_int"].npcs[18] = {name : 'ArchmageVillagerNPC', x : 36, y : 12, NPCName: 'Justice', PCThreatAI: 'RunAway', Conversation: 'justice_int', ConversationFlag: 'justice', Gender: 'female', Bark: '0', NPCBand: '0', skintone: 1, wornlayers: '{"body":"BlueRobe","head":"ShortBlackPale","back":"","offhand":"OffhandPale","cloak":"","mainhand":"QuarterstaffPale","realhead":"ShortBlackPale"}'};

mappages["blackdragon_int"].transover = '{"18,7":[["","",null,null],["static.gif","spacer.gif",-192,0],["TerrainBlend.gif","spacer.gif",-128,-576]],"18,8":[["","",null,null],["static.gif","spacer.gif",-192,0],["TerrainBlend.gif","spacer.gif",-192,-576]],"19,7":[["","",null,null],["static.gif","spacer.gif",-192,0],["TerrainBlend.gif","spacer.gif",0,-576]],"19,8":[["","",null,null],["static.gif","spacer.gif",-192,0],["TerrainBlend.gif","spacer.gif",-32,-576]],"20,7":[["","",null,null],["static.gif","spacer.gif",-192,0],["TerrainBlend.gif","spacer.gif",-160,-576]],"20,8":[["","",null,null],["static.gif","spacer.gif",-192,0],["TerrainBlend.gif","spacer.gif",-224,-576]]}';
...
mappages["blackdragon_int2"].returnmap = 'ellusus';
...
mappages["blackdragon_int3"].returnmap = 'ellusus';
...
mappages["blackdragon_int4"].returnmap = 'ellusus';
...
mappages["bdcave"].exitmap = 'ellusus';
...
mappages["bdcave"].returnmap = 'ellusus';
...
mappages["justice_battle"].features[2] = {name : 'EnergyField', x : 8, y : 2};
mappages["justice_battle"].features[3] = {name : 'EnergyField', x : 8, y : 3};
mappages["justice_battle"].features[4] = {name : 'EnergyField', x : 9, y : 3};
mappages["justice_battle"].features[5] = {name : 'EnergyField', x : 9, y : 4};
mappages["justice_battle"].features[6] = {name : 'EnergyField', x : 10, y : 4};
mappages["justice_battle"].features[7] = {name : 'EnergyField', x : 10, y : 5};
mappages["justice_battle"].features[8] = {name : 'EnergyField', x : 11, y : 5};
mappages["justice_battle"].features[9] = {name : 'EnergyField', x : 11, y : 6};
mappages["justice_battle"].features[10] = {name : 'EnergyField', x : 12, y : 6};
mappages["justice_battle"].features[11] = {name : 'EnergyField', x : 12, y : 7};
mappages["justice_battle"].features[12] = {name : 'EnergyField', x : 12, y : 8};
mappages["justice_battle"].features[13] = {name : 'EnergyField', x : 11, y : 8};
mappages["justice_battle"].features[14] = {name : 'EnergyField', x : 11, y : 9};
mappages["justice_battle"].features[15] = {name : 'EnergyField', x : 10, y : 9};
mappages["justice_battle"].features[16] = {name : 'EnergyField', x : 10, y : 10};
mappages["justice_battle"].features[17] = {name : 'EnergyField', x : 9, y : 10};
mappages["justice_battle"].features[18] = {name : 'EnergyField', x : 9, y : 11};
mappages["justice_battle"].features[19] = {name : 'EnergyField', x : 8, y : 11};
mappages["justice_battle"].features[20] = {name : 'EnergyField', x : 8, y : 12};
mappages["justice_battle"].features[21] = {name : 'EnergyField', x : 7, y : 12};
mappages["justice_battle"].features[22] = {name : 'EnergyField', x : 6, y : 12};
mappages["justice_battle"].features[23] = {name : 'EnergyField', x : 6, y : 11};
mappages["justice_battle"].features[24] = {name : 'EnergyField', x : 5, y : 11};
mappages["justice_battle"].features[25] = {name : 'EnergyField', x : 4, y : 10};
mappages["justice_battle"].features[26] = {name : 'EnergyField', x : 5, y : 10};
mappages["justice_battle"].features[27] = {name : 'EnergyField', x : 4, y : 9};
mappages["justice_battle"].features[28] = {name : 'EnergyField', x : 3, y : 9};
mappages["justice_battle"].features[29] = {name : 'EnergyField', x : 3, y : 8};
mappages["justice_battle"].features[30] = {name : 'EnergyField', x : 2, y : 8};
mappages["justice_battle"].features[31] = {name : 'EnergyField', x : 2, y : 7};
mappages["justice_battle"].features[32] = {name : 'EnergyField', x : 2, y : 6};
mappages["justice_battle"].features[33] = {name : 'EnergyField', x : 3, y : 6};
mappages["justice_battle"].features[34] = {name : 'EnergyField', x : 3, y : 5};
mappages["justice_battle"].features[35] = {name : 'EnergyField', x : 4, y : 5};
mappages["justice_battle"].features[36] = {name : 'EnergyField', x : 4, y : 4};
mappages["justice_battle"].features[37] = {name : 'EnergyField', x : 5, y : 4};
mappages["justice_battle"].features[38] = {name : 'EnergyField', x : 5, y : 3};
mappages["justice_battle"].features[39] = {name : 'EnergyField', x : 6, y : 3};
mappages["justice_battle"].features[40] = {name : 'FireField', x : 5, y : 5};
mappages["justice_battle"].features[41] = {name : 'FireField', x : 9, y : 5};
mappages["justice_battle"].features[42] = {name : 'FireField', x : 9, y : 9};
mappages["justice_battle"].features[43] = {name : 'FireField', x : 5, y : 9};
mappages["justice_battle"].features[44] = {name : 'BlueCrystal', x : 7, y : 3};
mappages["justice_battle"].features[45] = {name : 'BlueCrystal', x : 3, y : 7};
mappages["justice_battle"].features[46] = {name : 'BlueCrystal', x : 5, y : 7};
mappages["justice_battle"].features[47] = {name : 'BlueCrystal', x : 6, y : 7};
mappages["justice_battle"].features[48] = {name : 'BlueCrystal', x : 7, y : 7};
mappages["justice_battle"].features[49] = {name : 'BlueCrystal', x : 7, y : 6};
mappages["justice_battle"].features[50] = {name : 'BlueCrystal', x : 7, y : 8};
mappages["justice_battle"].features[51] = {name : 'BlueCrystal', x : 8, y : 7};
mappages["justice_battle"].features[52] = {name : 'BlueCrystal', x : 9, y : 7};
mappages["justice_battle"].features[53] = {name : 'BlueCrystal', x : 11, y : 7};
mappages["justice_battle"].features[54] = {name : 'BlueCrystal', x : 7, y : 11};
...
mappages["justice_battle"].returnmap = '';
