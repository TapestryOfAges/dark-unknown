...
mappages["poverty"].features[3] = {name : 'HealerSign', x : 25, y : 19, prefix : "a", desc : "sign: Healing Here"};
mappages["poverty"].features[4] = {name : 'SingleSignpost', x : 25, y : 20};
mappages["poverty"].features[5] = {name : 'BedHead', x : 21, y : 13};
mappages["poverty"].features[6] = {name : 'BedFoot', x : 22, y : 13};
mappages["poverty"].features[7] = {name : 'BookshelfLeft', x : 24, y : 12};
mappages["poverty"].features[8] = {name : 'BookshelfRight', x : 25, y : 12};
mappages["poverty"].features[9] = {name : 'BookshelfOne', x : 27, y : 12};
mappages["poverty"].features[10] = {name : 'BedHead', x : 21, y : 16};
mappages["poverty"].features[11] = {name : 'BedFoot', x : 22, y : 16};
mappages["poverty"].features[12] = {name : 'LeftTable', x : 25, y : 14};
mappages["poverty"].features[13] = {name : 'MiddleTable', x : 26, y : 14};
mappages["poverty"].features[14] = {name : 'RightTable', x : 27, y : 14};
mappages["poverty"].features[15] = {name : 'LeftChair', x : 27, y : 15};
mappages["poverty"].features[16] = {name : 'SleepField', x : 27, y : 17};
mappages["poverty"].features[17] = {name : 'UnlitBrazier', x : 21, y : 14};
mappages["poverty"].features[18] = {name : 'UnlitBrazier', x : 21, y : 17};
mappages["poverty"].features[19] = {name : 'Fireplace', x : 32, y : 26};
mappages["poverty"].features[20] = {name : 'BedHead', x : 30, y : 29};
mappages["poverty"].features[21] = {name : 'BedHead', x : 30, y : 27};
mappages["poverty"].features[22] = {name : 'BedHead', x : 30, y : 25};
mappages["poverty"].features[23] = {name : 'BedFoot', x : 31, y : 25};
mappages["poverty"].features[24] = {name : 'BedFoot', x : 31, y : 27};
mappages["poverty"].features[25] = {name : 'BedFoot', x : 31, y : 29};
mappages["poverty"].features[26] = {name : 'TrainingDummy', x : 30, y : 22};
