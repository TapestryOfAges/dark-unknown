...
mappages["poverty"].features[26] = {name : 'PileOfRocks', x : 18, y : 11};
mappages["poverty"].features[27] = {name : 'PileOfRocks', x : 16, y : 10};
mappages["poverty"].features[28] = {name : 'PileOfRocks', x : 15, y : 8};
mappages["poverty"].features[29] = {name : 'PileOfRocks', x : 20, y : 10};
mappages["poverty"].features[30] = {name : 'PileOfRocks', x : 21, y : 8};
mappages["poverty"].features[31] = {name : 'PileOfRocks', x : 19, y : 6};
mappages["poverty"].features[32] = {name : 'PileOfRocks', x : 17, y : 6};
mappages["poverty"].features[33] = {name : 'PileOfRocks', x : 9, y : 14};
mappages["poverty"].features[34] = {name : 'PileOfRocks', x : 8, y : 17};
mappages["poverty"].features[35] = {name : 'PileOfRocks', x : 4, y : 18};
mappages["poverty"].features[36] = {name : 'PileOfRocks', x : 2, y : 15};
mappages["poverty"].features[37] = {name : 'PileOfRocks', x : 3, y : 11};
mappages["poverty"].features[38] = {name : 'PileOfRocks', x : 5, y : 10};
mappages["poverty"].features[39] = {name : 'PileOfRocks', x : 8, y : 11};
mappages["poverty"].features[40] = {name : 'SleepField', x : 20, y : 28};
mappages["poverty"].features[41] = {name : 'Campfire', x : 5, y : 14};
mappages["poverty"].features[42] = {name : 'Brazier', x : 20, y : 24};
mappages["poverty"].features[43] = {name : 'Campfire', x : 20, y : 14};
