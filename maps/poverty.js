...
mappages["poverty"].terrain[14] = '.. .. ., ., ., ., ., ., ., ,% .. .. .. ., ., .. .. .. .. %% ., ., -= -= -= -= -= %% .. ,, .. .. ,, .. .. .. .. .. .. ..';
mappages["poverty"].terrain[15] = '.. .. ,% ., ., ., ., ., ., .. .. .. .. ., ., .. .. .. .. ., ., ., -= -= -= -= -= %% .. .. .. .. .. .. .. .. .. .. !# ..';
mappages["poverty"].terrain[16] = '.. .. ., ., ., ., ., ., ., .. .. .. .. .. ., ., .. .. .. %% ., ., -= -= -= -= -= %% .. .. ,, .. .. .. .. .. .. .. .. ..';
mappages["poverty"].terrain[17] = '.. .. .. ., ., ., ., ., ,% .. .. .. .. ., ., ., .. .. .. %% ., ., -= -= -= -= -= %% .. .. .. .. .. .. .. .. .. .. !# ..';
mappages["poverty"].terrain[18] = '.. .. .. .. ,% .. .. .. .. .. .. .. ., ., ., ., .. .. .. ., ., ., -= -= -= -= -= %% .. .. .. .. .. .. .. .. .. .. !# ..';
mappages["poverty"].terrain[19] = '.. .. .. .. .. .. .. .. .. .. ,, .. ., ., ., ., .. .. .. %% ., ., -= -= -= -= -= %% .. .. ff ff .. .. .. .. .. .. .. ..';
...
mappages["poverty"].features[26] = {name : 'SleepField', x : 20, y : 28};
mappages["poverty"].features[27] = {name : 'Campfire', x : 5, y : 14};
mappages["poverty"].features[28] = {name : 'Brazier', x : 20, y : 24};
mappages["poverty"].features[29] = {name : 'Campfire', x : 20, y : 14};
mappages["poverty"].features[30] = {name : 'RuinsWallMidLeftMidRight', x : 4, y : 20};
mappages["poverty"].features[31] = {name : 'RuinsWallMidLeftMidRight', x : 5, y : 20};
mappages["poverty"].features[32] = {name : 'RuinsWallMidLeftMidRight', x : 6, y : 20};
mappages["poverty"].features[33] = {name : 'RuinsWallMidLeftBottomRight', x : 7, y : 20};
mappages["poverty"].features[34] = {name : 'RuinsWallBottomLeftMidRight', x : 3, y : 20};
mappages["poverty"].features[35] = {name : 'RuinsWallBottomLeftMidRight', x : 34, y : 14};
mappages["poverty"].features[36] = {name : 'RuinsWallMidLeftMidRight', x : 35, y : 14};
mappages["poverty"].features[37] = {name : 'RuinsWallMidLeftMidRight', x : 36, y : 14};
mappages["poverty"].features[38] = {name : 'RuinsWallMidLeftBottomRight', x : 37, y : 14};
mappages["poverty"].features[39] = {name : 'RuinsWallMidLeftTallRight', x : 37, y : 18};
mappages["poverty"].features[40] = {name : 'RuinsWallMidLeftMidRight', x : 36, y : 18};
mappages["poverty"].features[41] = {name : 'RuinsWallMidLeftMidRight', x : 35, y : 18};
mappages["poverty"].features[42] = {name : 'RuinsWallBottomLeftMidRight', x : 34, y : 18};
...
mappages["poverty"].returnx = '41';
mappages["poverty"].returny = '26';
...
mappages["poverty2"].features[26] = {name : 'SleepField', x : 20, y : 28};
mappages["poverty2"].features[27] = {name : 'Campfire', x : 5, y : 14};
mappages["poverty2"].features[28] = {name : 'Brazier', x : 20, y : 24};
mappages["poverty2"].features[29] = {name : 'RuinsWallBottomLeftMidRight', x : 34, y : 14};
mappages["poverty2"].features[30] = {name : 'RuinsWallMidLeftMidRight', x : 35, y : 14};
mappages["poverty2"].features[31] = {name : 'RuinsWallBottomLeftMidRight', x : 34, y : 18};
mappages["poverty2"].features[32] = {name : 'RuinsWallMidLeftTallRight', x : 36, y : 14};
mappages["poverty2"].features[33] = {name : 'RuinsWallMidLeftTallRight', x : 35, y : 18};
mappages["poverty2"].features[34] = {name : 'BedHead', x : 36, y : 15};
mappages["poverty2"].features[35] = {name : 'BedHead', x : 36, y : 17};
mappages["poverty2"].features[36] = {name : 'BedFoot', x : 37, y : 15};
mappages["poverty2"].features[37] = {name : 'BedFoot', x : 37, y : 17};
mappages["poverty2"].features[38] = {name : 'Brazier', x : 20, y : 14};
mappages["poverty2"].features[39] = {name : 'Brazier', x : 20, y : 19};
mappages["poverty2"].features[40] = {name : 'FenceNW', x : 1, y : 20};
mappages["poverty2"].features[41] = {name : 'FenceNE', x : 10, y : 20};
mappages["poverty2"].features[42] = {name : 'FenceEW', x : 2, y : 20};
mappages["poverty2"].features[43] = {name : 'FenceEW', x : 3, y : 20};
mappages["poverty2"].features[44] = {name : 'FenceEW', x : 4, y : 20};
mappages["poverty2"].features[45] = {name : 'FenceEW', x : 5, y : 20};
mappages["poverty2"].features[46] = {name : 'FenceEW', x : 6, y : 20};
mappages["poverty2"].features[47] = {name : 'FenceEW', x : 7, y : 20};
mappages["poverty2"].features[48] = {name : 'FenceEW', x : 8, y : 20};
mappages["poverty2"].features[49] = {name : 'FenceEW', x : 9, y : 20};


mappages["poverty2"].npcs = [];
mappages["poverty2"].npcs[0] = {name : 'DruidVillagerNPC', x : 23, y : 25, NPCName: 'Jennifer', Desc: 'herbalist', PeaceAI: 'scheduled', PCThreatAI: 'RunAway', Schedule: 'jennifer', Conversation: 'jennifer', Gender: 'female', Leash: 2, NPCBand: '0', OverrideGraphic: '302.gif', skintone: '1'};
mappages["poverty2"].npcs[1] = {name : 'TownsfolkVillagerNPC', x : 24, y : 27, NPCName: 'Brooke', Desc: 'apprentice', PeaceAI: 'scheduled', Schedule: 'brooke', Conversation: 'brooke', Gender: 'female', Leash: 2, NPCBand: '0', OverrideGraphic: 'civ_green.2.gif', skintone: '2'};
mappages["poverty2"].npcs[2] = {name : 'MageVillagerNPC', x : 17, y : 8, NPCName: 'Ivan', PeaceAI: 'scheduled', Schedule: 'ivan', Conversation: 'ivan', Gender: 'male', NPCBand: '0', OverrideGraphic: '303.gif', skintone: '1'};
mappages["poverty2"].npcs[3] = {name : 'RangerVillagerNPC', x : 19, y : 8, NPCName: 'Steadman', Desc: 'hunter', PeaceAI: 'scheduled', Schedule: 'steadman', Conversation: 'steadman', Gender: 'male', NPCBand: '0', OverrideGraphic: 'ranger-offcolor.gif', skintone: '1'};
mappages["poverty2"].npcs[4] = {name : 'TownGuardNPC', x : 12, y : 20, NPCName: 'Arthur', PeaceAI: 'scheduled', Schedule: 'arthur', Conversation: 'arthur', Gender: 'male', NPCBand: '0', skintone: '2'};
mappages["poverty2"].npcs[5] = {name : 'BardVillagerNPC', x : 7, y : 12, NPCName: 'Kelly', Desc: 'mayor', PeaceAI: 'scheduled', Schedule: 'kelly', Conversation: 'kelly', Gender: 'female', NPCBand: '0', OverrideGraphic: '311.gif', skintone: '1'};
mappages["poverty2"].npcs[6] = {name : 'AdventurerVillagerNPC', x : 5, y : 16, NPCName: 'Damien', Desc: 'farmer', PeaceAI: 'scheduled', PCThreatAI: 'RunAway', Schedule: 'damien', Conversation: 'damien', Gender: 'male', NPCBand: '0', skintone: '1'};
mappages["poverty2"].npcs[7] = {name : 'BeggarVillagerNPC', x : 4, y : 12, NPCName: 'Garth', PeaceAI: 'scheduled', Schedule: 'garth', Conversation: 'garth', Gender: 'male', NPCBand: '0', skintone: '1'};
mappages["poverty2"].npcs[8] = {name : 'TownsfolkVillagerNPC', x : 10, y : 15, NPCName: 'Anna', PeaceAI: 'scheduled', Schedule: 'anna_poverty', Conversation: 'anna', Gender: 'female', NPCBand: '0', OverrideGraphic: '310.2.gif', skintone: '2'};
mappages["poverty2"].npcs[9] = {name : 'TinkerVillagerNPC', x : 21, y : 12, NPCName: 'Katie', Desc: 'builder', Schedule: 'katie', Conversation: 'katie', Gender: 'female', NPCBand: '0', OverrideGraphic: '304.gif', skintone: '1'};
mappages["poverty2"].npcs[10] = {name : 'TinkerVillagerNPC', x : 25, y : 12, NPCName: 'Brennan', Schedule: 'brennan', Conversation: 'brennan', Gender: 'male', NPCBand: '0', OverrideGraphic: '304.2.gif', skintone: '2'};
...
mappages["poverty2"].returnx = '41';
mappages["poverty2"].returny = '26';
