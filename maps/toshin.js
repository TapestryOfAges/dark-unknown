...
mappages["toshin2"].features[22] = {name : 'Mirror', x : 15, y : 18};
mappages["toshin2"].features[23] = {name : 'Dresser', x : 21, y : 18};
mappages["toshin2"].features[24] = {name : 'BookshelfLeft', x : 23, y : 18};
mappages["toshin2"].features[25] = {name : 'BookshelfRight', x : 24, y : 18};
mappages["toshin2"].features[26] = {name : 'SmallBox', x : 22, y : 18, lootedid : 'toshin2box', searchyield : 'YellowPotion'};
mappages["toshin2"].features[27] = {name : 'LeftTable', x : 18, y : 14};
mappages["toshin2"].features[28] = {name : 'RightTable', x : 19, y : 14};
mappages["toshin2"].features[29] = {name : 'TopChair', x : 19, y : 13};
mappages["toshin2"].features[30] = {name : 'BookshelfOne', x : 15, y : 13, lootedid : 'targrion', searchyield : 'FallOfTargrion'};
mappages["toshin2"].features[31] = {name : 'StatueBase', x : 15, y : 10};
mappages["toshin2"].features[32] = {name : 'StatueBase', x : 17, y : 10};
mappages["toshin2"].features[33] = {name : 'StatueTop', x : 15, y : 9};
mappages["toshin2"].features[34] = {name : 'StatueTop', x : 17, y : 9};
mappages["toshin2"].features[35] = {name : 'Fireplace', x : 14, y : 20};
mappages["toshin2"].features[36] = {name : 'UnlitBrazier', x : 24, y : 11};
mappages["toshin2"].features[37] = {name : 'UnlitBrazier', x : 24, y : 7};
mappages["toshin2"].features[38] = {name : 'UnlitBrazier', x : 14, y : 7};
mappages["toshin2"].features[39] = {name : 'UnlitBrazier', x : 12, y : 6};
mappages["toshin2"].features[40] = {name : 'UnlitBrazier', x : 8, y : 6};
mappages["toshin2"].features[41] = {name : 'UnlitBrazier', x : 12, y : 21};
mappages["toshin2"].features[42] = {name : 'UnlitBrazier', x : 8, y : 21};
mappages["toshin2"].features[43] = {name : 'UnlitBrazier', x : 12, y : 13};
mappages["toshin2"].features[44] = {name : 'EnergyField', x : 21, y : 13};
mappages["toshin2"].features[45] = {name : 'EnergyField', x : 24, y : 13};
mappages["toshin2"].features[46] = {name : 'EnergyField', x : 24, y : 16};
mappages["toshin2"].features[47] = {name : 'EnergyField', x : 22, y : 16};
mappages["toshin2"].features[48] = {name : 'SleepField', x : 21, y : 14};
mappages["toshin2"].features[49] = {name : 'SleepField', x : 23, y : 15};
mappages["toshin2"].features[50] = {name : 'FireField', x : 24, y : 14};
mappages["toshin2"].features[51] = {name : 'FireField', x : 23, y : 13};
mappages["toshin2"].features[52] = {name : 'FireField', x : 22, y : 15};
mappages["toshin2"].features[53] = {name : 'FireField', x : 23, y : 16};
mappages["toshin2"].features[54] = {name : 'PoisonField', x : 24, y : 15};
mappages["toshin2"].features[55] = {name : 'PoisonField', x : 23, y : 14};
mappages["toshin2"].features[56] = {name : 'PoisonField', x : 22, y : 14};
mappages["toshin2"].features[57] = {name : 'PoisonField', x : 21, y : 15};
mappages["toshin2"].features[58] = {name : 'SleepField', x : 22, y : 13};
mappages["toshin2"].features[59] = {name : 'SleepField', x : 21, y : 16};
mappages["toshin2"].features[60] = {name : 'UnlitBrazier', x : 15, y : 16};
mappages["toshin2"].features[61] = {name : 'FringeCarpetNW', x : 18, y : 19};
mappages["toshin2"].features[62] = {name : 'FringeCarpetN', x : 19, y : 19};
mappages["toshin2"].features[63] = {name : 'FringeCarpetN', x : 20, y : 19};
mappages["toshin2"].features[64] = {name : 'FringeCarpetN', x : 21, y : 19};
mappages["toshin2"].features[65] = {name : 'FringeCarpetN', x : 22, y : 19};
mappages["toshin2"].features[66] = {name : 'FringeCarpetN', x : 23, y : 19};
mappages["toshin2"].features[67] = {name : 'FringeCarpetNE', x : 24, y : 19};
mappages["toshin2"].features[68] = {name : 'FringeCarpetE', x : 24, y : 20};
mappages["toshin2"].features[69] = {name : 'FringeCarpetC', x : 23, y : 20};
mappages["toshin2"].features[70] = {name : 'FringeCarpetC', x : 22, y : 20};
mappages["toshin2"].features[71] = {name : 'FringeCarpetC', x : 21, y : 20};
mappages["toshin2"].features[72] = {name : 'FringeCarpetC', x : 20, y : 20};
mappages["toshin2"].features[73] = {name : 'FringeCarpetC', x : 19, y : 20};
mappages["toshin2"].features[74] = {name : 'FringeCarpetW', x : 18, y : 20};
mappages["toshin2"].features[75] = {name : 'FringeCarpetSW', x : 18, y : 21};
mappages["toshin2"].features[76] = {name : 'FringeCarpetS', x : 19, y : 21};
mappages["toshin2"].features[77] = {name : 'FringeCarpetS', x : 20, y : 21};
mappages["toshin2"].features[78] = {name : 'FringeCarpetS', x : 21, y : 21};
mappages["toshin2"].features[79] = {name : 'FringeCarpetS', x : 22, y : 21};
mappages["toshin2"].features[80] = {name : 'FringeCarpetS', x : 23, y : 21};
mappages["toshin2"].features[81] = {name : 'FringeCarpetSE', x : 24, y : 21};
mappages["toshin2"].features[82] = {name : 'DoubleBedTopHead', x : 23, y : 20};
mappages["toshin2"].features[83] = {name : 'DoubleBedBottomHead', x : 23, y : 21};
mappages["toshin2"].features[84] = {name : 'DoubleBedTopFoot', x : 24, y : 20};
mappages["toshin2"].features[85] = {name : 'DoubleBedBottomFoot', x : 24, y : 21};
