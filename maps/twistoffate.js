...
mappages["twistoffate1"].terrain[14] = 'BK BK BK BK BK BK BK BK BK BK BK !# !# !# hf hf hf !# !# !# !# !# !# !# hf hf hf hf !# !# !# BK BK BK BK BK BK BK BK BK BK BK BK BK';
mappages["twistoffate1"].terrain[15] = 'BK BK BK BK BK BK BK BK BK BK BK !# !# hf hf hf hf !# !# !# !# hf hf hf hf hf hf hf hf hf !# !# !# BK BK BK BK BK BK BK BK BK BK BK';
...
mappages["twistoffate1"].terrain[20] = 'BK BK BK BK BK BK !# !# hf hf hf hf !# !# !# !# hf hf hf !# !# hf hf hf hf hf hf hf hf !# !# hf hf hf hf hf !# BK BK BK BK BK BK BK';
mappages["twistoffate1"].terrain[21] = 'BK BK BK BK BK BK !# hf hf hf hf hf !# !# !# !# hf hf hf !# !# hf hf hf hf hf hf hf hf hf !# !# hf hf hf hf !# BK BK BK BK BK BK BK';
...
mappages["twistoffate1"].terrain[24] = 'BK BK BK BK BK BK !# !# hf hf hf !# !# !# hf hf hf hf !# !# !# hf hf hf !# !# !# !# !# hf hf hf !# !# hf hf hf !# BK BK BK BK BK BK';
...
mappages["twistoffate1"].features[0] = {name : 'LadderUp', x : 22, y : 26, entermap : 'ellusus', enterx : 50, entery : 118};
...
mappages["twistoffate1"].npcs[14] = {name : 'OlcrannNPC', x : 21, y : 41, skintone: 1};
...
mappages["twistoffate1"].exitmap = 'ellusus';
mappages["twistoffate1"].exitx = '50';
mappages["twistoffate1"].exity = '118';
...
mappages["twistoffate1"].returnmap = 'ellusus';
mappages["twistoffate1"].returnx = '50';
mappages["twistoffate1"].returny = '118';
mappages["twistoffate1"].returninfused = '0';
mappages["twistoffate1"].automap = '1';
...
mappages["twistoffate2"].terrain = [];
 ...
 mappages["twistoffate2"].terrain[7] = 'BK BK BK BK BK BK BK BK BK BK BK BK BK BK !# !# hf hf hf hf hf hf hf hf hf hf !# hf !# !# Lf Lf Lf !# !# hf hf hf hf !# BK BK BK BK BK BK BK BK BK BK BK BK BK BK';
 mappages["twistoffate2"].terrain[8] = 'BK BK BK BK BK BK BK BK BK BK BK BK BK BK !# hf hf hf hf hf hf !# !# hf !# !# !# Lf Lf Lf Lf Lf Lf !# !# hf hf hf hf !# BK BK BK BK BK BK BK BK BK BK BK BK BK BK';
 mappages["twistoffate2"].terrain[9] = 'BK BK BK BK BK BK BK BK BK BK BK BK BK !# !# hf hf hf hf hf !# !# Lf Lf Lf Lf Lf Lf !# !# !# !# !# !# hf hf hf hf hf !# BK BK BK BK BK BK BK BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[10] = 'BK BK BK BK BK BK BK BK BK BK BK BK !# !# hf hf hf hf !# hf !# Lf Lf Lf Lf Lf Lf !# !# hf hf hf hf hf hf hf hf !# !# !# BK BK BK BK BK BK BK BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[11] = 'BK BK BK BK BK BK BK BK BK BK BK !# !# hf hf hf hf !# !# Lf Lf Lf Lf Lf Lf !# !# !# !# hf hf hf hf hf hf hf !# !# BK BK BK BK BK BK BK BK BK BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[12] = 'BK BK BK BK BK BK BK BK BK BK !# !# hf hf hf hf !# !# Lf Lf Lf Lf Lf Lf !# !# BK BK !# hf hf hf !# !# !# !# !# BK BK BK BK BK BK BK BK BK BK BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[13] = 'BK BK BK BK BK BK BK BK BK !# !# hf hf hf hf !# !# Lf Lf Lf Lf Lf Lf Lf !# !# !# !# !# !# !# !# !# !# Lf !# !# !# !# !# !# BK BK BK BK BK BK BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[14] = 'BK BK BK BK BK BK BK BK !# !# hf hf hf hf !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# BK BK BK BK BK BK BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[15] = 'BK BK BK BK BK BK BK BK !# hf hf hf hf !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# BK BK BK BK BK BK BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[16] = 'BK BK BK BK BK BK BK !# !# hf hf hf hf hf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# hf !# !# !# !# !# hf !# !# !# !# hf !# !# BK BK BK BK BK BK BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[17] = 'BK BK BK BK BK BK BK !# hf hf hf hf !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# !# hf hf hf hf hf hf hf hf hf hf hf hf !# !# !# !# BK BK BK BK BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[18] = 'BK BK BK BK BK BK !# !# hf hf hf !# !# Lf Lf Lf Lf Lf Lf Lf Lf !# hf !# !# !# hf hf hf hf hf hf hf hf hf hf hf hf hf hf hf hf !# !# !# BK BK BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[19] = 'BK BK BK BK BK BK !# hf hf hf hf !# Lf Lf Lf Lf Lf Lf Lf Lf !# !# hf hf hf hf hf hf hf !# !# hf !# !# !# hf !# hf hf hf hf hf hf hf !# !# BK BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[20] = 'BK BK BK BK BK BK !# hf hf hf !# !# Lf Lf Lf Lf Lf Lf Lf !# !# hf hf hf hf hf hf hf !# !# Lf Lf Lf Lf Lf Lf !# !# !# !# hf hf hf hf hf !# !# BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[21] = 'BK BK BK BK BK !# !# hf hf hf hf Lf Lf Lf Lf Lf Lf Lf Lf !# hf hf hf !# !# !# hf !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# hf !# hf hf hf hf !# !# BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[22] = 'BK BK BK BK BK !# hf hf hf hf !# Lf Lf Lf Lf Lf Lf Lf Lf hf hf hf hf hf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# !# hf hf hf hf !# !# BK BK BK BK BK';
mappages["twistoffate2"].terrain[23] = 'BK BK BK BK BK !# hf hf hf !# !# Lf Lf Lf Lf Lf Lf Lf Lf !# hf hf !# !# Lf Lf Lf !# !# !# !# !# !# !# Lf Lf Lf Lf Lf Lf Lf Lf !# !# hf hf hf hf !# !# BK BK BK BK';
mappages["twistoffate2"].terrain[24] = 'BK BK BK BK BK !# hf hf hf hf !# !# Lf Lf Lf Lf Lf Lf Lf !# hf hf hf !# !# !# !# !# hf hf !# !# hf !# !# !# Lf Lf Lf Lf Lf Lf Lf !# !# hf hf hf hf !# BK BK BK BK';
mappages["twistoffate2"].terrain[25] = 'BK BK BK BK BK !# !# hf hf hf hf !# !# Lf Lf Lf Lf Lf Lf !# hf hf hf hf hf hf hf hf hf hf !# !# hf hf hf !# !# Lf Lf Lf Lf Lf Lf Lf !# !# hf hf hf !# BK BK BK BK';
mappages["twistoffate2"].terrain[26] = 'BK BK BK BK BK BK !# !# hf hf hf hf !# hf !# Lf Lf Lf Lf !# !# !# hf hf hf hf hf hf !# !# !# !# hf hf hf hf !# Lf Lf Lf Lf Lf Lf Lf Lf hf hf hf hf !# BK BK BK BK';
mappages["twistoffate2"].terrain[27] = 'BK BK BK BK BK BK BK !# !# hf hf hf hf hf !# !# Lf Lf Lf Lf Lf !# !# !# !# !# !# !# !# Lf !# !# !# hf hf hf !# Lf Lf Lf Lf Lf Lf Lf Lf !# !# hf hf !# !# BK BK BK';
mappages["twistoffate2"].terrain[28] = 'BK BK BK BK BK BK BK BK !# !# hf hf hf hf hf !# hf !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf hf hf hf hf hf hf !# Lf Lf Lf Lf Lf Lf Lf Lf Lf !# hf hf hf !# BK BK BK';
mappages["twistoffate2"].terrain[29] = 'BK BK BK BK BK BK BK BK BK !# !# hf hf hf hf hf hf hf !# !# !# hf !# Lf Lf Lf Lf Lf Lf !# !# hf hf hf hf !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf hf hf hf hf !# BK BK BK';
mappages["twistoffate2"].terrain[30] = 'BK BK BK BK BK BK BK BK BK BK !# !# hf hf hf hf hf hf hf hf hf hf !# !# !# hf !# !# !# !# hf hf hf hf !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# hf hf hf !# BK BK BK';
mappages["twistoffate2"].terrain[31] = 'BK BK BK BK BK BK BK BK BK BK BK !# !# !# hf !# hf hf hf hf hf hf hf hf hf hf hf hf hf hf hf hf hf !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# !# hf hf hf !# BK BK BK';
mappages["twistoffate2"].terrain[32] = 'BK BK BK BK BK BK BK BK BK BK BK BK !# Lf Lf !# !# !# hf !# hf hf hf hf hf hf hf hf hf hf hf hf !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# !# hf hf hf !# !# BK BK BK';
mappages["twistoffate2"].terrain[33] = 'BK BK BK BK BK BK BK BK BK BK BK BK !# !# Lf Lf Lf Lf Lf !# !# !# !# hf !# !# !# !# hf hf !# !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf hf hf hf hf hf !# BK BK BK BK';
mappages["twistoffate2"].terrain[34] = 'BK BK BK BK BK BK BK BK BK BK BK BK BK !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# hf !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# !# hf hf hf !# !# BK BK BK BK';
mappages["twistoffate2"].terrain[35] = 'BK BK BK BK BK BK BK BK BK BK BK BK BK !# !# !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# !# hf hf hf !# !# BK BK BK BK BK';
mappages["twistoffate2"].terrain[36] = 'BK BK BK BK BK BK BK BK BK BK BK BK BK BK BK BK !# !# !# !# !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# !# hf hf hf hf !# BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[37] = 'BK BK BK BK BK BK BK BK BK BK BK BK BK BK BK !# !# !# hf hf hf !# !# !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# hf !# hf hf hf hf !# !# BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[38] = 'BK BK BK BK BK BK BK BK BK BK BK BK BK BK !# !# hf hf hf hf hf !# !# !# !# !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# !# !# hf hf hf hf hf !# !# BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[39] = 'BK BK BK BK BK BK BK BK BK BK BK BK BK !# !# hf hf hf hf hf hf !# !# !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# hf !# hf hf hf hf hf !# !# !# BK BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[40] = 'BK BK BK BK BK BK BK BK BK BK BK BK !# !# hf hf hf hf !# !# !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# !# !# !# hf hf hf hf hf hf !# !# BK BK BK BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[41] = 'BK BK BK BK BK BK BK BK BK BK BK BK !# hf hf hf hf !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf Lf !# hf !# !# hf hf hf hf hf hf hf !# !# !# BK BK BK BK BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[42] = 'BK BK BK BK BK BK BK BK BK BK BK BK !# hf hf hf !# !# Lf Lf Lf Lf Lf Lf Lf Lf Lf !# !# !# hf hf hf hf hf hf hf hf !# !# !# BK BK BK BK BK BK BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[43] = 'BK BK BK BK BK BK BK BK BK BK BK BK !# hf hf hf hf !# Lf Lf Lf Lf Lf Lf !# !# !# !# hf hf hf hf hf hf hf !# !# !# !# BK BK BK BK BK BK BK BK BK BK BK BK BK BK BK';
...
mappages["twistoffate2"].features[36] = {name : 'Chest', x : 21, y : 13, lootgroup : 'Level3'};
mappages["twistoffate2"].features[37] = {name : 'Chest', x : 19, y : 16, lootgroup : 'Level4'};
mappages["twistoffate2"].features[38] = {name : 'Chest', x : 16, y : 18, lootgroup : 'Level5'};
mappages["twistoffate2"].features[39] = {name : 'Chest', x : 14, y : 22, lootgroup : 'Level4'};
mappages["twistoffate2"].features[40] = {name : 'Chest', x : 17, y : 25, lootgroup : 'Level3'};
mappages["twistoffate2"].features[41] = {name : 'Chest', x : 37, y : 22, lootgroup : 'Level3'};
mappages["twistoffate2"].features[42] = {name : 'Chest', x : 39, y : 25, lootgroup : 'Level4'};
mappages["twistoffate2"].features[43] = {name : 'Chest', x : 42, y : 28, lootgroup : 'Level5'};
mappages["twistoffate2"].features[44] = {name : 'Chest', x : 38, y : 31, lootgroup : 'Level4'};
mappages["twistoffate2"].features[45] = {name : 'Chest', x : 36, y : 35, lootgroup : 'Level3'};
mappages["twistoffate2"].features[46] = {name : 'Chest', x : 33, y : 36, lootgroup : 'Level5'};
mappages["twistoffate2"].features[47] = {name : 'Chest', x : 29, y : 38, lootgroup : 'Level4'};
...
mappages["twistoffate2"].features[52] = {name : 'Campfire', x : 32, y : 7};
mappages["twistoffate2"].features[53] = {name : 'Campfire', x : 26, y : 10};
mappages["twistoffate2"].features[54] = {name : 'Campfire', x : 34, y : 13};
mappages["twistoffate2"].features[55] = {name : 'Campfire', x : 23, y : 29};
mappages["twistoffate2"].features[56] = {name : 'Campfire', x : 15, y : 22};
mappages["twistoffate2"].features[57] = {name : 'Campfire', x : 18, y : 16};
mappages["twistoffate2"].features[58] = {name : 'Campfire', x : 25, y : 23};
mappages["twistoffate2"].features[59] = {name : 'Campfire', x : 34, y : 23};
mappages["twistoffate2"].features[60] = {name : 'Campfire', x : 15, y : 34};
mappages["twistoffate2"].features[61] = {name : 'Campfire', x : 26, y : 34};
mappages["twistoffate2"].features[62] = {name : 'Campfire', x : 19, y : 41};
mappages["twistoffate2"].features[63] = {name : 'Campfire', x : 35, y : 35};
mappages["twistoffate2"].features[64] = {name : 'Campfire', x : 40, y : 28};

mappages["twistoffate2"].npcs = [];
mappages["twistoffate2"].npcs[0] = {name : 'OlcrannNPC', x : 23, y : 34, skintone: 1};
mappages["twistoffate2"].npcs[1] = {name : 'OlcrannNPC', x : 13, y : 25, skintone: 1};
mappages["twistoffate2"].npcs[2] = {name : 'OlcrannNPC', x : 14, y : 16, skintone: 1};
mappages["twistoffate2"].npcs[3] = {name : 'OlcrannNPC', x : 26, y : 22, skintone: 1};
mappages["twistoffate2"].npcs[4] = {name : 'OlcrannNPC', x : 33, y : 15, skintone: 1};
mappages["twistoffate2"].npcs[5] = {name : 'OlcrannNPC', x : 40, y : 36, skintone: 1};
mappages["twistoffate2"].npcs[6] = {name : 'EvilEyeNPC', x : 21, y : 43, skintone: 1};
mappages["twistoffate2"].npcs[7] = {name : 'EvilEyeNPC', x : 36, y : 38, skintone: 1};
mappages["twistoffate2"].npcs[8] = {name : 'EvilEyeNPC', x : 43, y : 33, skintone: 1};
mappages["twistoffate2"].npcs[9] = {name : 'EvilEyeNPC', x : 40, y : 22, skintone: 1};
mappages["twistoffate2"].npcs[10] = {name : 'EvilEyeNPC', x : 31, y : 20, skintone: 1};
mappages["twistoffate2"].npcs[11] = {name : 'EvilEyeNPC', x : 27, y : 15, skintone: 1};
mappages["twistoffate2"].npcs[12] = {name : 'EvilEyeNPC', x : 38, y : 15, skintone: 1};
mappages["twistoffate2"].npcs[13] = {name : 'EvilEyeNPC', x : 18, y : 22, skintone: 1};
mappages["twistoffate2"].npcs[14] = {name : 'EvilEyeNPC', x : 16, y : 27, skintone: 1};
mappages["twistoffate2"].npcs[15] = {name : 'EvilEyeNPC', x : 29, y : 28, skintone: 1};
mappages["twistoffate2"].npcs[16] = {name : 'EvilEyeNPC', x : 19, y : 11, skintone: 1};
mappages["twistoffate2"].npcs[17] = {name : 'EvilEyeNPC', x : 30, y : 7, skintone: 1};
mappages["twistoffate2"].npcs[18] = {name : 'EvilEyeNPC', x : 14, y : 32, skintone: 1};
mappages["twistoffate2"].npcs[19] = {name : 'EvilEyeNPC', x : 28, y : 35, skintone: 1};
mappages["twistoffate2"].npcs[20] = {name : 'MimicNPC', x : 30, y : 37, skintone: 1};
mappages["twistoffate2"].npcs[21] = {name : 'MimicNPC', x : 32, y : 37, skintone: 1};
mappages["twistoffate2"].npcs[22] = {name : 'MimicNPC', x : 34, y : 35, skintone: 1};
mappages["twistoffate2"].npcs[23] = {name : 'MimicNPC', x : 37, y : 34, skintone: 1};
mappages["twistoffate2"].npcs[24] = {name : 'MimicNPC', x : 39, y : 30, skintone: 1};
mappages["twistoffate2"].npcs[25] = {name : 'MimicNPC', x : 41, y : 29, skintone: 1};
mappages["twistoffate2"].npcs[26] = {name : 'MimicNPC', x : 40, y : 26, skintone: 1};
mappages["twistoffate2"].npcs[27] = {name : 'MimicNPC', x : 38, y : 23, skintone: 1};
mappages["twistoffate2"].npcs[28] = {name : 'MimicNPC', x : 29, y : 22, skintone: 1};
mappages["twistoffate2"].npcs[29] = {name : 'MimicNPC', x : 15, y : 23, skintone: 1};
mappages["twistoffate2"].npcs[30] = {name : 'MimicNPC', x : 15, y : 19, skintone: 1};
mappages["twistoffate2"].npcs[31] = {name : 'MimicNPC', x : 18, y : 17, skintone: 1};
mappages["twistoffate2"].npcs[32] = {name : 'MimicNPC', x : 20, y : 14, skintone: 1};
mappages["twistoffate2"].npcs[33] = {name : 'MimicNPC', x : 30, y : 14, skintone: 1};
mappages["twistoffate2"].npcs[34] = {name : 'DelverNPC', x : 21, y : 15, skintone: 1};
mappages["twistoffate2"].npcs[35] = {name : 'DelverNPC', x : 15, y : 21, skintone: 1};
mappages["twistoffate2"].npcs[36] = {name : 'DelverNPC', x : 39, y : 24, skintone: 1};
mappages["twistoffate2"].npcs[37] = {name : 'DelverNPC', x : 25, y : 37, skintone: 1};
mappages["twistoffate2"].npcs[38] = {name : 'EttinNPC', x : 18, y : 15, skintone: 1};
mappages["twistoffate2"].npcs[39] = {name : 'EttinNPC', x : 22, y : 12, skintone: 1};
mappages["twistoffate2"].npcs[40] = {name : 'EttinNPC', x : 35, y : 22, skintone: 1};
mappages["twistoffate2"].npcs[41] = {name : 'EttinNPC', x : 36, y : 32, skintone: 1};
mappages["twistoffate2"].npcs[42] = {name : 'EttinNPC', x : 24, y : 41, skintone: 1};
...
mappages["twistoffate2"].returnmap = 'ellusus';
mappages["twistoffate2"].returnx = '50';
mappages["twistoffate2"].returny = '118';
mappages["twistoffate2"].returninfused = '0';
mappages["twistoffate2"].automap = '1';
...
mappages["twistoffate3"].terrain[12] = 'BK BK BK BK BK BK BK BK BK !# hf !# !# hf !# !# hf !# !# !# BK BK BK BK BK BK BK BK BK BK BK BK';
...
mappages["twistoffate3"].terrain[18] = 'BK BK BK BK BK BK BK BK BK BK BK !# hf hf hf hf hf hf hf hf hf !# BK BK BK BK BK BK BK BK BK BK';
...
mappages["twistoffate3"].features[6] = {name : 'Chest', x : 14, y : 17, lootedid : 'tofsoc', searchyield : 'StoneOfConflagrations'};
...
mappages["twistoffate3"].returnmap = 'ellusus';
mappages["twistoffate3"].returnx = '50';
mappages["twistoffate3"].returny = '118';
mappages["twistoffate3"].returninfused = '0';
mappages["twistoffate3"].automap = '1';
