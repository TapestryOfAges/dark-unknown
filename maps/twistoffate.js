...
mappages["twistoffate2"].terrain[31] = 'BK BK BK BK BK BK BK BK BK %% %% %% %% %% hf %% hf hf hf hf hf hf hf hf hf hf hf hf hf hf hf hf hf %% %% df df df df df df df df df df %% %% hf hf hf %% BK BK BK';
mappages["twistoffate2"].terrain[32] = 'BK BK BK BK BK BK BK BK BK %% df df df df df %% %% %% hf %% hf hf hf hf hf hf hf hf hf hf hf hf %% %% df df df df df df df df df df %% %% hf hf hf %% %% BK BK BK';
mappages["twistoffate2"].terrain[33] = 'BK BK BK BK BK BK BK BK BK %% df df df df df df df df df %% %% %% %% hf %% %% %% %% hf hf %% %% %% df df df df df df df df df df df hf hf hf hf hf %% BK BK BK BK';
mappages["twistoffate2"].terrain[34] = 'BK BK BK BK BK BK BK BK BK %% df df df df df df df df df df df df df df df df df %% hf %% %% df df df df df df df df df df df df %% %% hf hf hf %% %% BK BK BK BK';
mappages["twistoffate2"].terrain[35] = 'BK BK BK BK BK BK BK BK BK %% %% %% %% %% %% %% %% df df df df df df df df df df df df df df df df df df df df df df df df df %% %% hf hf hf %% %% BK BK BK BK BK';
...
mappages["twistoffate2"].terrain[37] = 'BK BK BK BK BK BK BK BK BK BK BK BK BK BK BK %% %% %% hf hf hf %% df df df df df df df df df df df df df df df df df %% hf %% hf hf hf hf %% %% BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[38] = 'BK BK BK BK BK BK BK BK BK BK BK BK BK BK %% %% hf hf hf hf hf %% df df df df df df df df df df df df df df df %% %% %% hf hf hf hf hf %% %% BK BK BK BK BK BK BK';
mappages["twistoffate2"].terrain[39] = 'BK BK BK BK BK BK BK BK BK BK BK BK BK %% %% hf hf hf hf hf hf %% df df df df df df df df df df df df df %% hf %% hf hf hf hf hf %% %% %% BK BK BK BK BK BK BK BK';
...
mappages["twistoffate3"].features[3] = {name : 'MetalTwisterLever', x : 10, y : 12};
mappages["twistoffate3"].features[4] = {name : 'MetalTwisterLever', x : 20, y : 18};
mappages["twistoffate3"].features[5] = {name : 'LadderUp', x : 13, y : 13, entermap : 'twistoffate2', enterx : 29, entery : 25};
mappages["twistoffate3"].features[6] = {name : 'LadderUp', x : 16, y : 12, entermap : 'twistoffate2', enterx : 32, entery : 24};
