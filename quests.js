...
questlist[96] = new Quest([95], "Stolen Accessories", "Nyrani", "Castle dea Olympus", `You have accused Peter. Nyrani sent a guard to just outside his house, the first on the right, past the stable. When Peter is not around, speak to the guard, who will admit you to Peter's house, where you can search for stolen goods. If you find anything, report to Nyrani.`, `You have recovered the stolen bridle.`, "side");
