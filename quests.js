...
questlist[0] = new Quest([], "Beginning", "A Messenger", "Your home", `Your father has called you back to Castle dea Yggdras, and wishes to speak with you as soon as may be.`, ``, "main");
questlist[1] = new Quest([0], "Preventing a War", "King Daragen", "Castle dea Yggdras", `Your brother is in rebellion. Find out why... and bring the threat to an end before it can start. <IFFLAG:shel_changed>Your mother thinks you should ask those who might know if he has changed.</IFFLAG>`, `You have saved your brother, and prevented a war.`, "main");
questlist[2] = new Quest([], "The Rune of Kings", "King Daragen", "Castle dea Yggdras", `Journey to the Pit of Despair, and find the Rune of Kings.`, `You have been marked by the Rune of Kings.`, "main");
questlist[3] = new Quest([], "To Earn a Spellbook", "Jharden", "Castle dea Yggdras", `Jharden needs an executioner's hood from the healer in Naurglen.`, `You brought Jharden the executioner's hood he asked for, and received a spellbook.`, "main");
questlist[4] = new Quest([], "Nyrani's Shield", "Nyrani", "Castle dea Yggdras", `Fetch Nyrani's shield from the armorsmith in Hildendain.`, `You've brought Nyrani her shield.`, "main");
...
questlist[6] = new Quest([46], "Fall of Targion", "Olivia", "Castle dea Yggdras", `Olivia in Castle dea Yggdras is looking for the book Fall of Targion, which is probably in the Tower of Toshin.`, `You found the book for Olivia.`, "side");
questlist[7] = new Quest([], "Reports for the Chancellor", "Tyler", "Castle dea Yggdras", `Chancellor Tyler asked that you get reports from the leaders of Swainhil, Clear Lake, and Beldskae. The passcode is "Eclipse".<IFITEM:ClearLakeReport><br />You acquired the report from Clear Lake.</IFITEM><IFITEM:SwainhilReport><br />You have acquired the report from Swainhil.</IFITEM><IFITEM:BeldskaeReport><br />You have acquired the report from Beldskae.</IFITEM>`, `You have brought the reports to the Chancellor.`, "side");
questlist[8] = new Quest([], "Interrogate a Prisoner", "King Daragen", "Castle dea Yggdras", `Speak to a recently captured prisoner, in the prison beneath the castle. The prison is behind a secret door in the north wall of the basement hallway.`, `You have spoken with Rose, the prisoner.`, "main");
...
questlist[14] = new Quest([], "Olcrann Bark", "Asharden", "Asharden's Tower", `To the southwest, in the Lower Fang Mountains, there is a mine. Find and bring back the bark of a petrified olcrann, and Asharden will present you with a spellbook.`, `You have brought Asharden the petrified olcrann bark, and received a stronger spellbook.`, "main");
...
questlist[22] = new Quest([21], "Looking for Sam", "Maggie", "Clear Lake", `Maggie and her friend Sam were exploring a cave to the northeast of town, and Maggie got scared and ran home. She begs you to go find Sam and bring her home safely.`, `You've found Sam.`, "side");
...
questlist[35] = new Quest([], "A Man on the Inside", "Heather", "Onyx", `Go back to Silverglade Keep and talk to Taran, and give him the loyalist password 'serene'. He may know what needs to be done next.`, `You have spoken to Taran in Silverglade Keep.`, "main");
questlist[36] = new Quest([], "A Letter for Lance", "Aithne", "Onyx", `Trusting you, Aithne has given you a letter to deliver directly to the hand of Lance and no other. Bring it to him in Silverglade Keep.`, `You have brought the letter to Lance.`, "main");
...
questlist[38] = new Quest([], "Check on Aara", "Lance", "Silverglade Keep", `The letter from Aithne informed Lance that his good friend Aara has been imprisoned under Castle dea Yggdras. He asks that you check and make sure she is ok.`, `You have reported back to Lance that Aara is safe and well.`, "main");
questlist[39] = new Quest([], "Return to Heather", "Heather", "Onyx", `Now that you have performed the task for Aithne and confirmed that you can get into Silverglade Keep, it is time to return to Heather and report.`, `You have checked in with Heather of the Loyalists.`, "main");
questlist[40] = new Quest([], "Bardic Lore", "Taran", "Silverglade Keep", `Taran theorizes that Lance is controlled by magic. Taran has heard court wizard Justice speak of a thing called the Brilliant Pool, which can duplicate the effect of any spell. If anyone knows anything about it, it would be the Bards. Ask them what they know.`, `You have started on the path of learning about the Brilliant Pool.`, "main");
...
questlist[43] = new Quest([], "Finding Natassa's Spire", "Markus", "Swainhil", `The Bards think that the best place to look for information about the Brilliant Pool would be in the Spire of Natassa.<br />The Spire is in a dungeon in the Crown Mountains. You have a letter with instructions for getting through the dungeon.`, `You have found Natassa's notes on the Brilliant Pool.`, "main");
questlist[44] = new Quest([], "Seeking the Brilliant Pool", "Natassa?", "Natassa's Research", `The Brilliant Pool moves, and could be under the city of Onyx, in the ruins of Hildendain, or in the dungeon Nox Talanua. Her knowledge is incomplete- there is something more needed, to properly use it. Your next step is up to you.`, `You have found the Brilliant Pool.`, "main");
questlist[45] = new Quest([], "Joining the Bards: Music", "Alison", "Swainhil", `Find Simon, and show him your proficiency in music. Then, return to Alison to report.`, `You have passed the test of music.`, "side");
questlist[46] = new Quest([], "Joining the Bards: Helping Olivia", "Alison", "Swainhil", `Travel to Castle dea Yggdras and find Olivia there, and offer her your help in her searches.`, `You've found Olivia and heard what help she needs.`, "side");
questlist[47] = new Quest([], "Joining the Bards: Olivia Helped", "Olivia", "Castle dea Yggdras", `You've helped Olivia- return to Alison to report your progress.`, `Alison has been appraised your progress.`, "side");
...
questlist[62] = new Quest([], "Find the Book of Lore", "Arlan", "Toshin's Tower", `Arlan has offered to give you a copy of the notes he has found in Toshin's Tower on Empowerment. But first, he asks that you find a book Toshin was known to have: the Book of Lore. He believes she had it with her when she went to Nox Talanua.`, `You brought Arlan the Book of Lore, and received the notes on the Empower spell.`, "main");
...
questlist[64] = new Quest([], "Find the Tome of Sight", "Ashlin", "Consolation", `Before she will tell you of the Oracle, Ashlin requires that you bring her a book called the Tome of Sight.`, `You have brought Ashlin the Tome and learned what she knows of the Oracle.`, "main");
...
questlist[67] = new Quest([], "Lance's Collapse", "Taran", "Silverglade Keep", `Prince Lance has collapsed, after the dragon's defeat, and cannot be roused. Go to your parents and ask them if they can apply their powers of healing.`, ``, "main");
...
questlist[71] = new Quest([67], "Lance's Collapse", "Taran", "Silverglade Keep", `Prince Lance has collapsed, after the dragon's defeat, and cannot be roused. Using the Rune of Kings, you should be able to rouse him from his slumber.`, `You've awakened your brother from his collapse following the defeat of the black dragon.`, "main");
questlist[72] = new Quest([], "Letter from Rhys", "Lance", "Silverglade Keep", `Lance has asked you to go back to Castle dea Yggdras and open the box in his room, and bring back the letter from his friend Rhys that is within. <IFITEM:RhysLetter><br />You have found the letter and should bring it to Lance.</IFITEM>`, `You have brought Lance the letter he asked for.`, "main");
questlist[73] = new Quest([], "Search Rhys's house", "Lance", "Silverglade Keep", `Go to Clear Lake and search Rhys's house, thoroughly. See if you can find a clue to his whereabouts. <IFFLAG:rhys_house_info>His house is the southern dwelling on the eastern island of Clear Lake.</IFFLAG>`, `You found a secret passage, and Rhys.`, "main");
questlist[74] = new Quest([], "Notes on Other Runes", "Lance", "Silverglade Keep", `Lance has notes on Runes besides the Rune of Kings. They are in his sanctum, off his bedroom; the key he gave you will give you access.`, `You found the book of notes.`, "main");
questlist[75] = new Quest([], "Confront Justice", "Rhys", "Dungeon Shadow", `Return to Silverglade Keep and confront Justice. Tell her you know of the cult and the dark. And be ready for anything.`, `You have defeated Justice and drove her to flee.`, "main");
questlist[76] = new Quest([], "Stone of Conflagrations", "Rhys", "Silverglade Keep", `Go to the dungeon in the Wilding Mountains, to the south of Silverglade Keep and east of Onyx. There, seek the Stone of Conflagrations, and then return with it to Rhys and Lance.`, `You have brought them the Stone they need for the ritual.`, "main");
questlist[77] = new Quest([], "Riddled With Vice?", "A Daemon", "Silverglade Keep", `The summoned daemon claimed that the Shepherd of Dark would bring forth daemons in "the place most riddled with vice", and that it was "already almost too late to save." What did it mean?`, `You have discovered the fate of Beldskae.`, "main");
questlist[78] = new Quest([], "Learn More", "Rhys", "Silverglade Keep", `You must learn more about the daemons and how to stop them. You must find a source of information. <IFFLAG:q78>Rhys suggests asking wizards and bards.</IFFLAG>`, `You've found a lead...`, "main");
questlist[79] = new Quest([], "Harness a whirlpool", "Ashlin", "Consolation", `You must find a way to gain power over the waters, and summon forth a whirlpool in order to reach the Oracle in the underworld.`, `You have obtained the Mark of Waves and used it to create a whirlpool.`, "main");
...
questlist[86] = new Quest([85], "Find a Flawless Ruby", "King Daragen", "Castle dea Yggdras", `Travel to Kalton Mine, descend past the first two levels which are already mined out, and then use the Rune of Kings to call a ruby to you.`, `You have acquired an exceptional uncut ruby.`, "main");
...
questlist[89] = new Quest([], "Frozen Sunlight", "Natassa's notes", "Natassa's Spire", `You have found Natassa's notes on creating frozen sunlight. To make it last, however, you will need the Rune of Flames, which is reached through a gate on the east coast of the Isle of Lost Hope. Get the Rune of Flames.`, `You have the Rune of Flames!`, "main");
...
questlist[91] = new Quest([], "Ruby of the Sun", "The Oracle", "The Underworld", `Create the Ruby of the Sun. Take a perfect, cut ruby, and cast Empower on it, using as reagents mandrake root, volcanic ash, spider silk, mistletoe, and frozen sunlight.`, `You have the Ruby of the Sun.`, "main");
...
questlist[94] = new Quest([], "Stolen Accessories", "Coll", "Castle dea Yggdras", `Someone has stolen King Daragen's silver bridle. To learn more, speak to Alex and Guard Captain Nyrani.`, ``, "side");
questlist[95] = new Quest([94], "Stolen Accessories", "Nyrani", "Castle dea Yggdras", `Nyrani bids you investigate, if you have an opportunity. Ask around if anyone has seen anything, and if you have a lead, return to Nyrani to accuse someone.`, ``, "side");
questlist[96] = new Quest([95], "Stolen Accessories", "Nyrani", "Castle dea Yggdras", `You've accused Peter. Nyrani sent a guard to outside his house, the first on the right, past the stable. When Peter is not around, speak to the guard, who will admit you to Peter's house, where you can search for stolen goods. If you find anything, report to Nyrani.`, `You have recovered the stolen bridle.`, "side");
questlist[97] = new Quest([], "Stolen Jewelry", "Blanche", "Naurglen", `While Blanche was away from home with the army, she had some jewelry stolen from her house. <IFFLAG:reported_grayson>She has reported it to Grayson, one of the town guard.</IFFLAG>`, ``, "side");
questlist[98] = new Quest([97], "Stolen Jewelry", "Blanche", "Naurglen", `While Blanche was away from home with the army, she had some jewelry stolen from her house. Grayson suggests you ask around and see if anyone has seen a thief.`, `You have returned the stolen jewelry.`, "side");
questlist[99] = new Quest([], "Regards from Nyrani", "Nyrani", "Castle dea Yggdras", `Nyrani has asked you to visit her cousin Blanche, in Naurglen, that she will visit soon.`, `You have relayed Nyrani's message to Blanche.`, "side");
questlist[100] = new Quest([], "Speak with Jharden", "King Daragen", "Castle dea Yggdras", `Your father has suggested that you speak to Jharden, for he has something to tell you.`, `Jharden has taught you how to cross the Abyss!`, "main");
questlist[101] = new Quest([100], "Cross the Abyss", "Jharden", "Castle dea Yggdras", `Jharden has learned how to cross the Great Abyss, and unlock the spells of the Amber Audachta. He has crafted and given you an Amulet of Reflections, and instructed you to use it while standing before a mirror.`, `You have crossed the Great Abyss, making you one of the greatest mages of this age.`, "main");
...
questlist[106] = new Quest([9], "A Cave Near the Coast", "Erin", "Hildendain", `The monsters in the cave are slain. Report back to Nyrani in Castle dea Yggdras.`, `The monsters in the cave are slain.`, "side");
...
questlist[117] = new Quest([], "Unsuitable Mortar", "-", "-", `You have tried to enchant the ruby and discovered that your tools are unsuited to an enchantment of that power. Speak to an artificer for advice.`, ``, "main");
questlist[118] = new Quest([117], "Unsuitable Mortar", "Lynn", "Consolation", `You have tried to enchant the ruby and discovered that your tools are unsuited to an enchantment of that power. Lynn mentioned that Tharock was known to have used a mortar made of crystal that would be.`, ``, "main");
