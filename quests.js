...
questlist[17] = new Quest([], "Bring Robert a Map", "Garen", "Garen has asked you to bring a map to Robert in Clear Lake.", "You've brought Garen's map to Robert.", "side");
...
questlist[33] = new Quest([], "Infiltrating the Trusted", "Heather", "Onyx", "You have learned that Lance's inner circle is known as the Trusted. No one knows how to join them... but it is known that they all wear a specific pin. Heather has given you the plans to make the Trusted pin- bring them to Colin in Clear Lake to have one made, and bring it back to Heather.", "You have acquired a Trusted pin.", "main");
...
questlist[44] = new Quest([], "Seeking the Brilliant Pool", "Natassa?", "Natassa's Research", "You have read what Natassa wrote about the Brilliant Pool. It moves, and could be either under the city of Onyx, in the ruins of Hildendain, or in the dungeon Mt Drash. She also states that her knowledge is incomplete- there is something more needed, to properly use the Pool. In her final entry, she wrote with fear that Toshin might find the Pool first. Your next step is up to you.", "You have found the Brilliant Pool.", "main");
...
questlist[53] = new Quest([], "The Infinite Scroll", "Toshin?", "Toshin's Journal", "Toshin's journals reveal that she had learned that to utilize the Brilliant Pool without dying, an Infinite Scroll. She did not know how to make one, but some still exist- apparently, she considered asking in the Thief's Guild in Onyx, but considered it more likely that she would find information about it in Beldskae.", "You tracked down some information about the Infinite Scroll in Beldskae.", "main");
...
questlist[55] = new Quest([54], "Franklin's Banishment", "Denise", "Beldskae", "You've spoken to Denise about Franklin's debt and banishment, but she is firm that if he returns, he will be imprisoned or worse. Perhaps you can find something that will provide you with the leverage you need. <IFFLAG:chit_tip>You've heard a rumor that the guard Kalli has one of Denise's chits...</IFFLAG>", "", "side");
...
// this quest has no terminus yet
