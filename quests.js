...
questlist[6] = new Quest([46], "Fall of Targion", "Olivia", "Castle dea Olympus", `Olivia in Castle dea Olympus is looking for the book Fall of Targion, which is probably in the Tower of Toshin.`, `You found the book for Olivia.`, "side");
...
questlist[47] = new Quest([], "Joining the Bards: Olivia Helped", "Olivia", "Castle dea Olympus", `You've helped Olivia- return to Alison to report your progress.`, `Alison has been appraised your progress.`, "side");
...
questlist[78] = new Quest([], "Learn More", "Rhys", "Black Dragon Castle", `You must learn more about the daemons and how to stop them. You must find a source of information. <IFFLAG:q78>Rhys suggests asking wizards and bards.</IFFLAG>`, `You've found a lead...`, "main");
...
questlist[94] = new Quest([], "Stolen Accessories", "Coll", "Castle dea Olympus", `Someone has stolen King Daragen's silver bridle. To learn more, speak to Alex and Guard Captain Nyrani.`, ``, "side");
questlist[95] = new Quest([94], "Stolen Accessories", "Nyrani", "Castle dea Olympus", `Nyrani bids you investigate, if you have an opportunity. Ask around if anyone has seen anything, and if you have a lead, return to Nyrani to accuse someone.`, ``, "side");
questlist[96] = new Quest([95], "Stolen Accessories", "Nyrani", "Castle dea Olympus", `You've accused Peter. Nyrani sent a guard to outside his house, the first on the right, past the stable. When Peter is not around, speak to the guard, who will admit you to Peter's house, where you can search for stolen goods. If you find anything, report to Nyrani.`, `You have recovered the stolen bridle.`, "side");
