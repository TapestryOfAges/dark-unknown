...
function FindNearestNPC(from, align, except, findinvis, overridemove, nopath) {
  if (!except) { except = []; }
...
function BlockCivilized(mapref) {
  const blocklist=[ [16,104],  // Onyx
                    [15,105],[16,105],[17,105],
                    [14,106],[15,106],[16,106],[17,106],[18,106],
                    [13,107],[14,107],[15,107],[16,107],[17,107],[18,107],[19,107],
                    [14,108],[15,108],[16,108],[17,108],[18,108],
                    [15,109],[16,109],[17,109],
                    [16,110],
                    [59,14],  // Poverty
                    [58,15],[59,15],[60,15],
                    [57,16],[58,16],[59,16],[60,16],[61,16],
                    [56,17],[57,17],[58,17],[59,17],[60,17],[61,17],[62,17],
                    [57,18],[58,18],[59,18],[60,18],[61,18],
                    [58,19],[59,19],[60,19],
                    [59,20],
                    [80,38], // Clear Lake
                    [79,39],[80,39],[81,39],
                    [78,40],[79,40],[80,40],[81,40],[82,40],
                    [77,41],[78,41],[79,41],[80,41],[81,41],[82,41],[83,41],
                    [78,42],[79,42],[80,42],[81,42],[82,42],
                    [79,43],[80,43],[81,43],
                    [80,44],
                    [52,60], // Hildendain
                    [51,61],[52,61],[53,61],
                    [50,62],[51,62],[52,62],[53,62],[54,62],
                    [49,63],[50,63],[51,63],[52,63],[53,63],[54,63],[55,63],
                    [50,64],[51,64],[52,64],[53,64],[54,64],
                    [51,65],[52,65],[53,65],
                    [52,66],
                    [67,69],[68,69],[69,69],[70,69],[71,69],[72,69],[73,69], // Capital region
                    [66,70],[67,70],[68,70],[69,70],[70,70],[71,70],[72,70],[73,70],[74,70],
                    [65,71],[66,71],[67,71],[68,71],[69,71],[70,71],[71,71],[72,71],[73,71],[74,71],[75,71],
                    [64,72],[65,72],[66,72],[67,72],[68,72],[69,72],[70,72],[71,72],[72,72],[73,72],[74,72],[75,72],[76,72],
                    [64,73],[65,73],[66,73],[67,73],[68,73],[69,73],[70,73],[71,73],[72,73],[73,73],[74,73],[75,73],[76,73],
                    [64,74],[65,74],[66,74],[67,74],[68,74],[69,74],[70,74],[71,74],[72,74],[73,74],[74,74],[75,74],[76,74],
                    [65,75],[66,75],[67,75],[68,75],[69,75],[70,75],[71,75],[72,75],[73,75],[74,75],[75,75],
                    [66,76],[67,76],[68,76],[69,76],[70,76],[71,76],[72,76],[73,76],[74,76],
                    [67,77],[68,77],[69,77],[70,77],[71,77],[72,77],[73,77],
                    [49,87], // Silverglade Keep
                    [48,88],[49,88],[50,88],
                    [47,89],[48,89],[49,89],[50,89],[51,89],
                    [46,90],[47,90],[48,90],[49,90],[50,90],[51,90],[51,90],
                    [47,91],[48,91],[49,91],[50,91],[51,91],
                    [48,92],[49,92],[50,92],
                    [49,93],
                    [109,98], // Swainhil
                    [108,99],[109,99],[110,99],
                    [107,100],[108,100],[109,100],[110,100],[111,100],
                    [106,101],[107,101],[108,101],[109,101],[110,101],[111,101],[112,101],
                    [107,102],[108,102],[109,102],[110,102],[111,102],
                    [108,103],[109,103],[110,103],
                    [109,104],
                    [123,11], // Beldskae
                    [122,12],[123,12],[124,12],
                    [121,13],[122,13],[123,13],[124,13],[125,13],
                    [120,14],[121,14],[122,14],[123,14],[124,14],[125,14],[126,14],
                    [121,15],[122,15],[123,15],[124,15],[125,15],
                    [122,16],[123,16],[124,16],
                    [123,17]
  ];
  ...
  for (let i=0; i<mapref.getWidth(); i++) {
    for (let j=0; j<mapref.getHeight(); j++) {
      ...
      mapref.setWeightAt(i,j,pathweight,MOVE_WALK_MONSTER);

      let response2 = thisspot.canMoveHere(MOVE_LEVITATE, 1);
      if (!response2["canmove"]) { mapref.setWalkableAt(i,j,false,MOVE_LEVITATE_MONSTER); }
